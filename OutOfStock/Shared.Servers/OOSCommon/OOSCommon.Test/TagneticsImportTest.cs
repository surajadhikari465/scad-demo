...
namespace OOSCommon.Test
{
    ...
    /// <summary>
    ///This is a test class for TagneticsImportTest and is intended
    ///to contain all TagneticsImportTest Unit Tests
    ///</summary>
    [TestClass()]
    public class TagneticsImportTest
    {
        ...
        /// <summary>
        ///A test for TagneticsImport Constructor
        ///</summary>
        [TestMethod()]
        public void TagneticsImportConstructorTest()
        {
            ...
            TagneticsImport target = new TagneticsImport(scanDate, store, isValidationMode, logging, vimRepository, oosEFConnectionString);
        ...
        public void ImportTest()
        {
            ...
            IVIMRepository vimRepository = null; // TODO: Initialize to an appropriate value
            string oosEFConnectionString = string.Empty; // TODO: Initialize to an appropriate value
            TagneticsImport target = new TagneticsImport(scanDate, store, isValidationMode, logging, vimRepository, oosEFConnectionString); // TODO: Initialize to an appropriate value
        ...
        public void ImportNextBatchTest()
        {
            ...
            TagneticsImport_Accessor target = new TagneticsImport_Accessor(param0); // TODO: Initialize to an appropriate value
