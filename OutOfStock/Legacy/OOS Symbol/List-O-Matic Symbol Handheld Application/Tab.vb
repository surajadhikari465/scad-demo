...
Public Class Tab
    ...
    Private Sub Tab_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
        ...
        If MsgBox("Upload the Item List?", MsgBoxStyle.OkCancel, "Upload?") = MsgBoxResult.Ok Then
            ...
            Else
                ...
                Catch ex As System.Exception
                    MsgBox("Network Error.  Your Data has been save on this device. Please contact nexussupport@wholefoods.com.  Error is: " & ex.Message, MsgBoxStyle.Exclamation)
                End Try
            End If
        End If
        Me.TextBox1.Focus()
        ...
        If ListBox1.Items.Count > 0 Then
            Try
                ...
                For i As Integer = 0 To ListBox1.Items.Count - 1
                    upcs.Add(ListBox1.Items(i).ToString.PadLeft(13, "0"c))
                Next
                'Dim oos2 As New oosapptest.ScanOOS
                'oos2.Ping("hi")
                Dim x As Boolean
                x = True
                'oos2.CreateEventsFor(Date.Now, x, Module1.storeName, upcs.ToArray())
                'oos2.Dispose()
                ' Dim oos As New Scanner.ScanOutOfStock.ScanOutOfStock
                ' Dim returncode As String
