    ...
    public class ItemMasterModel
    {
        ...
        public static Dictionary<string,ItemMasterModel> RunQuery(IEnumerable<string> upcs)
        {
            ...
            foreach (string csvUPC in csvUPCs)
            {
                ...
                {
                    resultInner = oracle.ReturnList<ItemMasterModel>(CommandType.Text, queryOracle);
                }
        ...
        public static ItemMasterModel RunQuery(string upc)
        {
            ...
            if (string.IsNullOrWhiteSpace(upc)) return result;

            var queryOracle = string.Format(queryOracleBase, $"='{upc}' ");
            // The SQL Server query with the Oracle query within
            ...
            if (resultInner != null) result = resultInner.FirstOrDefault();
            return result;
        }
