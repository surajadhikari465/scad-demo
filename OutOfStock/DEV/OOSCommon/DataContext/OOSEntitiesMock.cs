...
namespace OOSCommon.DataContext
{
    ...
    public partial class OOSEntitiesMock : IOOSEntities
    {
        ...
        {
            get { return _applicationConfig  ?? (_applicationConfig = new MockObjectSet<ApplicationConfig>()); }
        }
        private IObjectSet<ApplicationConfig> _applicationConfig;
        ...
        {
            get { return _outOfStockNofitication  ?? (_outOfStockNofitication = new MockObjectSet<OutOfStockNofitication>()); }
        }
        private IObjectSet<OutOfStockNofitication> _outOfStockNofitication;
