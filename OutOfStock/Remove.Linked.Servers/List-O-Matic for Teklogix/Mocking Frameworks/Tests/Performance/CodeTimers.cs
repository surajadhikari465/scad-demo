...
namespace Performance
{
    ...
    /// 
    /// From Vance Morrison's Weblog (http://blogs.msdn.com/vancem/archive/2006/09/21/765648.aspx)
    /// </summary>
    ...
    public class MultiSampleCodeTimer
    {
        ...
        public MultiSampleCodeTimer(int sampleCount, int iterationCount)
        {
            ...
            timer = new CodeTimer { OnMeasure = null, IterationCount = iterationCount };
            OnMeasure = Print;
        }
        ...
        public static MeasureCallback PrintStats =
            (name, iterationCount, sample) => Console.WriteLine(name + ": " + sample);
    ...
    public class CodeTimer
    {
        ...
        public float Measure(string name, Action action)
        {
            ...
            float sample = (float)(sw.Elapsed.TotalMilliseconds - runOverhead);
        ...
        public static MeasureCallback Print =
            (name, iterationCount, sample) => Console.WriteLine("{0}: count={1} time={2:f3} msec ", name, iterationCount, sample);
        #region privates
