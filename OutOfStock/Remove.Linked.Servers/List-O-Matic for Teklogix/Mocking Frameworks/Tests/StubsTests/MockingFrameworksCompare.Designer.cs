...
namespace MockingFrameworksCompare.BrainSample.Stubs
{
      ...
      , global::Microsoft.Stubs.Framework.IPartialStub
    {
        ...
        [global::System.Diagnostics.DebuggerHidden]
        public SBrain(global::MockingFrameworksCompare.BrainSample.IHand hand, global::MockingFrameworksCompare.BrainSample.IMouth mouth)
        : base(hand, mouth)
        {
            this.Initialize();
        }
...
namespace MockingFrameworksCompare.ShoppingCartSample.Stubs
{
      ...
      , global::Microsoft.Stubs.Framework.IPartialStub
    {
        ...
        /// <summary>Attaches delegates to emulate SContactDetails.Name as a property with a backing field</summary>
        public void AttachBackingFieldToName()
        {
            global::Microsoft.Stubs.Framework.IStubBehavior stub = this.FallbackBehavior;
            string initialValue;
            if (this.NameSet ==
              (global::Microsoft.Stubs.Framework.StubDelegates.Action<string>)null && 
            this.NameGet ==
              (global::Microsoft.Stubs.Framework.StubDelegates.Func<string>)null && 
            stub.TryGetPropertyValue
                <global::MockingFrameworksCompare.ShoppingCartSample.Stubs
                  .SContactDetails, string>(this, out initialValue))
            {
              global::Microsoft.Stubs.Framework.StubValueHolder<string> state
                 = new global::Microsoft.Stubs.Framework.StubValueHolder<string>
                    (initialValue);
              this.NameGet = state.GetGetter();
              this.NameSet = state.GetSetter();
            }
        }
...
namespace MockingFrameworksCompare.ShoppingCartSample.Stubs
{
    /// <summary>Stub of Product</summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Stubs", "0.14.40610.2")]
    [global::System.Serializable]
    [global::System.Diagnostics.DebuggerDisplay("Stub = Product")]
    [global::System.Diagnostics.DebuggerStepThrough]
    public partial class SProduct
      : global::MockingFrameworksCompare.ShoppingCartSample.Product
      , global::Microsoft.Stubs.Framework.IStub
      , global::Microsoft.Stubs.Framework.IPartialStub
    {
        [global::System.Diagnostics.DebuggerHidden]
        public SProduct(string name, int price)
        : base(name, price)
        {
            this.Initialize();
        }
...
namespace MockingFrameworksCompare.ShoppingCartSample.Stubs
{
      ...
      , global::Microsoft.Stubs.Framework.IPartialStub
    {
        ...
        /// <summary>Attaches delegates to emulate SShoppingCart.IsRed as a property with a backing field</summary>
        public void AttachBackingFieldToIsRed()
        {
            global::Microsoft.Stubs.Framework.IStubBehavior stub = this.FallbackBehavior;
            bool initialValue;
            if (this.IsRedSet ==
              (global::Microsoft.Stubs.Framework.StubDelegates.Action<bool>)null && 
            this.IsRedGet ==
              (global::Microsoft.Stubs.Framework.StubDelegates.Func<bool>)null && 
            stub.TryGetPropertyValue
                <global::MockingFrameworksCompare.ShoppingCartSample.Stubs
                  .SShoppingCart, bool>(this, out initialValue))
            {
              global::Microsoft.Stubs.Framework.StubValueHolder<bool> state
                 = new global::Microsoft.Stubs.Framework.StubValueHolder<bool>(initialValue);
              this.IsRedGet = state.GetGetter();
              this.IsRedSet = state.GetSetter();
            }
        }

        /// <summary>Attaches delegates to emulate SShoppingCart.User as a property with a backing field</summary>
        public void AttachBackingFieldToUser()
        {
            global::Microsoft.Stubs.Framework.IStubBehavior stub = this.FallbackBehavior;
            global::MockingFrameworksCompare.ShoppingCartSample.User initialValue;
            if (this.UserSet == (global::Microsoft.Stubs.Framework.StubDelegates.Action<
            global::MockingFrameworksCompare.ShoppingCartSample.User
            >)null && 
            this.UserGet == (global::Microsoft.Stubs.Framework.StubDelegates.Func<
            global::MockingFrameworksCompare.ShoppingCartSample.User
            >)null && stub.TryGetPropertyValue
                <global::MockingFrameworksCompare.ShoppingCartSample.Stubs
                  .SShoppingCart, 
                global::MockingFrameworksCompare.ShoppingCartSample.User>
                (this, out initialValue))
            {
              global::Microsoft.Stubs.Framework.StubValueHolder
                  <global::MockingFrameworksCompare.ShoppingCartSample.User> state
                 = new global::Microsoft.Stubs.Framework.StubValueHolder<
                global::MockingFrameworksCompare.ShoppingCartSample.User
                >(initialValue);
              this.UserGet = state.GetGetter();
              this.UserSet = state.GetSetter();
            }
        }
        ...
        public override bool IsRed
        {
            ...
            get
            {
                this.AttachBackingFieldToIsRed();
...
namespace MockingFrameworksCompare.ShoppingCartSample.Stubs
{
      ...
      , global::Microsoft.Stubs.Framework.IPartialStub
    {
        ...
        /// <summary>Attaches delegates to emulate SUser.ContactDetails as a property with a backing field</summary>
        public void AttachBackingFieldToContactDetails()
        {
            global::Microsoft.Stubs.Framework.IStubBehavior stub = this.FallbackBehavior;
            global::MockingFrameworksCompare.ShoppingCartSample.ContactDetails initialValue;
            if (this.ContactDetailsSet == (global::Microsoft.Stubs.Framework.StubDelegates
              .Action<global::MockingFrameworksCompare.ShoppingCartSample
                .ContactDetails>)null && 
            this.ContactDetailsGet == (global::Microsoft.Stubs.Framework.StubDelegates
              .Func<global::MockingFrameworksCompare.ShoppingCartSample
                .ContactDetails>)null && stub.TryGetPropertyValue
                <global::MockingFrameworksCompare.ShoppingCartSample.Stubs.SUser, 
                global::MockingFrameworksCompare.ShoppingCartSample.ContactDetails>
                (this, out initialValue))
            {
              global::Microsoft.Stubs.Framework.StubValueHolder
                  <global::MockingFrameworksCompare.ShoppingCartSample
                    .ContactDetails> state = new global::Microsoft.Stubs.Framework.StubValueHolder
                  <global::MockingFrameworksCompare.ShoppingCartSample
                    .ContactDetails>(initialValue);
              this.ContactDetailsGet = state.GetGetter();
              this.ContactDetailsSet = state.GetSetter();
            }
        }
        ...
        public override global::MockingFrameworksCompare.ShoppingCartSample.ContactDetails ContactDetails
        {
            ...
            get
            {
                this.AttachBackingFieldToContactDetails();
                global::Microsoft.Stubs.Framework.StubDelegates
                  .Func<global::MockingFrameworksCompare.ShoppingCartSample
