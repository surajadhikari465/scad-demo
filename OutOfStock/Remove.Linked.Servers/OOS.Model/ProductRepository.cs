...
namespace OOS.Model.Repository
{
    public class ProductRepository : IProductRepository
    {
        ...
        {
            using (var oracle = new OracleDataAccess(AppConfig.ConnectionStrings["VIM"].ConnectionString))
            {
                return oracle.ReturnList<ProductDTO>(System.Data.CommandType.Text, sqlQuery);
            }
