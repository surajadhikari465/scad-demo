...
{
    public class SingleStoreReportExcelModel : ICustomReportExcelModel
    {
        ...
        public SingleStoreReportExcelModel()
        {
        ...
        public SingleStoreReportExcelModel(
            ...
            string storesList,
            DateTime? LastDateSold, int? DaysWithSales
        )
        {
        ...
        public string CreateExcelFile(string excelFilename, List<ColumnDataModel> columnNames, ref IEnumerable<ICustomReportExcelModel> reportData, ref ReportHeaderDataModel headerData)
        {
            throw new NotImplementedException();
        }

        public string CreateExcelFile(string excelFilename, List<ColumnDataModel> columnNames, ref IEnumerable<ICustomReportExcelModel> reportData,
            ref ReportHeaderDataModel headerData, ref IEnumerable<ScanWithNoVimData> ScansWithNoVimData)
        {
            throw new NotImplementedException();
        }
    }
