...
namespace OutOfStock.Models
{
    public class CustomReportViewModel : ICustomReportViewModel
    {
        ...
        public IEnumerable<ICustomReportExcelModel> RunQuery(DateTime? start, DateTime? end,
            Dictionary<int,string>dicStore, Dictionary<string,string>dicTeam,
            Dictionary<string, string> dicSubTeam, DateTime todaysDate, ref IOOSEntitiesFactory dbfactory)
        {
