...
namespace OutOfStock.Controllers
{
    ...
    {
        private const int DefaultUpcCount = 90000;
        ...
        public SummaryReportController(SummaryReportService service, IUserLoginManager lm)
        {
        ...
        public ActionResult Index()
        {
            ...
            MvcApplication.oosLog.Trace(
                $"Summary Report for {user} took {sw.ElapsedMilliseconds} millisecond(s). Parameters: From={DateTime.Now.AddDays(-7).ToShortDateString()} To={DateTime.Now.ToShortDateString()} Region={OOSUser.userRegion}");
        ...
        {
            var summaryReport = _service.SummaryReportFor(dtStart, dtEnd, region);
