<%@ Page Language="vb" MasterPageFile="~/MasterPage.master"  AutoEventWireup="false" Inherits="PromoPlanner.pp_irma.reviewpromo" Codebehind="reviewpromo.aspx.vb" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
			...
			<table>
				<tr>
					<td>
						<table>
							<tr>
								<asp:datagrid id="promoItems" EditItemStyle-HorizontalAlign="left" ItemStyle-HorizontalAlign="Left"
									HeaderStyle-HorizontalAlign="Left" GridLines="Both" Width="1400" Runat="server" CssClass="smallertable"
									OnUpdateCommand="promoItems_Update" OnEditCommand="promoItems_Edit" OnDeleteCommand="promoItems_Delete"
									OnCancelCommand="promoItems_Cancel" AlternatingItemStyle-BackColor="Silver" AutoGenerateColumns="False">
										...
										<asp:TemplateColumn>
											...
											<EditItemTemplate>
												<td>
													...
													<asp:label Runat="server" Visible="False" ID="lbl_itemkey" text='<%# Container.DataItem("Item_Key")%>'>
													</asp:label>
													<asp:label Runat="server" ID="Label31" text='<%# Container.DataItem("Store_No")%>'>
													</asp:label></td>
												<td>
			...
			<table class="regtable">
				<tr>
					<td><asp:button id="loadStor" runat="server" text="Complete Promo"></asp:button></td>
				</tr>
				<TR>
