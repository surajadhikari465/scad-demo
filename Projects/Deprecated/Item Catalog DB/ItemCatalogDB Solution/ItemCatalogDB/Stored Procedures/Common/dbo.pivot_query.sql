if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[pivot_query]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[pivot_query]
go

create procedure dbo.pivot_query
   (
   @query         varchar(MAX),
