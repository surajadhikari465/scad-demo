/****** Object:  StoredProcedure [dbo].[msqGetIRMAItems]    Script Date: 03/30/2006 14:16:53 ******/
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[msqGetIRMAItems]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[msqGetIRMAItems]
GO
