...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[RIPE_GetIrmaItemForRecipe]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[RIPE_GetIrmaItemForRecipe]
GO
