IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[PurchasesSummaryReport]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP  Procedure  dbo.PurchasesSummaryReport
GO
