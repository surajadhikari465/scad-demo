...
/****** Object:  StoredProcedure [dbo].[InsertItemHistoryCycleCount]    Script Date: 10/04/2012 15:30:06 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[InsertItemHistoryCycleCount]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[InsertItemHistoryCycleCount]
GO
