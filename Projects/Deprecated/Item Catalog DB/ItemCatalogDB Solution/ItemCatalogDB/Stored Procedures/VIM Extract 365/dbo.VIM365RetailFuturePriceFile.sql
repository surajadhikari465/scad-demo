IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID(N'dbo.VIM365RetailFuturePriceFile'))
	EXEC('CREATE PROCEDURE [dbo].[VIM365RetailFuturePriceFile] AS BEGIN SET NOCOUNT ON; END')
GO

ALTER PROCEDURE [dbo].[VIM365RetailFuturePriceFile]
AS
