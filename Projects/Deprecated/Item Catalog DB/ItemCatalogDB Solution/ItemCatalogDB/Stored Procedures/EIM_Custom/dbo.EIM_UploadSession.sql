IF EXISTS (select * from dbo.sysobjects where id = object_id(N'[dbo].[EIM_UploadSession]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[EIM_UploadSession]
GO
