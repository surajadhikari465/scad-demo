...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[EIM_UpdateUploadAttribute]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[EIM_UpdateUploadAttribute]
GO
