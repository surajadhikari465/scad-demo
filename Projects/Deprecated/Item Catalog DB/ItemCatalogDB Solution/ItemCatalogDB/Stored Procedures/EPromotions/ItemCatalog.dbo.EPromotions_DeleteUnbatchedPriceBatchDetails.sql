...
/****** Object:  Stored Procedure dbo.EPromotions_DeleteUnbatchedPriceBatchDetails    Script Date: 6/6/2006 5:51:10 PM ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[EPromotions_DeleteUnbatchedPriceBatchDetails]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[EPromotions_DeleteUnbatchedPriceBatchDetails]
GO
