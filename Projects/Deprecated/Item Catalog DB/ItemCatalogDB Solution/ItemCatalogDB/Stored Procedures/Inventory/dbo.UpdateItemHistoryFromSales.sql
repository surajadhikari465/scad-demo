...
/****** Object:  StoredProcedure [dbo].[UpdateItemHistoryFromSales]    Script Date: 10/18/2012 14:05:13 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[UpdateItemHistoryFromSales]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[UpdateItemHistoryFromSales]
GO
