...
/****** Object:  StoredProcedure [dbo].[InsertItemHistory3]    Script Date: 10/04/2012 15:26:25 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[InsertItemHistory3]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[InsertItemHistory3]
GO
