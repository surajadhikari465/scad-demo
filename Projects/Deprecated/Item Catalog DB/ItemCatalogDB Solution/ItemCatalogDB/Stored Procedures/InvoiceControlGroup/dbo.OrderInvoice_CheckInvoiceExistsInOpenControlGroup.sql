IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[OrderInvoice_CheckInvoiceExistsInOpenControlGroup]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
	DROP PROCEDURE [dbo].[OrderInvoice_CheckInvoiceExistsInOpenControlGroup]
GO
