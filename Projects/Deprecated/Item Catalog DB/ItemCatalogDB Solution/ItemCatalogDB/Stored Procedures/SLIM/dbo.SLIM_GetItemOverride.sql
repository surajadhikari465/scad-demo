if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[SLIM_GetItemOverride]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[SLIM_GetItemOverride]
GO
