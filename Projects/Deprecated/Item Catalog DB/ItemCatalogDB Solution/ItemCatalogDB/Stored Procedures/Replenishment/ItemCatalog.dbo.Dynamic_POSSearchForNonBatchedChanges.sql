/****** Object:  StoredProcedure [dbo].[Dynamic_POSSearchForNonBatchedChanges]    Script Date: 06/27/2006 11:06:56 ******/
IF NOT EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[Dynamic_POSSearchForNonBatchedChanges]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
	EXEC ('create PROCEDURE [dbo].[Dynamic_POSSearchForNonBatchedChanges] (@foo int) as select 1')
GO
...
ALTER  PROCEDURE [dbo].[Dynamic_POSSearchForNonBatchedChanges]
