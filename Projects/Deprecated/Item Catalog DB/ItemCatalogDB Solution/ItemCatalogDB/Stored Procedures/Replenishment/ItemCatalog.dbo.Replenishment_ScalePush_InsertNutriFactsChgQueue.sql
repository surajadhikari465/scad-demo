IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'dbo.Replenishment_ScalePush_InsertNutriFactsChgQueue') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE dbo.Replenishment_ScalePush_InsertNutriFactsChgQueue
GO
