IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Replenishment_TagPush_GetAccessViaReprintTagFile]') AND type in (N'P', N'PC'))
	EXEC('CREATE PROCEDURE [dbo].[Replenishment_TagPush_GetAccessViaReprintTagFile] AS SET NO COUNT ON; END')
GO
...
ALTER PROCEDURE [dbo].[Replenishment_TagPush_GetAccessViaReprintTagFile]
...
-- Procedure: Replenishment_TagPush_GetAccessViaReprintTagFile
--	  Author: n/a
--      Date: n/a
--
-- Description: This stored proc is called by the Replenishment_TagPush_GetReprintTagFile stored proc
--
-- Modification History:
-- Date       	Init  	TFS   	Comment
-- 01/07/2013	BS		8755	Updated Item.Discontinue_Item with SIV.DiscontinueItem. Added Modification history
								However the TODO was already in place
-- 09/11/2014	DN		15418	Added function fn_ItemIdentifiers to get validated items
**********************************************************************************************************************/
BEGIN
