/****** Object:  StoredProcedure [dbo].[SOG_PrintCatalog]    Script Date: 07/17/2012 10:00:21 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SOG_PrintCatalog]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SOG_PrintCatalog]
GO
