...
--=====================================================================
--*********      dbo.EIM_Regen_InsertUploadTypeTemplateAttribute                         
--=====================================================================
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[EIM_Regen_InsertUploadTypeTemplateAttribute]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[EIM_Regen_InsertUploadTypeTemplateAttribute]
GO
