...
--=====================================================================
--*********      dbo.EIM_Regen_GetUploadTypeTemplateByPK                             
--=====================================================================
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[EIM_Regen_GetUploadTypeTemplateByPK]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[EIM_Regen_GetUploadTypeTemplateByPK]
GO

CREATE PROCEDURE dbo.EIM_Regen_GetUploadTypeTemplateByPK
