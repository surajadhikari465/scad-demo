...
--=====================================================================
--*********      dbo.EIM_Regen_GetUploadSessionByPK                             
--=====================================================================
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[EIM_Regen_GetUploadSessionByPK]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[EIM_Regen_GetUploadSessionByPK]
GO
