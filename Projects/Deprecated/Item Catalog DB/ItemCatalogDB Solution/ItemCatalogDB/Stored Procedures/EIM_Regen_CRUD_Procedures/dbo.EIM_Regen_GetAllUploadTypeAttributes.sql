...
--=====================================================================
--*********      dbo.EIM_Regen_GetAllUploadTypeAttributes                             
--=====================================================================
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[EIM_Regen_GetAllUploadTypeAttributes]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[EIM_Regen_GetAllUploadTypeAttributes]
GO

CREATE PROCEDURE dbo.EIM_Regen_GetAllUploadTypeAttributes
