--/****** Object:  StoredProcedure [dbo].[Conversion_RegionAddToItemTemp]    Script Date: 05/19/2006 16:34:23 ******/
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[Conversion_RegionAddToItemTemp]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[Conversion_RegionAddToItemTemp]
GO
--
--/****** Object:  StoredProcedure [dbo].[Conversion_RegionAddToItemTemp]    Script Date: 06/09/2006 15:51:10 ******/
--SET ANSI_NULLS ON
--GO
