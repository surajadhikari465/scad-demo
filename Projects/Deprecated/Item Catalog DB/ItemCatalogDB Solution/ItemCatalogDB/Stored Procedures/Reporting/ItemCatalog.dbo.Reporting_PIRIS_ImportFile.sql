/****** Object:  StoredProcedure [dbo].[Reporting_PIRIS_ImportFile]    Script Date: 08/14/2006 16:50:13 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Reporting_PIRIS_ImportFile]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[Reporting_PIRIS_ImportFile]

/****** Object:  StoredProcedure [dbo].[Reporting_PIRIS_ImportFile]    Script Date: 08/14/2006 16:50:03 ******/
SET ANSI_NULLS ON
