 /****** Object:  StoredProcedure [dbo].[DCPerformanceReport]    Script Date: 12/23/2009 10:39:06 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

/****** Object:  StoredProcedure [dbo].[DCPerformanceReport]    Script Date: 12/23/2009 10:43:05 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DCPerformanceReport]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[DCPerformanceReport]
