/****** Object:  StoredProcedure [dbo].[CloseReceiving]    Script Date: 06/29/2012 11:47:29 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[CloseReceiving]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[CloseReceiving]
GO

/****** Object:  StoredProcedure [dbo].[CloseReceiving]    Script Date: 06/29/2012 11:47:30 ******/
SET ANSI_NULLS ON
GO
