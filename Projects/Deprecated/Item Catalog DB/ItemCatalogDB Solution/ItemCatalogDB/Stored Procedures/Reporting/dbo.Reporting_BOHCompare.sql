...
/****** Object:  StoredProcedure [dbo].[Reporting_BOHCompare]    Script Date: 10/04/2012 16:13:57 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Reporting_BOHCompare]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Reporting_BOHCompare]
GO
