if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[Reporting_MarginImpact]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[Reporting_MarginImpact]
GO
