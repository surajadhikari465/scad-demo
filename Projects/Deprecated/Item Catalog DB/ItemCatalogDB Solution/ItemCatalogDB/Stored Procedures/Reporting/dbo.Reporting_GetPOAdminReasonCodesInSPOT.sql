/****** Object:  StoredProcedure [dbo].[Reporting_GetPOAdminReasonCodesInSPOT]    Script Date: 04/16/2012 11:52:59 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Reporting_GetPOAdminReasonCodesInSPOT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Reporting_GetPOAdminReasonCodesInSPOT]
GO
