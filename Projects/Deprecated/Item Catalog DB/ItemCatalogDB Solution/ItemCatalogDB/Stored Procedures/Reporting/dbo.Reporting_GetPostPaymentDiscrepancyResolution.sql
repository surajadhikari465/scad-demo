/****** Object:  StoredProcedure [dbo].[Reporting_GetPostPaymentDiscrepancyResolution]    Script Date: 04/27/2012 14:38:29 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Reporting_GetPostPaymentDiscrepancyResolution]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Reporting_GetPostPaymentDiscrepancyResolution]
GO
