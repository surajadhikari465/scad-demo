IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'InsertPriceChangeQueue')
BEGIN
	EXEC('CREATE PROCEDURE [mammoth].[InsertPriceChangeQueue] AS BEGIN SET NOCOUNT ON; END')
END
GO

ALTER PROCEDURE [mammoth].[InsertPriceChangeQueue]
