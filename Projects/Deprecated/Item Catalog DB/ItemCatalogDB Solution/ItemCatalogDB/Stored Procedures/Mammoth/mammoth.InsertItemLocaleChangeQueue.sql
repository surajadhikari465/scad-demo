IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'InsertItemLocaleChangeQueue')
	EXEC('CREATE PROCEDURE [mammoth].[InsertItemLocaleChangeQueue] AS BEGIN SET NOCOUNT ON; END')
GO

ALTER PROCEDURE [mammoth].[InsertItemLocaleChangeQueue]
	@Item_Key int,
	@Store_No int = NULL,
