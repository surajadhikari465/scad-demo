if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[IMHA_Update_Costs]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[IMHA_Update_Costs]
go
