 /****** Object:  StoredProcedure [dbo].[UpdateOrdersApplyNewVendorCost]    Script Date: 06/18/2009 15:08:33 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[UpdateOrdersApplyNewVendorCost]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[UpdateOrdersApplyNewVendorCost]


/****** Object:  StoredProcedure [dbo].[UpdateOrdersApplyNewVendorCost]    Script Date: 06/18/2009 14:44:04 ******/
SET ANSI_NULLS ON
GO
...
GO
Begin
	GRANT EXECUTE ON [dbo].[UpdateOrdersApplyNewVendorCost] TO [IRMAAdminRole]
End
GO