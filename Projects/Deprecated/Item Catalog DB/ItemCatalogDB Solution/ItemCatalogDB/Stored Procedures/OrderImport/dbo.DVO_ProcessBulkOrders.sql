print 'Creating DVO_ProcessBulkOrders Stored Proc ...'
go
if exists (select * from dbo.sysobjects where  name = 'DVO_ProcessBulkOrders') drop procedure DVO_ProcessBulkOrders;
go
