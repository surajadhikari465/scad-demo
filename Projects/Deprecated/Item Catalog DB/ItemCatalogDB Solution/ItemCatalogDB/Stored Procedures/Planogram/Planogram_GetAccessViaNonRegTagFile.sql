/****** Object:  StoredProcedure [dbo].[Planogram_GetAccessViaNonRegTagFile]    Script Date: 06/21/2012 17:08:20 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Planogram_GetAccessViaNonRegTagFile]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Planogram_GetAccessViaNonRegTagFile]
GO

CREATE PROCEDURE [dbo].[Planogram_GetAccessViaNonRegTagFile]
...
-- ****************************************************************************************************************
-- Procedure: Planogram_GetAccessViaNonRegTagFile()
--    Author: unknown
--      Date: unknown
--
--
...
BEGIN
	...
	BEGIN CATCH
		...
		RAISERROR ('Planogram_GetAccessViaNonRegTagFile failed with  @ErrorMessage' , -- Message text.
