...
/****** Object:  StoredProcedure [dbo].[Planogram_GetPrintLabSetRegTagFile]    Script Date: 06/22/2007 11:08:20 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Planogram_GetPrintLabSetRegTagFile]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Planogram_GetPrintLabSetRegTagFile]
GO
