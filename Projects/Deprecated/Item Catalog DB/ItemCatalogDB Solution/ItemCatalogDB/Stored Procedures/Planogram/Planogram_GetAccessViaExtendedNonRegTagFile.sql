/****** Object:  StoredProcedure [dbo].[Planogram_GetAccessViaExtendedNonRegTagFile]    Script Date: 06/24/2012 10:30:20 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Planogram_GetAccessViaExtendedNonRegTagFile]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Planogram_GetAccessViaExtendedNonRegTagFile]
GO
