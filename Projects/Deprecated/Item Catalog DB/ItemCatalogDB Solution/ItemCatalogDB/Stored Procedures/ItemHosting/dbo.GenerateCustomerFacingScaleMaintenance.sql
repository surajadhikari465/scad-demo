IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[GenerateCustomerFacingScaleMaintenance]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[GenerateCustomerFacingScaleMaintenance]
GO
...
ALTER PROCEDURE dbo.GenerateCustomerFacingScaleMaintenance
	@ItemKey int,
