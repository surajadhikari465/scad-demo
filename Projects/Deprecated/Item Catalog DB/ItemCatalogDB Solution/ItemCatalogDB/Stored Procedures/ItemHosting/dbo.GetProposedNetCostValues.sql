/****** Object:  StoredProcedure [dbo].[GetProposedNetCostValues]    Script Date: 2/12/2007 11:06:56 ******/
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[GetProposedNetCostValues]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[GetProposedNetCostValues]
GO
