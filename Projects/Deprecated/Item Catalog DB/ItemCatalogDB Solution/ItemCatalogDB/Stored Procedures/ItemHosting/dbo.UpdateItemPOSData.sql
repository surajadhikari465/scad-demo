/****** Object:  StoredProcedure [dbo].[UpdateItemPOSData]    Script Date: 09/26/2006 ******/
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[UpdateItemPOSData]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[UpdateItemPOSData]
GO
