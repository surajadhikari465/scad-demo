/****** Object:  StoredProcedure [dbo].[GetScalePLUConflicts]    Script Date: 1/17/2007 11:06:56 ******/
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[GetScalePLUConflicts]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[GetScalePLUConflicts]
GO
