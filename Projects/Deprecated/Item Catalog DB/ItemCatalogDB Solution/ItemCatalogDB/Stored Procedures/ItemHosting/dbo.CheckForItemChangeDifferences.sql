...
IF EXISTS (select * from dbo.sysobjects where id = object_id(N'[dbo].[CheckForItemChangeDifferences]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[CheckForItemChangeDifferences]
GO
