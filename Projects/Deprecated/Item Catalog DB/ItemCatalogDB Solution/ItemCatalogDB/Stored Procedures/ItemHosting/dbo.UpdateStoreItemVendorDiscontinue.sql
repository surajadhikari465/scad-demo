...
IF exists (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'[dbo].[UpdateStoreItemVendorDiscontinue]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[UpdateStoreItemVendorDiscontinue]
GO
