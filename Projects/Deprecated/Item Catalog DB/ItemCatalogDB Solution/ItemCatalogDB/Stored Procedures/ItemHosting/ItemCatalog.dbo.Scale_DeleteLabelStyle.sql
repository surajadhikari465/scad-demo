if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[Scale_DeleteLabelStyle]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[Scale_DeleteLabelStyle]
GO
