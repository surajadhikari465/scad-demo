...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Reporting_SpecialsByDateRange]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[Reporting_SpecialsByDateRange]
GO
