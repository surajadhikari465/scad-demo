...
/****** Object:  StoredProcedure [dbo].[InventoryBalance]    Script Date: 10/04/2012 15:35:59 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[InventoryBalance]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[InventoryBalance]
GO
