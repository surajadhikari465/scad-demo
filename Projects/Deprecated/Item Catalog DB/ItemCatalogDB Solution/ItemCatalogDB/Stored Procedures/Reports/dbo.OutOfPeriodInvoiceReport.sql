...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[OutOfPeriodInvoiceReport]') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[OutOfPeriodInvoiceReport]
GO
