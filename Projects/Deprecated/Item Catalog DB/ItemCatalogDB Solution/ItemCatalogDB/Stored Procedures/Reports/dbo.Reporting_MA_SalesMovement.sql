IF EXISTS (select * from dbo.sysobjects where id = object_id(N'[dbo].Reporting_MA_SalesMovement') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
	BEGIN
		DROP  Procedure  [dbo].Reporting_MA_SalesMovement
	END
GO
