/****** Object:  StoredProcedure [dbo].[InvoiceDiscrepanciesReport]    Script Date: 06/13/2012 10:08:07 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[InvoiceDiscrepanciesReport]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[InvoiceDiscrepanciesReport]
GO
