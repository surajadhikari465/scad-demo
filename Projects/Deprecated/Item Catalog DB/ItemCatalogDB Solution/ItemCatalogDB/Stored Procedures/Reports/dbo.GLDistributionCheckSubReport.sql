/****** Object:  StoredProcedure [dbo].[GLDistributionCheckSubReport]    Script Date: 02/08/2012 12:28:05 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GLDistributionCheckSubReport]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[GLDistributionCheckSubReport]
GO
...
CREATE PROCEDURE [dbo].[GLDistributionCheckSubReport]
...
AS
   ...
   -- **************************************************************************
   -- Procedure: GLDistributionCheckSubReport
   --    Author: n/a
   --      Date: n/a
   --
   -- Description:
   ...
   -- 12/22/2011  BAS	3744	updated aggregation to consume new column
   --							OrderHeader.AdjustedReceivedCost instead
