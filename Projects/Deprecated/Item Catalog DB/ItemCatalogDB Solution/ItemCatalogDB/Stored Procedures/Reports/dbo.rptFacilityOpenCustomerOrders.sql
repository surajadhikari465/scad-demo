...
IF EXISTS (SELECT name 
	   FROM   sysobjects 
	   WHERE  name = N'rptFacilityOpenCustomerOrders' 
	   AND 	  type = 'P')
    DROP PROCEDURE rptFacilityOpenCustomerOrders
GO
...
grant exec on dbo.rptFacilityOpenCustomerOrders to IRMAClientRole, IRMAReportsRole, IRMASchedJobsRole, IRMASupportRole
