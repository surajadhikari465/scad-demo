...
/****** Object:  StoredProcedure [dbo].[Reporting_ItemList_UseLastCost]    Script Date: 1/11/2013 11:06:17 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Reporting_ItemList_UseLastCost]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Reporting_ItemList_UseLastCost]
GO
