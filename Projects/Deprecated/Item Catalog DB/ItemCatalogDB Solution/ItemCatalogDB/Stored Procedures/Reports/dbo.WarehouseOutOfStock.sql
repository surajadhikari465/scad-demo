...
/****** Object:  StoredProcedure [dbo].[WarehouseOutOfStock]    Script Date: 10/04/2012 16:23:15 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[WarehouseOutOfStock]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[WarehouseOutOfStock]
GO
