/****** Object:  StoredProcedure [dbo].[DynamicMovement]    Script Date: 09/10/2012 10:14:12 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DynamicMovement]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[DynamicMovement]
GO
