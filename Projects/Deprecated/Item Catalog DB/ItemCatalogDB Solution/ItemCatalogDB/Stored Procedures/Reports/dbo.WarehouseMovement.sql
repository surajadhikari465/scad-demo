...
/****** Object:  StoredProcedure [dbo].[WarehouseMovement]    Script Date: 10/04/2012 16:20:58 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[WarehouseMovement]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[WarehouseMovement]
GO
