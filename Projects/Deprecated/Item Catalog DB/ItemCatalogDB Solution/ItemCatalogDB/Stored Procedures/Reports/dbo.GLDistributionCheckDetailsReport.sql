/****** Object:  StoredProcedure [dbo].[GLDistributionCheckDetailsReport]    Script Date: 02/08/2012 12:30:00 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GLDistributionCheckDetailsReport]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[GLDistributionCheckDetailsReport]
GO
