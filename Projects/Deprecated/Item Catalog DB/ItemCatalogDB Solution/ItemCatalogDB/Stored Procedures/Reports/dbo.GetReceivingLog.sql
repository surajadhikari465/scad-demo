/****** Object:  StoredProcedure [dbo].[GetReceivingLog]    Script Date: 11/23/2011 09:47:29 ******/
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GetReceivingLog]') AND type in (N'P', N'PC'))
begin
	EXEC ('CREATE PROCEDURE [dbo].[GetReceivingLog] AS SELECT 1')
end
GO

/****** Object:  StoredProcedure [dbo].[GetReceivingLog]    Script Date: 02/06/2012 09:08:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[GetReceivingLog] 
    @Store_No	int,
    @Begin		varchar(255),
    @End		varchar(255),
    @SubTeam_No int
