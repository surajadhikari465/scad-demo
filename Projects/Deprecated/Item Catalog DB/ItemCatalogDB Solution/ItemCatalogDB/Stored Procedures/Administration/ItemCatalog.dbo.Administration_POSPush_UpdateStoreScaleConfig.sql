/****** Object:  StoredProcedure [dbo].[Administration_POSPush_UpdateStoreScaleConfig]    Script Date: 05/19/2006 16:03:50 ******/
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[Administration_POSPush_UpdateStoreScaleConfig]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[Administration_POSPush_UpdateStoreScaleConfig]
GO
