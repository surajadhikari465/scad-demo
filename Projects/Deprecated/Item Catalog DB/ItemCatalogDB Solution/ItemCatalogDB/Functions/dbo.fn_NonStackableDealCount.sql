if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[fn_NonStackableDealCount]') and xtype in (N'FN', N'IF', N'TF'))
drop function [dbo].[fn_NonStackableDealCount]
GO
