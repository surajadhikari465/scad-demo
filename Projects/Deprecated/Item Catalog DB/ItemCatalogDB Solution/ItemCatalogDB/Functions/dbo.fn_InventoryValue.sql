...
/****** Object:  UserDefinedFunction [dbo].[fn_InventoryValue]    Script Date: 10/04/2012 16:33:09 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[fn_InventoryValue]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
DROP FUNCTION [dbo].[fn_InventoryValue]
GO
