/****** Object:  View [dbo].[EIM_Jurisdiction_ItemView]    Script Date: 01/18/2011 06:47:13 ******/
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[EIM_Jurisdiction_ItemView]'))
DROP VIEW [dbo].[EIM_Jurisdiction_ItemView]
GO

/****** Object:  View [dbo].[EIM_Jurisdiction_ItemView]    Script Date: 01/18/2011 06:47:17 ******/
SET ANSI_NULLS ON
GO
