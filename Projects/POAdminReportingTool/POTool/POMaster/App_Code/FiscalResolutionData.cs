...
namespace POReports
{
    public class FiscalResolutionData
    {
        ...
        private void ResetData()
        {
            TotalPO = 0;
            SuspendedPO = 0;
            ResolutionCode = "Not Specified";
            FiscalWeek = null;
            FiscalPeriod = null;
            Region = "";
        }

        public FiscalResolutionData()
        {
            ResetData();
        }
        ...
        public FiscalResolutionData(FiscalWeek _data, string _region)
        {
            ResetData();
        ...
        public FiscalResolutionData(FiscalWeek _data, string _resolutionCode, string _region)
        {
            ResetData();
            SetFiscalWeek(_data, _region);
        ...
        public FiscalResolutionData(FiscalPeriod _data, string _resolutionCode, string _region)
        {
            ResetData();
        ...
        {
            if (FiscalPeriod.Period == 0 || FiscalPeriod.Year == 0 || String.IsNullOrEmpty(ResolutionCode))
            {
                return;
            }
            ...
            {
                SqlCommand cmd = new SqlCommand("GetResolutionCodePOTotals", cn);
        ...
        {
            if (FiscalWeek.Period == 0 || FiscalWeek.Year == 0 || FiscalWeek.Week == 0 || String.IsNullOrEmpty(ResolutionCode))
            {
                return;
            }
