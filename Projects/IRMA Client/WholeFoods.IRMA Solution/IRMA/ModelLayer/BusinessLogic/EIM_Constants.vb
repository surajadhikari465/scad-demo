...
#Region "Attribute Key Constants"
        ...
        Public Shared JURISDICTION_ATTR_KEY_ARRAY As String() = New String() {EIM_Constants.ITEM_IS_DEFAULT_JURISDICTION_ATTR_KEY, _
                            EIM_Constants.ITEM_JURISDICTION_ID_ATTR_KEY, _
                            EIM_Constants.ITEM_ITEM_DESCRIPTION_ATTR_KEY, _
                            EIM_Constants.ITEM_POS_DESCRIPTION_ATTR_KEY, _
                            EIM_Constants.ITEM_SIGN_DESCRIPTION_ATTR_KEY, _
                            EIM_Constants.ITEM_PACKAGE_DESC1_ATTR_KEY, _
                            EIM_Constants.ITEM_PACKAGE_DESC2_ATTR_KEY, _
                            EIM_Constants.ITEM_PACKAGE_UNIT_ID_ATTR_KEY, _
                            EIM_Constants.ITEM_RETAIL_UNIT_ID_ATTR_KEY, _
                            EIM_Constants.ITEM_DISTRIBUTION_UNIT_ID_ATTR_KEY, _
                            EIM_Constants.ITEM_VENDOR_UNIT_ID_ATTR_KEY, _
                            EIM_Constants.ITEM_FOOD_STAMPS_ATTR_KEY, _
                            EIM_Constants.ITEM_DISCOUNTABLE_ATTR_KEY, _
                            EIM_Constants.ITEM_PRICE_REQUIRED_ATTR_KEY, _
                            EIM_Constants.ITEM_QUANTITY_REQUIRED_ATTR_KEY, _
                            EIM_Constants.ITEM_MANUFACTURING_UNIT_ID_ATTR_KEY, _
                            EIM_Constants.ITEM_QTYPROHIBIT_ATTR_KEY, _
                            EIM_Constants.ITEM_CASE_DISCOUNT_ATTR_KEY, _
                            EIM_Constants.ITEM_COUPON_MULTIPLIER_ATTR_KEY, _
                            EIM_Constants.ITEM_MISC_TRANSACTION_SALE_ATTR_KEY, _
                            EIM_Constants.ITEM_ICE_TARE_ATTR_KEY, _
                            EIM_Constants.ITEM_SCALEDESC1_ATTR_KEY, _
                            EIM_Constants.ITEM_SCALEDESC2_ATTR_KEY, _
                            EIM_Constants.ITEM_SCALEDESC3_ATTR_KEY, _
                            EIM_Constants.ITEM_SCALEDESC4_ATTR_KEY, _
                            EIM_Constants.ITEMSCALE_SCALE_EXTRATEXT_LABEL_TYPE_ATTR_KEY, _
                            EIM_Constants.SCALE_EXTRATEXT_EXTRATEXT, _
                            EIM_Constants.ITEMSCALE_SCALE_TARE_ID_ATTR_KEY, _
                            EIM_Constants.ITEMSCALE_SCALE_SCALEUOMUNIT_ID_ATTR_KEY, _
                            EIM_Constants.ITEMSCALE_SCALE_RANDOMWEIGHTTYPE_ID_ATTR_KEY, _
                            EIM_Constants.ITEMSCALE_SCALE_FIXEDWEIGHT_ATTR_KEY, _
                            EIM_Constants.ITEMSCALE_SCALE_BYCOUNT_ATTR_KEY, _
                            EIM_Constants.ITEMSCALE_SHELFLIFE_LENGTH_ATTR_KEY, _
                            EIM_Constants.ITEM_BRAND_ID_ATTR_KEY, _
                            EIM_Constants.ITEM_COSTEDBYWEIGHT, _
                            EIM_Constants.ITEM_COUNTRYOFPROC_ATTR_KEY, _
                            EIM_Constants.ITEM_FSAELIGIBLE_ATTR_KEY, _
                            EIM_Constants.ITEM_INGREDIENT_ATTR_KEY, _
                            EIM_Constants.ITEM_LABELTYPE_ID_ATTR_KEY, _
                            EIM_Constants.ITEM_LOCKAUTH_ATTR_KEY, _
                            EIM_Constants.ITEM_NOTAVAILABLE_ATTR_KEY, _
                            EIM_Constants.ITEM_NOTAVAILABLENOTE_ATTR_KEY, _
                            EIM_Constants.ITEM_ORIGIN_ATTR_KEY, _
                            EIM_Constants.ITEM_PRODUCTCODE_ATTR_KEY, _
                            EIM_Constants.ITEM_SUSTAINABILITYRANKING_ATTR_KEY, _
                            EIM_Constants.ITEM_SUSTAINABILITYRANKINGREQUIRED_ATTR_KEY, _
