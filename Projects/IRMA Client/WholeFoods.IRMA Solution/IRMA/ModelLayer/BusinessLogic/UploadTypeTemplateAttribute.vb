...
Namespace WholeFoods.IRMA.ModelLayer.BusinessLogic
    ...
    ''' <summary>
    ''' Business Object for the UploadTypeTemplateAttribute db table.
    '''
    ''' This class inherits persistent properties from the regenerable base class.
    ''' These properties map one-to-one to columns in the UploadTypeTemplateAttribute db table.
    '''
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class UploadTypeTemplateAttribute
        Inherits UploadTypeTemplateAttributeRegen
...
#Region "Constructors"
        ...
        Public Sub New(ByRef inUploadTypeAttribute As UploadTypeAttribute, ByRef inUploadTypeTemplate As UploadTypeTemplate)
            MyBase.New(inUploadTypeAttribute, inUploadTypeTemplate)
        End Sub
