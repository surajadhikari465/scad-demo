...
Namespace WholeFoods.IRMA.Ordering.DataAccess
    Public Class ReturnOrderDAO
        ...
        ''' 
        ''' This class is calling from ReturnOrder.Vb class.
        ''' </summary>
        ''' <param name="OrderHeaderID"></param>
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Shared Function GetReturnOrderOrderItemID(ByVal OrderHeaderID As Integer) As Int32

            logger.Debug("GetReturnOrderOrderItemID entry: OrderHeaderID=" + OrderHeaderID.ToString)
            ...
            logger.Debug("GetReturnOrderOrderItemID exit")
            Return iOrderItemId
        End Function
    End Class
End Namespace
