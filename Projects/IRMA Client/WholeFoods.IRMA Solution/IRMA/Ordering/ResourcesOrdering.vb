...
' </summary>
Public NotInheritable Class ResourcesOrdering

    '
    ' Class fields
    '
    Private Shared resourceServices As WholeFoods.Utility.ResourceServices = New WholeFoods.Utility.ResourceServices("Ordering")
