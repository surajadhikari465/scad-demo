...
Friend Class frmAVCIAudit
	...
	Private Sub frmAVCIAudit_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		...
		Call LoadSubTeam((Me.cmbSubTeam))
		Call Me.cmbSubTeam.Items.Insert(0, "All Sub Teams")
		VB6.SetItemData(Me.cmbSubTeam, 0, -9999)
    ...
    Private Sub optTeam_CheckedChanged(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles optTeam.CheckedChanged
        If IsInitializing = True Then Exit Sub

        If eventSender.Checked Then
            cmbTeam.Visible = True
            cmbSubTeam.Visible = False
        End If
    End Sub
