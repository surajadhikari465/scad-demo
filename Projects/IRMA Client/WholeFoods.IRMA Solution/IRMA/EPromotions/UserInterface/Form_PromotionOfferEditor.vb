...
Imports WholeFoods.IRMA.Pricing.DataAccess          ' For Price Batch Detail
Imports WholeFoods.IRMA.EPromotions.BusinessLogic.Common    ' for BO_Irmabase enumerations
...
#Region "Private Methods"
    ...
    Private Sub InitializeForm(Optional ByVal ForceEditOfLocked As Boolean = False)
        ...
        ComboBox_Subteam.Enabled = Not _ReadOnlyOffer
    ...
    Private Sub BindSubTeamComboBox()
        Dim subteamDAO As New WholeFoods.IRMA.EPromotions.DataAccess.SubTeamDAO
        Dim subteamList As BindingList(Of SubTeamBO) = subteamDAO.GetSubTeamList()

        ComboBox_Subteam.DataSource = subteamList
...
#End Region
    ...
    Private Sub ComboBox_Subteam_DropDown(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox_Subteam.DropDown
        Dim MaxLen As Integer = 200
        Dim Len As Integer = 0
        For Each item As SubTeamBO In ComboBox_Subteam.Items
            Len = TextRenderer.MeasureText(item.SubTeamName, ComboBox_Subteam.Font).Width
            If Len > MaxLen Then MaxLen = Len
        Next
        ComboBox_Subteam.DropDownWidth = MaxLen
    End Sub
    ...
    Private Sub Form_PromotionOfferEditor_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        EditTabStop(ComboBox_Subteam, True, 4)
