...
#Region "Public Methods"
        ...
        Public Sub Add(ByVal key As Object, ByVal value As Object)
            If Me.ContainsKey(key) Then
                Throw New Exception("An item with the same key is already in the list.")
                Exit Sub
            End If
        ...
        Public Sub SortByValue(ByVal DESC As Boolean)
        ...
        Public Sub SortByPropertyValue(ByVal propertyName As String)
            SortByPropertyValue(propertyName, False)
        End Sub

        Public Sub SortByPropertyValue(ByVal propertyName As String, ByVal DESC As Boolean)
