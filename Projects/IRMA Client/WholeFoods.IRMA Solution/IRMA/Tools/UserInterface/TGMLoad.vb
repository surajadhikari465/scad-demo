...
Friend Class frmTGMLoad
    ...
    Private Sub frmTGMLoad_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub InitializeForm()
        ...
        sLastType = String.Empty

        '-- Make sure a file was selected
        If cdbFileOpen.FileName = "" Then
            Me.Close()
            Exit Sub
        End If
    ...
    End Sub
	Private Function Fields(ByRef sString As String) As Integer
		
		Dim lLoop, lCount As Integer
		
		For lLoop = 1 To Len(sString)
