...
Friend Class frmLocationItemManualCountReport
    Inherits System.Windows.Forms.Form

    Private IsInitializing As Boolean

    Private Sub frmLocationItemManualCountReport_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        CenterForm(Me)
    ...
    Private Sub cmdReport_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdReport.Click
        ...
        sReportURL = "InvLocationItemsManualCountSheet&rs:Command=Render&rc:Parameters=false" & "&InvLocID=" & VB6.GetItemData(cboLocation, cboLocation.SelectedIndex) & "&Store_Name=" & Trim(cboStore.Text) & "&SubTeam_Name=" & Trim(cboSubTeam.Text) & "&Location_Name=" & Trim(cboLocation.Text) & "&SortBy=" & Trim(cboSortBy.Text) & "&BarCode=" & cbBarCode.Checked
