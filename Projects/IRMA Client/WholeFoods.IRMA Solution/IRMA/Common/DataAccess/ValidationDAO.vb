...
Namespace WholeFoods.IRMA.Common.DataAccess
    ...
    Public Class ValidationDAO
        ...
        Public Shared Function IsErrorCode(ByVal valCode As Integer) As Boolean
            ...
            logger.Debug("IsErrorCode Entry with Value code =" + valCode.ToString())
            ...
            logger.Debug("IsErrorCode Exit with isError= " + isError.ToString())
        ...
        Public Shared Function GetValidationCodeDetails(ByVal valCode As Integer) As ValidationBO
            ...
            logger.Debug("GetValidationCodeDetails Entry with valCode=" + valCode.ToString())
            ...
            Try
                ...
                While results.Read
                    ...
                    If results.GetValue(results.GetOrdinal("ValidationCodeType_Description")).GetType IsNot GetType(DBNull) Then
                        validation.ValidationCodeTypeDesc = results.GetString(results.GetOrdinal("ValidationCodeType_Description"))
                    End If

                    If results.GetValue(results.GetOrdinal("ValidationCode_Description")).GetType IsNot GetType(DBNull) Then
                        validation.ValidationCodeDesc = results.GetString(results.GetOrdinal("ValidationCode_Description"))
                    End If
                End While
            ...
            logger.Debug("GetValidationCodeDetails Exit")
