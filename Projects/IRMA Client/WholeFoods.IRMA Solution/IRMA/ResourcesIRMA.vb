...
' </summary>
Public NotInheritable Class ResourcesIRMA

    '
    ' Class fields
    '
    Private Shared resourceServices As WholeFoods.Utility.ResourceServices = New WholeFoods.Utility.ResourceServices("IRMA")
