...
' </summary>
Public NotInheritable Class ResourcesItemHosting

    '
    ' Class fields
    '
    Private Shared resourceServices As WholeFoods.Utility.ResourceServices = New WholeFoods.Utility.ResourceServices("ItemHosting")
