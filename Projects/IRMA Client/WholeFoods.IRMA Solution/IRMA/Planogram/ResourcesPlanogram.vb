...
' </summary>
Public NotInheritable Class ResourcesPlanogram

    '
    ' Class fields
    '
    Private Shared resourceServices As WholeFoods.Utility.ResourceServices = New WholeFoods.Utility.ResourceServices("Planogram")
