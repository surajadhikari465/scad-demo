...
#Region "Property Definitions"
        ...
        Overrides Property WriterFilename(ByVal currentStore As StoreUpdatesBO) As String
            Get
                ...
                Select Case CBool(CInt(ConfigurationServices.AppSettings("UseDefaultScaleFileName")))
                    'Select Case CBool(CInt(My.Resources.UseDefaultScaleFileName))
                    Case True
                        retval = _scaleFilename
                    Case False
