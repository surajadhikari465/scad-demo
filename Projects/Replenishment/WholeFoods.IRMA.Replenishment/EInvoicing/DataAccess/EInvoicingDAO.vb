...
Namespace WholeFoods.IRMA.Replenishment.EInvoicing.DataAccess
    Public Class EInvoicingDAO
        ...
        Public Function GetOrderHeaderIDForDSDOrder(ByRef Invoice_Num As String, ByRef PO_Num As String, ByRef Vendor_ID As String) As DataTable
            Dim factory As New DataFactory(DataFactory.ItemCatalog)
            Dim paramList As New ArrayList
            Dim currentParam As DBParam = Nothing
            ...
            Return factory.GetStoredProcedureDataTable("EInvoicing_GetOrderHeaderIDForDSDOrder", paramList)
