...
Module HARTExportTransferModule
    ...
    Private Const CLASSNAME As String = "HARTExportTransferJob"
    ...
    Sub Main()
        ...
        Try
            ...
            logger.Info("[ HART EXPORT TRANSFER JOB START ]")

            Try

                ' initialize and run the job
                Dim HARTJob As New HARTExportTransferJob
                HARTJob.Main()
