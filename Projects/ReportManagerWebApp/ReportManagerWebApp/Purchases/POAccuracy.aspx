<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" Inherits="ReportManagerWebApp.Purchases_POAccuracyReport" Title="PO Accuracy Report" Codebehind="POAccuracy.aspx.vb" %>
    ...
    <asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        <div id="navbar">
            <h3>
                <a href="..\Default.aspx">Home</a> &gt; Purchases &gt; PO Accuracy Report</h3>
        </div>
        <br />
