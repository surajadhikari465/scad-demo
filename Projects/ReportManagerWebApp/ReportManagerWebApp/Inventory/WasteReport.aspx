<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" Inherits="ReportManagerWebApp.Inventory_WasteReport" Title="Waste Report" Codebehind="WasteReport.aspx.vb" %>
    ...
    <asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        <div id="navbar">
            <h3>
                <a href="..\Default.aspx">Home</a> &gt; <a href="InventoryReports.aspx?valuePath=Reports Home/Inventory">
                    Inventory Reports</a> &gt; Waste Report</h3>
        </div>
        <br />
            ...
            <table style="width: 524px; table-layout: fixed;">
                <tr>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                        ControlToValidate="cmbStore" ErrorMessage=" * Required"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <asp:DropDownList ID="cmbSubTeam" runat="server"
                        Width="250px" DataSourceID="ICSubteams" DataTextField="SubTeam_Name" 
                        DataValueField="SubTeam_No"></asp:DropDownList>
                    ...
                    <td valign="top">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="cmbSubTeam"
                        ErrorMessage=" * Required" Visible="False"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
