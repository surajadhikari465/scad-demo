<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" Inherits="ReportManagerWebApp.Misc_IRMAScanAudit" title="Report Manager - IRMA Scan Audit" Codebehind="IRMAScanAudit.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="navbar"><h3><a href="..\Default.aspx">Home</a> &gt; <a href="MiscReports.aspx?valuePath=Reports Home/Misc">Miscellaneous Reports</a> &gt; IRMA Scan Audit</h3>
    </div>
    <table border="0">
        <tr>
        ...
        <tr>
            ...
            <td style="width: 249px; text-align: left">
                ...
                SelectCommand="SELECT UserName, User_Id FROM Users WHERE AccountEnabled = 1 ORDER BY UserName" ProviderName="<%$ ConnectionStrings:ReportManager_Conn.ProviderName %>"></asp:SqlDataSource>
            </td>
            <td style="width: 318px; text-align: left">
            </td>
        </tr>
        <tr>
            ...
            <td style="width: 249px; text-align: left">
                ...
                SelectCommand="SELECT SubTeam_Name, SubTeam_No FROM SubTeam ORDER BY SubTeam_Name" ProviderName="<%$ ConnectionStrings:ReportManager_Conn.ProviderName %>"></asp:SqlDataSource>
            </td>
            <td style="width: 318px; text-align: left">
            </td>
        </tr>
