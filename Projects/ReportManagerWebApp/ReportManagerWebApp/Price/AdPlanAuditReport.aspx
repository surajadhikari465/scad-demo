<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" Inherits="ReportManagerWebApp.Price_Ad_Plan_Audit_Report" title="Ad Plan Audit Report" Codebehind="AdPlanAuditReport.aspx.vb" %>
...
<div id="navbar">
        <h3>
            <a href="..\Default.aspx">Home</a> &gt; <a href="PriceReports.aspx?valuePath=Reports Home/Prices">
                Price Reports</a> &gt; Ad Plan Audit Report</h3>
    </div>
    <asp:Table runat="server" ID="table1">
        <asp:TableRow>
            <asp:TableCell>
                Store (Hold down Ctrl key to select multiple values):
            </asp:TableCell>
            <asp:TableCell>
                <asp:ListBox ID="cmbStores" runat="server" SelectionMode="Multiple" DataSourceID="ICStores" DataTextField="Store_Name"
                    DataValueField="Store_No"></asp:ListBox>
        ...
        <asp:TableRow>
            <asp:TableCell>
                Sub Team (Hold down Ctrl key to select multiple values):
            </asp:TableCell>
            <asp:TableCell> 
                <asp:ListBox ID="cmbSubTeam" runat="server" SelectionMode="Multiple" DataSourceID="ICSubTeams" DataTextField="SubTeam_Name"
                    DataValueField="SubTeam_No"></asp:ListBox>
