Partial Class Distribution_QOHVendorPack
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        'report name
        sReportURL.Append(Application.Get("region") + "_" + "OnHandVendorPack")
        ...
        If cmbSubTeam.SelectedValue <> 0 Then
            sReportURL.Append("&DistSubTeam_No=" & cmbSubTeam.SelectedValue)
        End If
