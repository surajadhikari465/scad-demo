<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" Inherits="ReportManagerWebApp.Sales_CommodityCodeMovement" title="Commodity Code Movement Summary" Codebehind="CommodityCodeMovement.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="navbar"><a href="..\Default.aspx"></a> 
        <h3><a href="..\Default.aspx">Home</a>&gt; <a href="SalesReports.aspx?valuePath=Reports Home/Sales">Sales Reports</a>&gt; Commodity Code Movement Summary</h3>
    </div>
