<%@ Page Language="VB" MasterPageFile="~/UserInterface/MasterPage.master" AutoEventWireup="false" Inherits="SLIM.UserInterface_RefreshPOS_SearchResults" title="Refresh Search Results" Codebehind="SearchResults.aspx.vb" %>
        ...
        <asp:View ID="vwDesktop" runat="server">
            ...
            <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server">
                ...
                <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="NotSet" BorderCollapseDefault="Separate"
                    ...
                    <GroupByBox BoxStyle-BackColor="ActiveBorder" BoxStyle-BorderColor="Window"></GroupByBox>
                    ...
                    <Pager AllowPaging="True" MinimumPagesForDisplay="2" PagerStyle-BackColor="LightGray" PagerStyle-BorderStyle="Solid" PagerStyle-BorderWidth="1px">
                    </Pager>
                    <AddNewBox BoxStyle-BackColor="Window" BoxStyle-BorderColor="InactiveCaption" BoxStyle-BorderStyle="Solid" BoxStyle-BorderWidth="1px"></AddNewBox>
