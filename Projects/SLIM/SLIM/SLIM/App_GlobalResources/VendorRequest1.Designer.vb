...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("VendorRequest1"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class VendorRequest1
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As VendorRequest1 = CType(MyBase.Clone,VendorRequest1)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "VendorRequest1"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/VendorRequest1.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As VendorRequest1 = New VendorRequest1()
    ...
    Partial Public Class VendorRequestDataTable
        ...
        Private Shared columnIRMA_Add_Date_defaultValue As Date = Date.Parse("1900-01-01T02:00:00")
        ...
        Public Overloads Function AddVendorRequestRow( _
            ...
            Dim columnValuesArray() As Object = New Object() {Nothing, VendorStatus_ID, Vendor_Key, CompanyName, City, State, ZipCode, Phone, User_Store, UserAccessLevel_ID, User_ID, PS_Vendor_ID, InsuranceNumber, Email, Insert_Date, IRMA_Add_Date, Ready_To_Apply, Address_Line_2, Address_Line_1, Comment, Fax, PS_Export_Vendor_ID}
        ...
        Private Sub InitClass()
            ...
            Me.columnInsuranceNumber.MaxLength = 20
            Me.columnEmail.MaxLength = 50
            Me.columnIRMA_Add_Date.DefaultValue = CType(VendorRequestDataTable.columnIRMA_Add_Date_defaultValue,Date)
...
Namespace VendorRequest1TableAdapters
    ...
    Partial Public Class VendorRequestTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [VendorRequest] ([VendorStatus_ID], [Vendor_Key], [CompanyName], [Cit"& _ 
                ...
                "dy_To_Apply], [Address_Line_2], [Address_Line_1], [Comment], [Fax], [PS_Export_V"& _ 
                "endor_ID]) VALUES (@VendorStatus_ID, @Vendor_Key, @CompanyName, @City, @State, @"& _ 
                "ZipCode, @Phone, @User_Store, @UserAccessLevel_ID, @User_ID, @PS_Vendor_ID, @Ins"& _ 
                "uranceNumber, @Email, @Insert_Date, @IRMA_Add_Date, @Ready_To_Apply, @Address_Li"& _ 
                "ne_2, @Address_Line_1, @Comment, @Fax, @PS_Export_Vendor_ID)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@PS_Export_Vendor_ID", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "PS_Export_Vendor_ID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [VendorRequest] SET [VendorStatus_ID] = @VendorStatus_ID, [Vendor_Key] = @"& _ 
                ...
                "ddress_Line_2] = @Address_Line_2, [Address_Line_1] = @Address_Line_1, [Comment] "& _ 
                "= @Comment, [Fax] = @Fax, [PS_Export_Vendor_ID] = @PS_Export_Vendor_ID WHERE ((["& _ 
                "VendorRequest_ID] = @Original_VendorRequest_ID))"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@PS_Export_Vendor_ID", Global.System.Data.SqlDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "PS_Export_Vendor_ID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     VendorRequest_ID, VendorStatus_ID, Vendor_Key, CompanyName, City, Stat"& _ 
                "e, ZipCode, Phone, User_Store, UserAccessLevel_ID, User_ID, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                  "& _ 
                "    PS_Vendor_ID, InsuranceNumber, Email, Insert_Date, IRMA_Add_Date, Ready_To_A"& _ 
                "pply, Address_Line_2, Address_Line_1, Comment, Fax, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      PS_E"& _ 
                "xport_Vendor_ID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         VendorRequest"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (VendorRequest_ID = @Vend"& _ 
                "orRequest_ID)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@VendorRequest_ID", Global.System.Data.SqlDbType.Int, 4, Global.System.Data.ParameterDirection.Input, 0, 0, "VendorRequest_ID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT Address_Line_1, Address_Line_2, City, Comment, CompanyName, Email, ISNULL("& _ 
                "IRMA_Add_Date, GetDate()) As IRMA_Add_Date, Insert_Date, InsuranceNumber, PS_Ven"& _ 
                "dor_ID, Phone, Ready_To_Apply, State, UserAccessLevel_ID, User_ID, User_Store, V"& _ 
                "endorRequest_ID, VendorStatus_ID, Vendor_Key, ZipCode FROM VendorRequest WHERE ("& _ 
                "VendorRequest_ID = @VendorRequest_ID)"
            ...
            Me._commandCollection(2).CommandText = "SELECT Address_Line_1, Address_Line_2, City, Comment, CompanyName, Email, IRMA_Ad"& _ 
                "d_Date, Insert_Date, InsuranceNumber, PS_Vendor_ID, Phone, Ready_To_Apply, State"& _ 
                ", UserAccessLevel_ID, User_ID, User_Store, VendorRequest_ID, VendorStatus_ID, Ve"& _ 
                "ndor_Key, ZipCode FROM VendorRequest WHERE (VendorStatus_ID = 2) ORDER BY IRMA_A"& _ 
                "dd_Date DESC"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(3) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(3).Connection = Me.Connection
            Me._commandCollection(3).CommandText = "SELECT Address_Line_1, Address_Line_2, City, Comment, CompanyName, Email, IRMA_Ad"& _ 
                "d_Date, Insert_Date, InsuranceNumber, PS_Vendor_ID, Phone, Ready_To_Apply, State"& _ 
                ", UserAccessLevel_ID, User_ID, User_Store, VendorRequest_ID, VendorStatus_ID, Ve"& _ 
                "ndor_Key, ZipCode FROM VendorRequest WHERE (VendorStatus_ID = 2) ORDER BY IRMA_A"& _ 
                "dd_Date DESC"
            ...
            Me._commandCollection(4).CommandText = "SELECT     COUNT(*) AS Expr1"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         VendorRequest"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (CompanyName "& _ 
                "= @CompanyName)"
            Me._commandCollection(4).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(4).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@CompanyName", Global.System.Data.SqlDbType.VarChar, 50, Global.System.Data.ParameterDirection.Input, 0, 0, "CompanyName", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Public Overloads Overridable Function GetData1(ByVal dataTable As VendorRequest1.VendorRequestDataTable, ByVal VendorRequest_ID As Integer) As Integer
        ...
        Public Overloads Overridable Function GetData(ByVal VendorRequest_ID As Integer) As VendorRequest1.VendorRequestDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(VendorRequest_ID,Integer)
            Dim dataTable As VendorRequest1.VendorRequestDataTable = New VendorRequest1.VendorRequestDataTable()
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As VendorRequest1.VendorRequestDataTable, ByVal VendorRequest_ID As Integer) As Integer
        ...
        Public Overloads Overridable Function GetVendorRequest(ByVal VendorRequest_ID As Integer) As VendorRequest1.VendorRequestDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(VendorRequest_ID,Integer)
            Dim dataTable As VendorRequest1.VendorRequestDataTable = New VendorRequest1.VendorRequestDataTable()
            Me.Adapter.Fill(dataTable)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillBy1(ByVal dataTable As VendorRequest1.VendorRequestDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetProcessedVendors() As VendorRequest1.VendorRequestDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(2)
            Dim dataTable As VendorRequest1.VendorRequestDataTable = New VendorRequest1.VendorRequestDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillBy2(ByVal dataTable As VendorRequest1.VendorRequestDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetAllProcessedVendors() As VendorRequest1.VendorRequestDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(3)
            Dim dataTable As VendorRequest1.VendorRequestDataTable = New VendorRequest1.VendorRequestDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As VendorRequest1.VendorRequestDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As VendorRequest1) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function VendorRequestExists(ByVal CompanyName As String) As Global.System.Nullable(Of Integer)
