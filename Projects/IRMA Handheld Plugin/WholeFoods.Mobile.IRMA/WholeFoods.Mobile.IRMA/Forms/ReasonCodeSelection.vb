Public Class ReasonCodeSelection
    ...
    Private Sub DataGridReasonCode_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGridReasonCode.Click
