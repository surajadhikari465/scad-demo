...
Namespace Common
    ...
    Public Class StoreList
        Inherits WfmReadOnlyListBase(Of StoreList, StoreInfo)

#Region " Factory Methods "

        Public Overloads Shared Function GetList() As StoreList

            Return DataPortal.Fetch(Of StoreList)(New FetchCriteria())

        End Function
        Public Overloads Shared Function GetList(ByVal PosWriterID As Integer) As StoreList

            Return DataPortal.Fetch(Of StoreList)(New FetchCriteria(PosWriterID))
            ...
            Using cn As New SqlConnection(connString)
                ...
                Using cm As SqlCommand = cn.CreateCommand
                    With cm
                        ...
                        If Criteria.POSWriterID = -1 Then
                            .CommandText = "GetStores"
                        Else
                            .CommandText = "Administration_GetSourceStores"
