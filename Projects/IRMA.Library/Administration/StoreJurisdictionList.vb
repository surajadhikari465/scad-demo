...
Namespace Administration
    <Serializable()> _
    Public Class StoreJurisdictionList
        Inherits WfmReadOnlyListBase(Of StoreJurisdictionList, StoreJurisdictionInfo)

#Region " Factory Methods "

        Public Overloads Shared Function GetList() As StoreJurisdictionList

            Return DataPortal.Fetch(Of StoreJurisdictionList)()
            ...
            Using cn As New SqlConnection(connString)
                ...
                Using cm As SqlCommand = cn.CreateCommand
                    With cm
                        ...
                        .CommandText = "GetStoreJurisdictions"
                        Me.IsReadOnly = False
                        Using dr As New SafeDataReader(.ExecuteReader)
                            While dr.Read()
                                Dim info As New StoreJurisdictionInfo(dr)
                                Me.Add(info)
                            End While
                        End Using
                        Me.IsReadOnly = True
