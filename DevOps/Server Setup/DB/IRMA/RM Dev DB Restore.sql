...
FROM DISK = N'\\atx-nas\irmabackups\rm-prd4\rmp\itemcatalog\itemcatalog.Full.BAK' WITH FILE = 1, 
...
/*
MOVE N'ItemCatalog_Data' TO N'F:\SQL_DATA\ItemCatalog_Test.mdf',
MOVE N'ItemCatalog_Log' TO N'L:\SQL_LOGS\ItemCatalog_Test_5.ldf',
MOVE N'Warehouse_Data' TO N'F:\SQL_DATA\ItemCatalog_Test_4.ndf',
MOVE N'ItemCatalog2' TO N'F:\SQL_DATA\ItemCatalog_Test_1.ndf',
MOVE N'ItemCatalog3' TO N'F:\SQL_DATA\ItemCatalog_Test_2.ndf',
MOVE N'ItemCatalog4' TO N'F:\SQL_DATA\ItemCatalog_Test_3.ndf',


RESTORE DATABASE itemcatalog WITH RECOVERY
go
...
WHERE name like 'itemcatalog%'



LOGS

9/17/18 (first restore)
...
Processed 15243192 pages for database 'ItemCatalog', file 'ItemCatalog_Data' on file 1.
Processed 13043920 pages for database 'ItemCatalog', file 'ItemCatalog2' on file 1.
Processed 14501768 pages for database 'ItemCatalog', file 'ItemCatalog3' on file 1.
Processed 15893848 pages for database 'ItemCatalog', file 'ItemCatalog4' on file 1.
Processed 240 pages for database 'ItemCatalog', file 'Warehouse_Data' on file 1.
Processed 17864 pages for database 'ItemCatalog', file 'ItemCatalog_Log' on file 1.
RESTORE DATABASE successfully processed 58700832 pages in 2756.893 seconds (166.346 MB/sec).
...
RESTORE DATABASE successfully processed 58700832 pages in 1053.971 seconds (435.116 MB/sec).
...
90 percent processed.
100 percent processed.
Processed 15286576 pages for database 'ItemCatalog', file 'ItemCatalog_Data' on file 1.
Processed 13080256 pages for database 'ItemCatalog', file 'ItemCatalog2' on file 1.
Processed 14546064 pages for database 'ItemCatalog', file 'ItemCatalog3' on file 1.
Processed 15933264 pages for database 'ItemCatalog', file 'ItemCatalog4' on file 1.
Processed 240 pages for database 'ItemCatalog', file 'Warehouse_Data' on file 1.
Processed 639570 pages for database 'ItemCatalog', file 'ItemCatalog_Log' on file 1.
Converting database 'ItemCatalog' from version 655 to the current version 869.
Database 'ItemCatalog' running the upgrade step from version 655 to version 668.
Database 'ItemCatalog' running the upgrade step from version 668 to version 669.
Database 'ItemCatalog' running the upgrade step from version 669 to version 670.
...
Database 'ItemCatalog' running the upgrade step from version 867 to version 868.
Database 'ItemCatalog' running the upgrade step from version 868 to version 869.
RESTORE DATABASE successfully processed 59485970 pages in 1210.328 seconds (383.973 MB/sec).
