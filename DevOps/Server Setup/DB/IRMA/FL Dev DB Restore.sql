...
FROM DISK = N'\\atx-nas\irmabackups\fl-prd2\flp\itemcatalog\itemcatalog.Full.BAK' WITH FILE = 1,  
MOVE N'ItemCatalog_Data' TO N'e:\SQL_DATA_01\files\ItemCatalog_Data.mdf',  
MOVE N'ItemCatalog_Log' TO N'e:\SQL_LOGS_01\files\ItemCatalog_Log.ldf',  
MOVE N'Warehouse_Data' TO N'e:\SQL_DATA_01\files\Warehouse_Data.mdf',  
MOVE N'ItemCatalog2' TO N'e:\SQL_DATA_01\files\ItemCatalog2.mdf',  
MOVE N'ItemCatalog3' TO N'e:\SQL_DATA_01\files\ItemCatalog3.mdf',  
MOVE N'ItemCatalog4' TO N'e:\SQL_DATA_01\files\ItemCatalog4.mdf',    
...
/*
Started 2018-10-16 23:22:43.507
Processed 8972248 pages for database 'ItemCatalog', file 'ItemCatalog_Data' on file 1.
Processed 13637648 pages for database 'ItemCatalog', file 'ItemCatalog2' on file 1.
Processed 15374656 pages for database 'ItemCatalog', file 'ItemCatalog3' on file 1.
Processed 16798456 pages for database 'ItemCatalog', file 'ItemCatalog4' on file 1.
Processed 2864 pages for database 'ItemCatalog', file 'Warehouse_Data' on file 1.
Processed 78911 pages for database 'ItemCatalog', file 'ItemCatalog_Log' on file 1.
...
RESTORE DATABASE successfully processed 54864783 pages in 2133.743 seconds (200.882 MB/sec).

12/5/18
Processed 8902400 pages for database 'ItemCatalog', file 'ItemCatalog_Data' on file 1.
Processed 13731288 pages for database 'ItemCatalog', file 'ItemCatalog2' on file 1.
Processed 15449208 pages for database 'ItemCatalog', file 'ItemCatalog3' on file 1.
Processed 16829160 pages for database 'ItemCatalog', file 'ItemCatalog4' on file 1.
Processed 2864 pages for database 'ItemCatalog', file 'Warehouse_Data' on file 1.
Processed 37412 pages for database 'ItemCatalog', file 'ItemCatalog_Log' on file 1.
Converting database 'ItemCatalog' from version 655 to the current version 869.
Database 'ItemCatalog' running the upgrade step from version 655 to version 668.
Database 'ItemCatalog' running the upgrade step from version 668 to version 669.
Database 'ItemCatalog' running the upgrade step from version 669 to version 670.
...
Database 'ItemCatalog' running the upgrade step from version 867 to version 868.
Database 'ItemCatalog' running the upgrade step from version 868 to version 869.
RESTORE DATABASE successfully processed 54952332 pages in 1039.058 seconds (413.177 MB/sec).
...
Processed 8927216 pages for database 'ItemCatalog', file 'ItemCatalog_Data' on file 1.
Processed 13844400 pages for database 'ItemCatalog', file 'ItemCatalog2' on file 1.
Processed 15553872 pages for database 'ItemCatalog', file 'ItemCatalog3' on file 1.
Processed 16932184 pages for database 'ItemCatalog', file 'ItemCatalog4' on file 1.
Processed 2864 pages for database 'ItemCatalog', file 'Warehouse_Data' on file 1.
Processed 25017 pages for database 'ItemCatalog', file 'ItemCatalog_Log' on file 1.
Converting database 'ItemCatalog' from version 655 to the current version 869.
Database 'ItemCatalog' running the upgrade step from version 655 to version 668.
Database 'ItemCatalog' running the upgrade step from version 668 to version 669.
Database 'ItemCatalog' running the upgrade step from version 669 to version 670.
...
Database 'ItemCatalog' running the upgrade step from version 867 to version 868.
Database 'ItemCatalog' running the upgrade step from version 868 to version 869.
RESTORE DATABASE successfully processed 55285553 pages in 1243.611 seconds (347.309 MB/sec).
...
90 percent processed.
100 percent processed.
Processed 8896560 pages for database 'ItemCatalog', file 'ItemCatalog_Data' on file 1.
Processed 13846944 pages for database 'ItemCatalog', file 'ItemCatalog2' on file 1.
Processed 15550080 pages for database 'ItemCatalog', file 'ItemCatalog3' on file 1.
Processed 16904792 pages for database 'ItemCatalog', file 'ItemCatalog4' on file 1.
Processed 2864 pages for database 'ItemCatalog', file 'Warehouse_Data' on file 1.
Processed 13872 pages for database 'ItemCatalog', file 'ItemCatalog_Log' on file 1.
Converting database 'ItemCatalog' from version 655 to the current version 869.
Database 'ItemCatalog' running the upgrade step from version 655 to version 668.
Database 'ItemCatalog' running the upgrade step from version 668 to version 669.
Database 'ItemCatalog' running the upgrade step from version 669 to version 670.
...
Database 'ItemCatalog' running the upgrade step from version 867 to version 868.
Database 'ItemCatalog' running the upgrade step from version 868 to version 869.
RESTORE DATABASE successfully processed 55215112 pages in 1272.730 seconds (338.931 MB/sec).
