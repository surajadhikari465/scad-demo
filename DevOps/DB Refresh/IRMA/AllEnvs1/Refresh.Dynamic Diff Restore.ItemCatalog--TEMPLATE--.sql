...
print '______________________ HARD-CODING DIFF RESTORE UNTIL WE CAN EXEC XP_CMDSHELL ______________________'
	print '[' + convert(nvarchar, getdate(), 121) + '] ' + '****Blind DIFF Restore****...'
	PRINT (@restoreSql)
	exec sp_executesql @restoreSql
