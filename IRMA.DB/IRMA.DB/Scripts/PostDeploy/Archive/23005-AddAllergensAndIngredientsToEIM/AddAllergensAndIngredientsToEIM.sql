...
IF NOT EXISTS (SELECT * FROM UploadAttribute WHERE Name = 'Scale Allergens')
...
VALUES('Scale Allergens', 'scale_allergen', 'allergens', 'TextBox', 'varchar', 4200, NULL, 0, 0, NULL, NULL, NULL, 1,  NULL,  NULL,  NULL, @MaxSpreadSheetPosition, NULL)

-- ***** Get inserted UploadAttribute_ID ******
SELECT  @UploadAttribute_Id = UploadAttribute_ID FROM UploadAttribute WHERE Name = 'Scale Allergens'
...
VALUES ('ITEM_MAINTENANCE', @UploadAttribute_ID, 0, 1, 0, @GridPosition, 0, 1, 'Scale Data')
...
IF NOT EXISTS (SELECT * FROM UploadAttribute WHERE Name = 'Scale Ingredients')
INSERT INTO [UploadAttribute]([Name], [TableName], [ColumnNameOrKey], [ControlType], [DbDataType], [Size], [DisplayFormatString], [IsRequiredValue], [IsCalculated], [DefaultValue], [OptionalMinValue], [OptionalMaxValue], [IsActive], [PopulateProcedure], [PopulateIndexField], [PopulateDescriptionField], [SpreadsheetPosition],[ValueListStaticData]) 
VALUES('Scale Ingredients', 'scale_ingredient', 'ingredients', 'TextBox', 'varchar', 4200, NULL, 0, 0, NULL, NULL, NULL, 1,  NULL,  NULL,  NULL, @MaxSpreadSheetPosition, NULL)

-- ***** Get inserted UploadAttribute_ID ******
SELECT  @UploadAttribute_Id = UploadAttribute_ID FROM UploadAttribute WHERE Name = 'Scale Ingredients'
