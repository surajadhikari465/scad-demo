...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[fn_ReceiveUPCPLUUpdateFromIcon] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[fn_ReceiveUPCPLUUpdateFromIcon] TO [IRSUser]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[fn_ReceiveUPCPLUUpdateFromIcon] TO [IConInterface]
    AS [dbo];
