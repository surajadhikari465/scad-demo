...
--*****************************************************************************************
-- Description: This fuction returns aggregated tlog results to update ItemHistory table.
--		This function is used by SP UpdateItemHistoryFromSalesSumByItem
-- History:
-- Date		DEV	TFS	Description
-- 08/15/2015	DN	16344	Function creation
--*****************************************************************************************

CREATE FUNCTION dbo.fn_UpdateItemHistory_GetSalesSummary
(
@Date		DATETIME,
@StoreNo	INT
)
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[fn_UpdateItemHistory_GetSalesSummary] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[fn_UpdateItemHistory_GetSalesSummary] TO [IRSUser]
    AS [dbo];
