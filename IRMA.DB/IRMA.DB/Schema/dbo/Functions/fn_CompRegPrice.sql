...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[fn_CompRegPrice] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[fn_CompRegPrice] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[fn_CompRegPrice] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[fn_CompRegPrice] TO [IRMAReportsRole]
    AS [dbo];
