CREATE TABLE [dbo].[AvgCostHistory] (
    ...
    CONSTRAINT [pk_AvgCostHistory_AvgCostHistoryId] PRIMARY KEY CLUSTERED ([AvgCostHistoryId] ASC, [Effective_Date] ASC) WITH (FILLFACTOR = 90),
...
CREATE NONCLUSTERED INDEX [IX_AvgCostHistory]
    ON [dbo].[AvgCostHistory]([Item_Key] ASC, [Store_No] ASC, [SubTeam_No] ASC, [Effective_Date] ASC);
