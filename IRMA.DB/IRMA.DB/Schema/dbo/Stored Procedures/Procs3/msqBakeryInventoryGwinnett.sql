CREATE PROCEDURE dbo.msqBakeryInventoryGwinnett
...
WHERE Vendor.Vendor_ID IN (5319,5004,5139,203,3573,355,5116,390,5318,5141,6352,5701,5058,5793,5467)    
AND SubTeam_No = 4200 AND Price.Store_No = 106  	      
