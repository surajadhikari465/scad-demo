...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ItemVendorCostCurrent] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ItemVendorCostCurrent] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ItemVendorCostCurrent] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ItemVendorCostCurrent] TO [IRMAReportsRole]
    AS [dbo];
