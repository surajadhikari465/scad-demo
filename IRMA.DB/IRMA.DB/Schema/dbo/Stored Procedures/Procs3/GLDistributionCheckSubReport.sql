...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GLDistributionCheckSubReport] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GLDistributionCheckSubReport] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GLDistributionCheckSubReport] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GLDistributionCheckSubReport] TO [IRMAReportsRole]
    AS [dbo];
