/****** Object:  Stored Procedure dbo.msqGetBakeryVendorInventoryItems    Script Date: 9/19/2005 2:00:41 PM ******/
CREATE PROCEDURE dbo.msqGetBakeryVendorInventoryItems @StoreNo int
...
AND OH.Transfer_To_SubTeam = 4200
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[msqGetBakeryVendorInventoryItems] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[msqGetBakeryVendorInventoryItems] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[msqGetBakeryVendorInventoryItems] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[msqGetBakeryVendorInventoryItems] TO [IRMAReportsRole]
    AS [dbo];
