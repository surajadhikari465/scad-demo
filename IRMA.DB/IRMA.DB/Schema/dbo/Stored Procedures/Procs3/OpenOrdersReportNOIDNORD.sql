...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[OpenOrdersReportNOIDNORD] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[OpenOrdersReportNOIDNORD] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[OpenOrdersReportNOIDNORD] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[OpenOrdersReportNOIDNORD] TO [IRMAReportsRole]
    AS [dbo];
