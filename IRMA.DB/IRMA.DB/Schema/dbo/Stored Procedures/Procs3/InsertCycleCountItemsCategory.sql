CREATE PROCEDURE dbo.InsertCycleCountItemsCategory
	@CycleCountID int
	,@SubTeam_No int
	,@Category_ID int
	,@InvLocID int = null
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertCycleCountItemsCategory] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertCycleCountItemsCategory] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertCycleCountItemsCategory] TO [IRMAReportsRole]
    AS [dbo];
