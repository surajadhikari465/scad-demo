...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[OrdersReceivedNotClosedReport] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[OrdersReceivedNotClosedReport] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[OrdersReceivedNotClosedReport] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[OrdersReceivedNotClosedReport] TO [IRMAReportsRole]
    AS [dbo];
