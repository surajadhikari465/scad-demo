...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[NoSells] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[NoSells] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[NoSells] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[NoSells] TO [IRMAReportsRole]
    AS [dbo];
