...
SELECT Store.BusinessUnit_ID AS Unit, 'ACTUAL' AS Ledger, '220000' AS Account, NULL AS Dept, NULL AS Prod,
...
UNION
SELECT Store.BusinessUnit_ID AS Unit, 'ACTUAL' AS Ledger, '400000' AS Account, StoreSubTeam.Team_No AS Dept, SubTeam.SubTeam_No AS Prod,
       '' AS Aff, '' AS Proj, 'USD' AS Curr, 
...
UNION
SELECT Store.BusinessUnit_ID AS Unit, 'ACTUAL' AS Ledger, Item.Sales_Account AS Account, StoreSubTeam.Team_No AS Dept, SubTeam.SubTeam_No AS Prod,
       '' AS Aff, '' AS Proj, 'USD' AS Curr, 
       0 - SUM(Sales_Amount) + SUM(Return_Amount) + SUM(Markdown_Amount) + SUM(Promotion_Amount) AS Amount,
...
UNION 
SELECT Store.BusinessUnit_ID AS Unit, 'ACTUAL' AS Ledger, '234000' AS Account, NULL AS Dept, NULL AS Prod,
       '' AS Aff, '' AS Proj, 'USD' AS Curr, 
...
UNION
SELECT Store.BusinessUnit_ID AS Unit, 'ACTUAL' AS Ledger, '236000' AS Account, NULL AS Dept, NULL AS Prod,
       '' AS Aff, '' AS Proj, 'USD' AS Curr, 
...
GROUP BY Store.BusinessUnit_ID, Buggy_SumByRegister.Date_Key, Store.Store_Name, Store.Store_No
UNION
SELECT Store.BusinessUnit_ID AS Unit, 'ACTUAL' AS Ledger, '780000' AS Account, NULL AS Dept, NULL AS Prod,
       '' AS Aff, '' AS Proj, 'USD' AS Curr, 
