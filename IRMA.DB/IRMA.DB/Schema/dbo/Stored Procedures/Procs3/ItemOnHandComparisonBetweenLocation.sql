...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ItemOnHandComparisonBetweenLocation] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ItemOnHandComparisonBetweenLocation] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ItemOnHandComparisonBetweenLocation] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ItemOnHandComparisonBetweenLocation] TO [IRMAReportsRole]
    AS [dbo];
