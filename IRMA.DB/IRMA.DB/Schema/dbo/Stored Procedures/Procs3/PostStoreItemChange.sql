...
CREATE PROCEDURE dbo.PostStoreItemChange 
    @Item_Key int, 
    @Store_No int, 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PostStoreItemChange] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PostStoreItemChange] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PostStoreItemChange] TO [IRMAReportsRole]
    AS [dbo];
