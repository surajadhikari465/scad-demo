CREATE PROCEDURE dbo.MovementCompSales
@Month int,
@Year int,
@Team_No int,
@SubTeam_No int,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MovementCompSales] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MovementCompSales] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MovementCompSales] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MovementCompSales] TO [IRMAReportsRole]
    AS [dbo];
