...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GLDistributionCheckFromSubReport] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GLDistributionCheckFromSubReport] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GLDistributionCheckFromSubReport] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GLDistributionCheckFromSubReport] TO [IRMAReportsRole]
    AS [dbo];
