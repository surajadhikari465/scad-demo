...
CREATE PROCEDURE [dbo].[Replenishment_TagPush_GetAccessViaExtendedBatchTagFile]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_TagPush_GetAccessViaExtendedBatchTagFile] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_TagPush_GetAccessViaExtendedBatchTagFile] TO [IRMAClientRole]
    AS [dbo];
