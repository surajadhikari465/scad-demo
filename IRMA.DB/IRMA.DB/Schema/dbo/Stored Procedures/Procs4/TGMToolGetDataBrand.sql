CREATE PROCEDURE dbo.TGMToolGetDataBrand
    @SubTeam_No int, 
...
BEGIN
    ...
    AND dbo.fn_GetDiscontinueStatus(Item.Item_Key,NULL,NULL) <= @Discontinue_Item AND WFM_Item >= @WFM_Item AND Brand_ID = @Brand_ID 
    ...
    LEFT OUTER JOIN 
	OnHand OH (nolock)
	ON Item.Item_Key = OH.Item_Key AND Store.Store_No = OH.Store_No AND OH.SubTeam_No = @SubTeam_No
 END
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TGMToolGetDataBrand] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TGMToolGetDataBrand] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TGMToolGetDataBrand] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TGMToolGetDataBrand] TO [IRMAReportsRole]
    AS [dbo];
