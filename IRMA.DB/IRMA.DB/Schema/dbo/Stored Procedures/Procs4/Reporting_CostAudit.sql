...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_CostAudit] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_CostAudit] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_CostAudit] TO [IRMAReportsRole]
    AS [dbo];
