...
CREATE PROCEDURE [dbo].[Replenishment_TagPush_GetAccessViaExtendedReprintTagFile]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_TagPush_GetAccessViaExtendedReprintTagFile] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_TagPush_GetAccessViaExtendedReprintTagFile] TO [IRMAClientRole]
    AS [dbo];
