...
CREATE PROCEDURE dbo.Replenishment_POSPush_PopulateNonBatchIconPOSPushStaging
AS
	/*********************************************************************************************
CHANGE LOG
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_POSPush_PopulateNonBatchIconPOSPushStaging] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_POSPush_PopulateNonBatchIconPOSPushStaging] TO [IRSUser]
    AS [dbo];
