CREATE PROCEDURE dbo.TGMToolGetDataAll
    @SubTeam_No int, 
...
BEGIN
    ...
    AND dbo.fn_GetDiscontinueStatus(Item.Item_Key,NULL,NULL) <= @Discontinue_Item AND WFM_Item >= @WFM_Item AND Retail_Sale = 1 AND Deleted_Item = 0
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TGMToolGetDataAll] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TGMToolGetDataAll] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TGMToolGetDataAll] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TGMToolGetDataAll] TO [IRMAReportsRole]
    AS [dbo];
