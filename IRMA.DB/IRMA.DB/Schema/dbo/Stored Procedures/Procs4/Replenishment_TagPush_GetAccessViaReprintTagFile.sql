...
CREATE PROCEDURE [dbo].[Replenishment_TagPush_GetAccessViaReprintTagFile]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_TagPush_GetAccessViaReprintTagFile] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_TagPush_GetAccessViaReprintTagFile] TO [IRMAClientRole]
    AS [dbo];
