...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[StoreOpsOrdersExport] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[StoreOpsOrdersExport] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[StoreOpsOrdersExport] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[StoreOpsOrdersExport] TO [IRMAReportsRole]
    AS [dbo];
