...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TGMToolGetDataVendor] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TGMToolGetDataVendor] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TGMToolGetDataVendor] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TGMToolGetDataVendor] TO [IRMAReportsRole]
    AS [dbo];
