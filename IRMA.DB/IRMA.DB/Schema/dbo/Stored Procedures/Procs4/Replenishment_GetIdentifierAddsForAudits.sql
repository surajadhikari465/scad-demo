...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_GetIdentifierAddsForAudits] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_GetIdentifierAddsForAudits] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_GetIdentifierAddsForAudits] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_GetIdentifierAddsForAudits] TO [IRMAReportsRole]
    AS [dbo];
