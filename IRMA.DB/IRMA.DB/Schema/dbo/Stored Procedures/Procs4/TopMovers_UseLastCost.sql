...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TopMovers_UseLastCost] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TopMovers_UseLastCost] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TopMovers_UseLastCost] TO [IRMAReportsRole]
    AS [dbo];
