...
print '[' + convert(nvarchar, getdate(), 121) + '] ' + 'Finish: [ItemCatalog.dbo.Replenishment_Tlog_House_UpdateSalesSumByItem.sql]'

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_Tlog_House_UpdateSalesSumByItem] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_Tlog_House_UpdateSalesSumByItem] TO [IRSUser]
    AS [dbo];
