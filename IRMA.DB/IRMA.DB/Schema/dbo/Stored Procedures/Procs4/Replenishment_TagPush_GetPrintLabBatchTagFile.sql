...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_TagPush_GetPrintLabBatchTagFile] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_TagPush_GetPrintLabBatchTagFile] TO [IRMAClientRole]
    AS [dbo];
