...
print '[' + convert(nvarchar, getdate(), 121) + '] ' + 'Finish: [ItemCatalog.dbo.Replenishment_POSPush_UpdateOffPromoCostRecords.sql]'

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_POSPush_UpdateOffPromoCostRecords] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_POSPush_UpdateOffPromoCostRecords] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_POSPush_UpdateOffPromoCostRecords] TO [IRMASchedJobsRole]
    AS [dbo];
