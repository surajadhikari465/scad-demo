...
CREATE PROCEDURE [dbo].[Replenishment_ScalePush_GetIdentifierDeletes]
    @Date				datetime,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_ScalePush_GetIdentifierDeletes] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_ScalePush_GetIdentifierDeletes] TO [IRSUser]
    AS [dbo];
