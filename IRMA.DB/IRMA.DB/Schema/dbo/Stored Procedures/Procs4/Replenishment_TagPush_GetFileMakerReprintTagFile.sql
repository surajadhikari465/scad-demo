...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_TagPush_GetFileMakerReprintTagFile] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_TagPush_GetFileMakerReprintTagFile] TO [IRMAClientRole]
    AS [dbo];
