CREATE PROCEDURE dbo.TopMoversSummary
...
BEGIN
    ...
    SELECT Store_Name, 
           ...
           SUM(SF.AvgCost * dbo.Fn_ItemSalesQty(TI.Identifier, ItemUnit.Weight_Unit, Price_Level, 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TopMoversSummary] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TopMoversSummary] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TopMoversSummary] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TopMoversSummary] TO [IRMAReportsRole]
    AS [dbo];
