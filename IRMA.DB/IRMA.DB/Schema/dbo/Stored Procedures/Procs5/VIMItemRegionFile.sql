...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[VIMItemRegionFile] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[VIMItemRegionFile] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[VIMItemRegionFile] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[VIMItemRegionFile] TO [IRMAReportsRole]
    AS [dbo];
