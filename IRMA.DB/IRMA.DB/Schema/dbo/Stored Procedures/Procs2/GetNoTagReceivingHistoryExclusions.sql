...
CREATE PROCEDURE [dbo].[GetNoTagReceivingHistoryExclusions]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetNoTagReceivingHistoryExclusions] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetNoTagReceivingHistoryExclusions] TO [IRSUser]
    AS [dbo];
