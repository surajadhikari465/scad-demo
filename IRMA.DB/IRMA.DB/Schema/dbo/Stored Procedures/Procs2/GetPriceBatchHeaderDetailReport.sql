...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetPriceBatchHeaderDetailReport] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetPriceBatchHeaderDetailReport] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetPriceBatchHeaderDetailReport] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetPriceBatchHeaderDetailReport] TO [IRMAReportsRole]
    AS [dbo];
