...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetPriceBatchDetailDetailReport] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetPriceBatchDetailDetailReport] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetPriceBatchDetailDetailReport] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetPriceBatchDetailDetailReport] TO [IRMAReportsRole]
    AS [dbo];
