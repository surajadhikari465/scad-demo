...
CREATE PROCEDURE dbo.DeleteItemInventory 
    @Item_Key int,
	@UserID int,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[DeleteItemInventory] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[DeleteItemInventory] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[DeleteItemInventory] TO [IRMAReportsRole]
    AS [dbo];
