...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[CreditReasonReport] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[CreditReasonReport] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[CreditReasonReport] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[CreditReasonReport] TO [IRMAReportsRole]
    AS [dbo];
