...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Administration_GetPriceBatchHeaderSearch] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Administration_GetPriceBatchHeaderSearch] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Administration_GetPriceBatchHeaderSearch] TO [IRMAClientRole]
    AS [dbo];
