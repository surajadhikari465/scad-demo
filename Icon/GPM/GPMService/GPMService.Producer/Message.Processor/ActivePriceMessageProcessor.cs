    ...
    internal class ActivePriceMessageProcessor : IMessageProcessor
    {
        ...
        public void ProcessMessage(ReceivedMessage receivedMessage)
        {
            ...
            try
            {
                ...
                activePriceProcessorDAL.UpdateStatusToRunning(jobScheduleMessage.JobScheduleId);
                ...
                activePriceProcessorDAL.UpdateStatusToReady(jobScheduleMessage.JobScheduleId);
