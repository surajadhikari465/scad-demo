...
{
    [TestClass]
    public class SendFailedPricesToEsbServiceTests
    {
        private SendFailedPricesToEsbService service;
        ...
        public void Initialize()
        {
            ...
            service = new SendFailedPricesToEsbService(settings, mockSettingsFactory.Object, mockEsbConnectionFactory.Object, mockMessageBuilder.Object);
        ...
        [TestMethod]
        public void SendFailedPricesToEsbService_ErrorPricesExist_SendsPricesToEsb()
        {
            //Given
        ...
        [TestMethod]
        public void SendFailedPricesToEsbService_ErrorPricesDoNotExist_DoesNotSendPricesToEsb()
        {
            //Given
        ...
        [TestMethod]
        public void SendFailedPricesToEsbService_ConnectionFactoryThrowsError_SetsErrorOnPrices()
        {
            //Given
            prices.Add(new PriceModel { ErrorCode = Errors.Codes.SendFailedPricesToEsbError });
            ...
            {
                Assert.AreEqual(Errors.Codes.SendFailedPricesToEsbError, price.ErrorCode);
