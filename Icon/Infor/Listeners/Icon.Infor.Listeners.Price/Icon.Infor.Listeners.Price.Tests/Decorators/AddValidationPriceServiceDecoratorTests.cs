...
{
    [TestClass]
    public class AddValidationPriceServiceDecoratorTests
    {
        private AddValidationPriceServiceDecorator decorator;
        ...
        public void InitializeTest()
        {
            ...
            this.decorator = new AddValidationPriceServiceDecorator(this.mockPriceService.Object, this.mockGetPricesQuery.Object);
