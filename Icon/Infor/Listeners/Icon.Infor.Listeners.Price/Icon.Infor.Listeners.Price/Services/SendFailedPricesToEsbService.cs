...
{
    public class SendFailedPricesToEsbService : IService<PriceModel>
    {
        ...
        public SendFailedPricesToEsbService(
        ...
        {
            this.settings = settingsFactory.CreateConnectionSettings(typeof(SendFailedPricesToEsbService));
        ...
        public void Process(IEnumerable<PriceModel> data, IEsbMessage message)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    price.ErrorCode = Errors.Codes.SendFailedPricesToEsbError;
