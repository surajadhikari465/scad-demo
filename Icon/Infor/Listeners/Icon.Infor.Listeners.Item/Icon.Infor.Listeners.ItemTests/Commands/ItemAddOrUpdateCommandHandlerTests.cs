...
namespace Icon.Infor.Listeners.Item.Tests.Commands
{
    ...
    public class ItemAddOrUpdateCommandHandlerTests
    {
            ...
            HierarchyClass newNationalHierarchyClass)
        {
            ...
            item.Biodynamic = "0";
            item.CheeseMilkType = MilkTypes.Descriptions.CowGoatMilk;
            item.CheeseRaw = "1";
            item.EcoScaleRating = EcoScaleRatings.Descriptions.BaselineOrange;
            ...
            item.FreshOrFrozen = SeafoodFreshOrFrozenTypes.Descriptions.Fresh;
            item.SeafoodCatchType = SeafoodCatchTypes.Descriptions.Wild;
