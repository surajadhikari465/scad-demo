...
namespace Icon.Infor.Listeners.Item.Tests.Validators
{
	...
	public class ItemModelValidatorTests
	{
		...
		[TestMethod]
		public void ValidateCollection_AnimalWelfareRatingAStringUpTo255Characters_NoError()
		{
			//Given
			testItem.AnimalWelfareRating = new string('a', 255);
		...
		[TestMethod]
		public void ValidateCollection_MilkTypeAStringUpTo255Characters_NoError()
		{
			//Given
			testItem.MilkType = new string('a', 255);
		...
		[TestMethod]
		public void ValidateCollection_MilkTypeIsEmpty_NoError()
		{
			//Given
			testItem.MilkType = string.Empty;
		...
		[TestMethod]
		public void ValidateCollection_MilkTypeIsNull_NoError()
		{
			//Given
			testItem.MilkType = null;
		...
		[TestMethod]
		public void ValidateCollection_DeliverySystemAStringUpTo255Characters_NoError()
		{
			//Given
			testItem.DeliverySystem = new string('a', 255);
		...
		[TestMethod]
		public void ValidateCollection_DeliverySystemIsNull_NoError()
		{
			//Given
			testItem.DeliverySystem = null;
		...
		[TestMethod]
		public void ValidateCollection_DrainedWeightUomAStringUpTo255Characters_NoError()
		{
			//Given
			testItem.DrainedWeightUom = new string('a', 255);
		...
		[TestMethod]
		public void ValidateCollection_DrainedWeightUomIsNull_NoError()
		{
			//Given
			testItem.DrainedWeightUom = null;
		...
		[TestMethod]
		public void ValidateCollection_EcoScaleRatingAStringUpTo255Characters_NoError()
		{
			//Given
			testItem.EcoScaleRating = new string('a', 255);
		...
		[TestMethod]
		public void ValidateCollection_EcoScaleRatingIsNull_NoError()
		{
			//Given
			testItem.EcoScaleRating = null;
		...
		[TestMethod]
		public void ValidateCollection_FreshOrFrozenAStringUpTo255Characters_NoError()
		{
			//Given
			testItem.FreshOrFrozen = new string('a', 255);
		...
		[TestMethod]
		public void ValidateCollection_FreshOrFrozenIsNull_NoError()
		{
			//Given
			testItem.FreshOrFrozen = null;
		...
		[TestMethod]
		public void ValidateCollection_SeafoodCatchTypeAStringUpTo255Characters_NoError()
		{
			//Given
			testItem.SeafoodCatchType = new string('a', 255);
		...
		[TestMethod]
		public void ValidateCollection_SeafoodCatchTypeIsEmpty_NoError()
		{
			//Given
		...
		[TestMethod]
		public void ValidateCollection_SeafoodCatchTypeIsNull_NoError()
		{
			//Given
			testItem.SeafoodCatchType = null;
