    ...
    public class ItemAddOrUpdateCommandHandler : ICommandHandler<ItemAddOrUpdateCommand>
    {
        ...
        private void AddOrUpdateItemTraits(IconContext context, IEnumerable<ItemModel> data)
        {
            var itemTraits = data.SelectMany(i => new[] {
                ...
                new ItemTraitModel(i.ItemId, Traits.NonGmo, i.NonGmo, Locales.WholeFoods),
                new ItemTraitModel(i.ItemId, Traits.Organic, i.Organic, Locales.WholeFoods),
                new ItemTraitModel(i.ItemId, Traits.GlutenFree, i.GlutenFree, Locales.WholeFoods),
