    ...
    public class ItemAddOrUpdateCommandHandler : ICommandHandler<ItemAddOrUpdateCommand>
    {
        ...
        private void AddOrUpdateItemTraits(IconContext context, IEnumerable<ItemModel> data)
        {
            var itemTraits = data.SelectMany(i => new[]
            {
                ...
                new ItemTraitModel(i.ItemId, Traits.NonGmoTransparency, i.NonGMOTransparency, Locales.WholeFoods),
                ...
                new ItemTraitModel(i.ItemId, Traits.ItemWeight, i.ItemWeight, Locales.WholeFoods),
                ...
                new ItemTraitModel(i.ItemId, Traits.KitchenItem, i.KitchenItem.HasValue ? i.KitchenItem.Value.BoolToString() : null,Locales.WholeFoods),
                new ItemTraitModel(i.ItemId, Traits.HospitalityItem, i.HospitalityItem.HasValue ? i.HospitalityItem.Value.BoolToString() : null,Locales.WholeFoods),
            });
