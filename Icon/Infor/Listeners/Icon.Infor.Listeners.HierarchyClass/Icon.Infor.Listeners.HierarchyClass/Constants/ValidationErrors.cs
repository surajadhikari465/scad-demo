...
namespace Icon.Infor.Listeners.HierarchyClass.Constants
{
    public static class ValidationErrors
    {
        ...
        public static class Descriptions
        {
            ...
            public static readonly string InvalidNationalClassCodeLength = "NationalClassCode trait has an invalid value '{PropertyValue}'. It must be 5 numeric characters only.";
