...
namespace NutritionWebApi.Tests.Unit.Controllers
{
    ...
    public class NutritionControllerTests
    {
        ...
        public void Initialize()
        {
            ...
            controller = new NutritionController(getNutritionItemQuery.Object, addOrUpdateNutritionItemCommandHandler.Object, logger.Object);
        }
        ...
        {
            // Given.
            addOrUpdateNutritionItemCommandHandler.Setup(ai => ai.Execute(It.IsAny<AddOrUpdateNutritionItemCommand>()))
                .Throws(new Exception("Error: Value must be provided."));
            ...
            // When.
            controller.AddOrUpdateNutritionItem(itemModel);
        }
