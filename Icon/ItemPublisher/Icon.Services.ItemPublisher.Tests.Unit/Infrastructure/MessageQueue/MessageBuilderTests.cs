...
namespace Icon.Services.ItemPublisher.Infrastructure.MessageQueue.Tests
{
    ...
    public class MessageBuilderTests
    {
        ...
        {
            // Given.
            Mock<ILogger<MessageBuilder>> loggerMock = new Mock<ILogger<MessageBuilder>>();
            Mock<IMessageServiceCache> serviceCacheMock = new Mock<IMessageServiceCache>();
            ...
            MessageBuilder builder = new MessageBuilder(loggerMock.Object, serviceCacheMock.Object, traitBuilderMock.Object, hierarchyValuesParserMock.Object, valueFormatterMock.Object, uomMapperMock.Object, new ServiceSettings());
        ...
        public async Task BuildTraits_ReturnIsInCorrectFormat()
        {
            ...
            Mock<IUomMapper> uomMapperMock = new Mock<IUomMapper>();
            MessageBuilder builder = new MessageBuilder(loggerMock.Object, serviceCacheMock.Object, new TraitMessageBuilder(), hierarchyValuesParserMock.Object, valueFormatterMock.Object, uomMapperMock.Object, new ServiceSettings());
