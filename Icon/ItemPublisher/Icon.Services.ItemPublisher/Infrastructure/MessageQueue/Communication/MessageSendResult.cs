...
namespace Icon.Services.ItemPublisher.Infrastructure.MessageQueue
{
    public class MessageSendResult
    {
        ...
        public MessageSendResult(bool success, string message, string request = "", Dictionary<string, string> headers = null, Guid messageId = default(Guid), List<string> warnings = null, Exception exception = null)
        {
