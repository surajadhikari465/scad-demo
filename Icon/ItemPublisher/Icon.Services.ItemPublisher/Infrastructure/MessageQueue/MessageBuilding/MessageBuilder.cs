...
namespace Icon.Services.ItemPublisher.Infrastructure.MessageQueue
{
    ...
    {
        private readonly ILogger<MessageBuilder> logger;
        private readonly IMessageServiceCache messageServiceCache;
        ...
        public MessageBuilder(ILogger<MessageBuilder> logger,
            IMessageServiceCache messageServiceCache,
        ...
        {
            this.logger = logger;
            this.messageServiceCache = messageServiceCache;
        ...
        public bool CacheLoaded
        {
            ...
            get
            {
                ...
                return this.messageServiceCache.CacheLoaded;
            }
        }

        public async Task RefreshCache()
        {
            await this.messageServiceCache.RefreshCache();
        }
...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        public async Task<List<GroupTypeType>> BuildProductSelectionGroups(MessageQueueItemModel message, Action<string> processLogger)
        {
            ...
            var psgGroups = this.messageServiceCache.ProductSelectionGroupCache
                .Values
