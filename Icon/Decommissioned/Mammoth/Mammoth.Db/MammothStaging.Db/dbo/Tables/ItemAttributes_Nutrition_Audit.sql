CREATE TABLE [dbo].[ItemAttributes_Nutrition_Audit] (
    ...
    [AddedDate]                DATETIME        NOT NULL CONSTRAINT [DF_ItemAttributes_Nutrition_Audit_AddedDate] DEFAULT GETDATE(),
    [ModifiedDate]             DATETIME        NULL,
    CONSTRAINT [PK_ItemAttributes_Nutrition_Audit] PRIMARY KEY CLUSTERED ([ItemAttributeID] ASC) WITH (FILLFACTOR = 100)
);
GO

CREATE NONCLUSTERED INDEX [IX_ItemAttributes_Nutrition_Audit_ItemID] ON [dbo].[ItemAttributes_Nutrition_Audit] ([ItemID])
GO