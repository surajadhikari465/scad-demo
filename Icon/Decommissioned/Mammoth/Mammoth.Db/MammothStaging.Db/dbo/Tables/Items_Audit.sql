CREATE TABLE [dbo].[Items_Audit] (
    ...
    CONSTRAINT [PK_Items_Audit] PRIMARY KEY CLUSTERED ([ItemID] ASC) WITH (FILLFACTOR = 100),
    UNIQUE NONCLUSTERED ([ItemID] ASC) WITH (FILLFACTOR = 100)
);
GO

CREATE INDEX [IX_Items_ScanCode] ON [dbo].[Items_Audit] ([ScanCode]) INCLUDE ([ItemID])
GO