...
namespace KitBuilderWebApi.DatabaseModels
{
    public partial class KitBuilderContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasIndex(e => e.InstructionListId)
                    .HasName("IX_Kit_InstructionListID");
                ...
                entity.HasOne(d => d.InstructionList)
                    .WithMany(p => p.Kit)
                    .HasForeignKey(d => d.InstructionListId)
                    .HasConstraintName("FK_Kit_InstructionList");
            ...
            modelBuilder.Entity<KitInstructionList>(entity =>
            {
                ...
                entity.Property(e => e.KitInstructionListId).ValueGeneratedOnAdd();
                ...
                entity.HasOne(d => d.KitInstructionListNavigation)
                    .WithOne(p => p.KitInstructionList)
                    .HasForeignKey<KitInstructionList>(d => d.KitInstructionListId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
