...
/****** Object:  Job [KitBuilder-LoadHospitalityItems]    Script Date: 10/29/2018 3:37:51 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 10/29/2018 3:37:51 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'KitBuilder-LoadHospitalityItems', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Run SSIS Package]    Script Date: 10/29/2018 3:37:51 PM ******/
