...
namespace Icon.ApiController.Controller.QueueReaders
{
    public class ProductQueueReader : IQueueReader<MessageQueueProduct, Contracts.items>
    {
            ...
            var itemTraits = new List<Contracts.TraitType>
                        {
                                ...
                                BuildTrait(TraitCodes.Appellation, TraitDescriptions.Appellation, message.Appellation),
                                BuildTrait(TraitCodes.BeerStyle, TraitDescriptions.BeerStyle, message.BeerStyle),
                                BuildTrait(TraitCodes.CountryOfOrigin, TraitDescriptions.CountryOfOrigin, message.CountryOfOrigin),
                                BuildTrait(TraitCodes.Labeling, TraitDescriptions.Labeling, message.Labeling),
                                BuildTraitLeaveBlankIfNull(TraitCodes.LocalLoanProducer, TraitDescriptions.LocalLoanProducer, message.LocalLoanProducer),
                                BuildTraitLeaveBlankIfNull(TraitCodes.OrganicPersonalCare, TraitDescriptions.OrganicPersonalCare, message.OrganicPersonalCare),
                                BuildTraitLeaveBlankIfNull(TraitCodes.Paleo, TraitDescriptions.Paleo, message.Paleo),
                                BuildTrait(TraitCodes.PrivateLabel, TraitDescriptions.PrivateLabel, message.PrivateLabel),
                                BuildTrait(TraitCodes.ProductFlavorType, TraitDescriptions.ProductFlavorType, message.ProductFlavorOrType),
                                BuildTrait(TraitCodes.Varietal, TraitDescriptions.Varietal, message.Varietal),
                                BuildTraitLeaveBlankIfNull(TraitCodes.CaseinFree, TraitDescriptions.CaseinFree, message.CaseinFree),
                                BuildTrait(TraitCodes.DeliverySystem, TraitDescriptions.DeliverySystem, message.DeliverySystem),
                                BuildTraitLeaveBlankIfNull(TraitCodes.Hemp, TraitDescriptions.Hemp, message.Hemp),
                                BuildTrait(TraitCodes.InsertDate, TraitDescriptions.InsertDate, message.InsertDate),
                                BuildTraitLeaveBlankIfNull(TraitCodes.GlutenFreeClaim, TraitDescriptions.GlutenFreeClaim, message.GlutenFreeClaim),
                                BuildTrait(TraitCodes.ItemDepth, TraitDescriptions.ItemDepth, message.ItemDepth),
                                BuildTrait(TraitCodes.ItemHeight, TraitDescriptions.ItemHeight, message.ItemHeight),
                                BuildTrait(TraitCodes.ItemWidth, TraitDescriptions.ItemWidth, message.ItemWidth),
                                BuildTraitLeaveBlankIfNull(TraitCodes.NonGmoClaim, TraitDescriptions.NonGmoClaim, message.NonGMOClaim),
                                BuildTraitLeaveBlankIfNull(TraitCodes.OrganicClaim, TraitDescriptions.OrganicClaim, message.OrganicClaim),
                                BuildTrait(TraitCodes.PackageGroup, TraitDescriptions.PackageGroup, message.PackageGroup),
                                BuildTrait(TraitCodes.PackageGroupType, TraitDescriptions.PackageGroupType, message.PackageGroupType),
                                BuildTrait(TraitCodes.TrayDepth, TraitDescriptions.TrayDepth, message.TrayDepth),
                                BuildTrait(TraitCodes.TrayHeight, TraitDescriptions.TrayHeight, message.TrayHeight),
                                BuildTrait(TraitCodes.TrayWidth, TraitDescriptions.TrayWidth, message.TrayWidth),
                                BuildTrait(TraitCodes.ItemWeight, TraitDescriptions.ItemWeight, message.ItemWeight),
                                BuildTrait(TraitCodes.Cube, TraitDescriptions.Cube, message.Cube),
                                BuildTrait(TraitCodes.DataSource, TraitDescriptions.DataSource, message.DataSource),
                                BuildTraitLeaveBlankIfNull(TraitCodes.FairTradeClaim, TraitDescriptions.FairTradeClaim, message.FairTradeClaim),
                                BuildTrait(TraitCodes.NonGmoTransparency, TraitDescriptions.NonGmoTransparency, message.NonGMOTransparency),
                                BuildTrait(TraitCodes.LineExtension, TraitDescriptions.LineExtension, message.LineExtension),
                                BuildTrait(TraitCodes.ModifiedDate, TraitDescriptions.ModifiedDate, message.ModifedDate)
                        };
        ...
        private Contracts.ConsumerInformationType BuildConsumerInformation(MessageQueueProduct messageQueueProduct)
        {
            var message = messageQueueProduct.MessageQueueNutrition.FirstOrDefault();
        ...
        private Contracts.TraitType BuildTrait(string traitCode, string traitDescription, DateTime? value)
        {
            return BuildTrait(traitCode, traitDescription, value?.ToString());
        }
