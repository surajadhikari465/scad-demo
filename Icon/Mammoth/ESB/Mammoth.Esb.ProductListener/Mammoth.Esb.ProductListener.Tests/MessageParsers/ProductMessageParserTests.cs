...
namespace Mammoth.Esb.ProductListener.Tests.MessageParsers
{
	...
	public class ProductMessageParserTests
	{
		...
		public void ParseMessage_1ItemInMessageWithAllAttributes_ReturnItemModel()
		{
			...
			Assert.AreEqual("Fair Trade Certified Test", extAttributes.Traits[Attributes.Codes.FairTradeCertified]);
			Assert.AreEqual("Flexible Text Test", extAttributes.Traits[Attributes.Codes.FlexibleText]);
			Assert.AreEqual("Made With Organic Grapes Test", extAttributes.Traits[Attributes.Codes.MadeWithOrganicGrapes]);
			Assert.AreEqual("Made with Biodynamic Grapes Test", extAttributes.Traits[Attributes.Codes.MadeWithBiodynamicGrapes]);
			Assert.AreEqual("1", extAttributes.Traits[Attributes.Codes.NutritionRequired]);
			Assert.AreEqual("Prime Beef Test", extAttributes.Traits[Attributes.Codes.PrimeBeef]);
			Assert.AreEqual("Rainforest Alliance Test", extAttributes.Traits[Attributes.Codes.RainforestAlliance]);
			Assert.AreEqual("Refrigerated or Shelf Stable Test", extAttributes.Traits[Attributes.Codes.RefrigeratedOrShelfStable]);
			Assert.AreEqual("Smithsonian Bird Friendly Test", extAttributes.Traits[Attributes.Codes.SmithsonianBirdFriendly]);
			Assert.AreEqual("WIC Test", extAttributes.Traits[Attributes.Codes.Wic]);
			Assert.AreEqual("Global Pricing Program Test", extAttributes.Traits[Attributes.Codes.GlobalPricingProgram]);
		...
		public void ParseMessage_1ItemInMessageWithAFewMissingExtendedAttributes_ReturnItemModel()
		{
			...
			var extAttributes = item.ExtendedAttributes;
			Assert.IsFalse(extAttributes.Traits.ContainsKey(Attributes.Codes.FairTradeCertified));
			Assert.IsFalse(extAttributes.Traits.ContainsKey(Attributes.Codes.FlexibleText));
			Assert.AreEqual("Made With Organic Grapes Test", extAttributes.Traits[Attributes.Codes.MadeWithOrganicGrapes]);
			Assert.AreEqual("Made with Biodynamic Grapes Test", extAttributes.Traits[Attributes.Codes.MadeWithBiodynamicGrapes]);
			Assert.AreEqual("1", extAttributes.Traits[Attributes.Codes.NutritionRequired]);
			Assert.AreEqual("Prime Beef Test", extAttributes.Traits[Attributes.Codes.PrimeBeef]);
			Assert.IsFalse(extAttributes.Traits.ContainsKey(Attributes.Codes.RainforestAlliance));
			Assert.AreEqual("Refrigerated or Shelf Stable Test", extAttributes.Traits[Attributes.Codes.RefrigeratedOrShelfStable]);
			Assert.AreEqual("Smithsonian Bird Friendly Test", extAttributes.Traits[Attributes.Codes.SmithsonianBirdFriendly]);
			Assert.AreEqual("WIC Test", extAttributes.Traits[Attributes.Codes.Wic]);
			Assert.IsFalse(extAttributes.Traits.ContainsKey(Attributes.Codes.GlobalPricingProgram));
		...
		public void ParseMessage_1ItemInMessageWithoutExtendedAttributes_ReturnItemModel()
		{
			...
			Assert.AreEqual(0, item.ExtendedAttributes.Traits.Count);
        ...
        /*
          These Unit tests would not compile after merge from Master into Icon_Reboot_Master. Commenting out for now.
         */
