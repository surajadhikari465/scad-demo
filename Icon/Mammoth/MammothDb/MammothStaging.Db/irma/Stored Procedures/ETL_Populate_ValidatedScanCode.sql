CREATE PROCEDURE [irma].[ETL_Populate_ValidatedScanCode] @Environment NCHAR(3), @region NCHAR(2) AS BEGIN
	...
	SET @table_name = N'ValidatedScanCode'
	SET @sqlParams = N''
