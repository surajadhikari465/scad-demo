CREATE TABLE [dbo].[ItemAttributes_Locale_FL_Audit] (
    ...
    CONSTRAINT [PK_ItemAttributes_Locale_FL] PRIMARY KEY CLUSTERED ([Region] ASC, [ItemAttributeLocaleID] ASC) WITH (FILLFACTOR = 100),
...
CREATE INDEX [IX_ItemAttributesLocale_FL_ItemID_BusinessUnitID_Region_ItemAttributeLocaleID] ON [dbo].[ItemAttributes_Locale_FL_Audit]
(
	[ItemID] ASC,
	[BusinessUnitID] ASC,
	[Region] ASC,
