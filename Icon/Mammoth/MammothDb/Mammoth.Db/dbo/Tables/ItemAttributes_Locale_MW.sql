CREATE TABLE [dbo].[ItemAttributes_Locale_MW] (
    ...
    CONSTRAINT [CK_ItemAttributes_Locale_MW_Restriction_Age] CHECK ([Restriction_Age]=(21) OR [Restriction_Age]=(18)),
    CONSTRAINT [CK_ItemAttributes_Locale_MW_Region] CHECK ([Region] = 'MW')
) TEXTIMAGE_ON [FG_MW];
GO

CREATE INDEX [IX_ItemAttributesLocale_MW_ItemID_BusinessUnitID_Region_ItemAttributeLocaleID] ON [dbo].[ItemAttributes_Locale_MW]
(
	[ItemID] ASC,
	[BusinessUnitID] ASC,
	[Region] ASC,
...
INCLUDE ([AddedDate], [Authorized]) ON [FG_MW];
GO

CREATE UNIQUE INDEX UNQ_ItemAttributesLocale_MW_ItemID_BU on dbo.ItemAttributes_Locale_MW(ItemID, BusinessUnitID) ON [FG_MW];
GO