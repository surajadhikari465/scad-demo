...
INCLUDE ([AddedDate], [Authorized]) ON [FG_NE];
GO

CREATE UNIQUE INDEX unq_ItemAttributesLocale_NE_ItemID_BU on dbo.ItemAttributes_Locale_NE(ItemID, BusinessUnitID) ON [FG_NE];
GO