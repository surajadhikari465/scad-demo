CREATE TABLE [dbo].[ItemAttributes_Locale_PN] (
...
CREATE INDEX [IX_ItemAttributesLocale_PN_ItemID_BusinessUnitID_Region_ItemAttributeLocaleID] ON [dbo].[ItemAttributes_Locale_PN]
(
	[ItemID] ASC,
	[BusinessUnitID] ASC,
	[Region] ASC,
...
INCLUDE ([AddedDate], [Authorized]) ON [FG_PN];
GO

CREATE UNIQUE INDEX UNQ_ItemAttributesLocale_PN_ItemID_BU on dbo.ItemAttributes_Locale_PN(ItemID, BusinessUnitID) ON [FG_PN];
GO