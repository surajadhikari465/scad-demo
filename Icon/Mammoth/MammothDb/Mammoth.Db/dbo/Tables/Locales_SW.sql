...
GRANT SELECT ON [dbo].[Locales_SW] TO [MammothRole]
GO

CREATE NONCLUSTERED INDEX [IX_Locales_SW_BusinessUnitId]
    ON [dbo].[Locales_SW]([BusinessUnitID] ASC) WITH (FILLFACTOR = 80)
    ON [FG_SW];
GO