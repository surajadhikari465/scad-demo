CREATE TABLE [dbo].[ItemAttributes_Locale_NC] (
    ...
    CONSTRAINT [PK_ItemAttributes_Locale_NC] PRIMARY KEY CLUSTERED ([Region] ASC, [ItemAttributeLocaleID] ASC) WITH (FILLFACTOR = 100) ON [FG_NC],
    CONSTRAINT [CK_ItemAttributes_Locale_NC_Restriction_Age] CHECK ([Restriction_Age]=(21) OR [Restriction_Age]=(18)),
    CONSTRAINT [CK_ItemAttributes_Locale_NC_Region] CHECK ([Region] = 'NC')
) TEXTIMAGE_ON [FG_NC];
GO

CREATE INDEX [IX_ItemAttributesLocale_NC_ItemID_BusinessUnitID_Region_ItemAttributeLocaleID] ON [dbo].[ItemAttributes_Locale_NC]
(
	[ItemID] ASC,
	[BusinessUnitID] ASC,
	[Region] ASC,
...
CREATE UNIQUE INDEX UNQ_ItemAttributesLocale_NC_ItemID_BU on dbo.ItemAttributes_Locale_NC(ItemID, BusinessUnitID) ON [FG_NC];
GO