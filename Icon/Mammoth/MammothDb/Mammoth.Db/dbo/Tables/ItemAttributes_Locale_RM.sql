CREATE TABLE [dbo].[ItemAttributes_Locale_RM] (
...
CREATE INDEX [IX_ItemAttributesLocale_RM_ItemID_BusinessUnitID_Region_ItemAttributeLocaleID] ON [dbo].[ItemAttributes_Locale_RM]
(
	[ItemID] ASC,
	[BusinessUnitID] ASC,
	[Region] ASC,
...
CREATE UNIQUE INDEX UNQ_ItemAttributesLocale_RM_ItemID_BU on dbo.ItemAttributes_Locale_RM(ItemID, BusinessUnitID) ON [FG_RM];
GO