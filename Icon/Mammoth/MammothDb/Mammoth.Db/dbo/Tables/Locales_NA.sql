...
GRANT SELECT ON [dbo].[Locales_NA] TO [MammothRole]
GO

CREATE NONCLUSTERED INDEX [IX_Locales_NA_BusinessUnitId]
    ON [dbo].[Locales_NA]([BusinessUnitID] ASC) WITH (FILLFACTOR = 80)
    ON [FG_NA];
GO