...
INCLUDE ([AddedDate], [Authorized]) ON [FG_SP];
GO

CREATE UNIQUE INDEX UNQ_ItemAttributesLocale_SP_ItemID_BU on dbo.ItemAttributes_Locale_SP(ItemID, BusinessUnitID) ON [FG_SP];
GO