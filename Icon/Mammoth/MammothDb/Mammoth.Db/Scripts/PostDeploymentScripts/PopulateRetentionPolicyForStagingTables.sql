...
BEGIN
	...
	BEGIN
		...
		('Mammoth_Dev', 'gpm', 'MessageArchivePriceR10', 'InsertDateUtc', 10, 21, 24, 1, 0, 'Data History Purge', NULL)
		...
		('Mammoth', 'gpm', 'MessageArchivePriceR10', 'InsertDateUtc', 10, 21, 24, 1, 0, 'Data History Purge', NULL)
	END
