DECLARE @scriptKey VARCHAR(128) = '26540_AMZItemVendorLane_JobSchedule';
   ...
   BEGIN
      BEGIN
		...
		SET @AmzIVL_xmlobject = '
		{
          ...
          "query" : "select * from dbo.VendorLaneExtract where STORE_NUMBER = @STORE_NUMBER order by STORE_NUMBER, UPC",
		  "parameters": [],
