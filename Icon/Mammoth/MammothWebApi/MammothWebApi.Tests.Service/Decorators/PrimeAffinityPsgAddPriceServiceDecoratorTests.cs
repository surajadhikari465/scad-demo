...
namespace MammothWebApi.Tests.Service.Decorators
{
    ...
    public class PrimeAffinityPsgAddPriceServiceDecoratorTests
    {
        ...
        [TestMethod]
        public void Handle_PricesAreCancelAllSalesAndEndToday_ShouldSendDeletePsgs()
        {
            //Given
            var region = "FL";
            data.Prices = new List<PriceServiceModel>
            {
                new PriceServiceModel{ BusinessUnitId = 123, ScanCode = "111", Region = region, PriceType = "REG", StartDate = DateTime.Today.AddDays(-1), EndDate = DateTime.Today, CancelAllSales = true },
                new PriceServiceModel{ BusinessUnitId = 456, ScanCode = "222", Region = region, PriceType = "REG", StartDate = DateTime.Today.AddDays(-1), EndDate = DateTime.Today, CancelAllSales = true },
                new PriceServiceModel{ BusinessUnitId = 789, ScanCode = "333", Region = region, PriceType = "REG", StartDate = DateTime.Today.AddDays(-1), EndDate = DateTime.Today, CancelAllSales = true },
                new PriceServiceModel{ BusinessUnitId = 147, ScanCode = "444", Region = region, PriceType = "REG", StartDate = DateTime.Today.AddDays(-1), EndDate = DateTime.Today, CancelAllSales = true },
            };
            var primePsgItemStoreDataModels = data.Prices
                .Select(p => new PrimePsgItemStoreDataModel
                {
        ...
        [TestMethod]
        public void Handle_PricesAreACollectionOfPrimeEligibleSalesAndNotPrimeEligibleSalesWithDifferentStartAndEndDates_ShouldSendAddOrUpdateAndDeletePsgs()
        {
            //Given
            var region = "FL";
            var addPsgPrices = new List<PriceServiceModel>
            {
                new PriceServiceModel{ BusinessUnitId = 123, ScanCode = "111", Region = region, PriceType = "ISS", StartDate = DateTime.Today, EndDate = DateTime.Today.AddDays(1) },
                new PriceServiceModel{ BusinessUnitId = 1234, ScanCode = "111", Region = region, PriceType = "SAL", StartDate = DateTime.Today, EndDate = DateTime.Today.AddDays(1) },
            };
            var deletePsgPrices = new List<PriceServiceModel>
            {
            ...
            var noPsgPrices = new List<PriceServiceModel>
            {
                new PriceServiceModel{ BusinessUnitId = 456, ScanCode = "222", Region = region, PriceType = "ISS", StartDate = DateTime.Today.AddDays(1), EndDate = DateTime.Today.AddDays(5) },
                new PriceServiceModel{ BusinessUnitId = 456, ScanCode = "222", Region = region, PriceType = "REG", StartDate = DateTime.Today, EndDate = DateTime.Today.AddDays(5) },
                new PriceServiceModel{ BusinessUnitId = 456, ScanCode = "222", Region = region, PriceType = "REG", StartDate = DateTime.Today, EndDate = DateTime.Today.AddDays(5), CancelAllSales = true },
                new PriceServiceModel{ BusinessUnitId = 456, ScanCode = "222", Region = region, PriceType = "SAL", StartDate = DateTime.Today.AddDays(1), EndDate = DateTime.Today.AddDays(5) },
            };
            data.Prices = addPsgPrices
                .Concat(noPsgPrices)
                .Concat(deletePsgPrices)
                .ToList();
            ...
            mockPrimeAffinityPsgProcessor.Verify(m => m.SendPsgs(It.Is<PrimeAffinityPsgProcessorParameters>(
                p => p.MessageAction == ActionEnum.AddOrUpdate
                    && p.Region == region
                    && p.PrimeAffinityMessageModels.Count() == 2
                    && AssertDataModelsAreEqualToMessageModels(ConvertToDataModels(addPsgPrices, region), p.PrimeAffinityMessageModels, ActionEnum.AddOrUpdate))), Times.Once);
            mockPrimeAffinityPsgProcessor.Verify(m => m.SendPsgs(It.Is<PrimeAffinityPsgProcessorParameters>(
                p => p.MessageAction == ActionEnum.Delete
                    && p.Region == region
                    && p.PrimeAffinityMessageModels.Count() == 2
                    && AssertDataModelsAreEqualToMessageModels(ConvertToDataModels(deletePsgPrices, region), p.PrimeAffinityMessageModels, ActionEnum.Delete))), Times.Once);
        }
