...
{
    public class NLoggerInstance : ILogger
    {
        private Logger logger;

        public NLoggerInstance(Type t, string instance)
        {
            this.logger = LogManager.GetLogger(String.Format("{0}.{1}", t.FullName, instance.ToString()));
        }
