...
namespace InventoryProducer.Mapper.Tests
{
    ...
    public class PurchaseOrderCanonicalModelTests
    {
        ...
        public void GetEvents_Transformation_Validation()
        {
            ...
            string expectedXmlMessage = @"<?xml version=""1.0"" encoding=""utf-8""?>
				<PurchaseOrders
					xmlns:ns0=""http://schemas.wfm.com/Enterprise/InventoryMgmt/CommonRefTypes/V1""
					xmlns:ns1=""http://schemas.wfm.com/Enterprise/UnitOfMeasureMgmt/UnitOfMeasure/V2""
					xmlns:ns2=""http://schemas.wfm.com/Enterprise/TransactionMgmt/CommonRefTypes/V1""
					xmlns=""http://schemas.wfm.com/Enterprise/InventoryMgmt/PurchaseOrder/V1"">
					<PurchaseOrder>
						<purchaseOrderNumber>0</purchaseOrderNumber>
						<eventType>PO_CRE</eventType>
						<messageNumber>1</messageNumber>
						<purchaseType>Purchase Order</purchaseType>
						<supplierNumber>11161777</supplierNumber>
						<locationNumber>10268</locationNumber>
						<locationName>ON SQUARE ONE (SQO)</locationName>
						<OrderSubTeam>
							<orderSubTeamNumber>4900</orderSubTeamNumber>
							<orderSubTeamName>Prepared Foods</orderSubTeamName>
							<orderTeamNumber>70</orderTeamNumber>
							<orderTeamName>Prepared Foods</orderTeamName>
						</OrderSubTeam>
						<status>Sent</status>
						<userInfo>
							<ns0:idNumber>16037</ns0:idNumber>
							<ns0:name>Sarah.Roberts</ns0:name>
						</userInfo>
						<createDateTime>2022-11-16T15:54:53-05:00</createDateTime>
						<PurchaseOrderDetail>
							<PurchaseOrderDetailNumber>289246108</PurchaseOrderDetailNumber>
							<sourceItemKey>736066</sourceItemKey>
							<locationId>10268</locationId>
							<SubTeam>
								<ns0:subTeamNumber>4900</ns0:subTeamNumber>
								<ns0:subTeamName>Prepared Foods</ns0:subTeamName>
								<ns0:hostSubTeamNumber>1400</ns0:hostSubTeamNumber>
								<ns0:hostSubTeamName>Bin Bulk</ns0:hostSubTeamName>
							</SubTeam>
							<defaultScanCode>1432151031</defaultScanCode>
							<quantities>
								<ns2:quantity>
									<ns2:value>1</ns2:value>
									<ns2:units>
										<ns2:uom>
											<ns1:code>CS</ns1:code>
										</ns2:uom>
									</ns2:units>
								</ns2:quantity>
							</quantities>
							<eInvoiceASNQuantities>
								<ns2:quantity>
									<ns2:units>
										<ns2:uom />
									</ns2:units>
							...
							<packSize1>1</packSize1>
							<packSize2>1</packSize2>
							<itemCost>19.2244</itemCost>
							<expectedArrivalDate>2022-11-16T15:54:53-05:00</expectedArrivalDate>
						</PurchaseOrderDetail>
						<PurchaseOrderDetail>
							<PurchaseOrderDetailNumber>289246108</PurchaseOrderDetailNumber>
							<sourceItemKey>736066</sourceItemKey>
