...
namespace Icon.Dashboard.Mvc.UnitTests.ControllerTests.HomeControllerUnitTests
{
    public class _HomeControllerUnitTestBase : _MvcControllerUnitTestBase
    {
        ...
        protected HomeController ConstructController(string dataFile = null,
        ...
        {
            var controller = new HomeController(dataFile, dataServiceWrapper, loggingServiceWrapper, serverUtility);
