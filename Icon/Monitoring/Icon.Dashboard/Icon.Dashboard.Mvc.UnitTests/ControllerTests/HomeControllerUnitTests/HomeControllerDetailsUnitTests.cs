...
namespace Icon.Dashboard.Mvc.UnitTests.ControllerTests.HomeControllerUnitTests
{
    ...
    public class HomeControllerDetailsUnitTests : _HomeControllerUnitTestBase
    {
        ...
        //    //When
        //    ActionResult result = controller.Details(testService.Server, testService.Name);
        ...
        //    //When
        //    ActionResult result = controller.Details(testService.Server, testService.Name, cmd);
