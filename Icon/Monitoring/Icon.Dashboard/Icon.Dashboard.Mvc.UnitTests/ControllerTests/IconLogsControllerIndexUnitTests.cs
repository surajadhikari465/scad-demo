...
namespace Icon.Dashboard.Mvc.UnitTests.ControllerTests
{
    ...
    public class IconLogsControllerIndexUnitTests : _MvcControllerUnitTestBase
    {
        ...
        protected override string testControllerName => "IconLogs";
        ...
        {
            var controller = new IconLogsController(
                dashboardAuthorizer,
        ...
        {
            var fakeData = serviceTestData.AppLogs.IconAppLogEntryViewModelList;
        ...
        protected int SetupTestLoggingServiceForGetSingleApp(IApp fakeApp, int page = 1, int pageSize = PagingConstants.DefaultPageSize)
        {
            ...
            base.MockIconLoggingServiceWrapper
                ...
                .Returns(fakeApp);
            var fakeLogs = serviceTestData.AppLogs.IconAppLogEntryViewModelList
        ...
        {
            // Arrange
            const string expectedTitle = "Icon Tst0 DB Log Viewer (All Icon Apps)";
        ...
        public void MvcLogsController_IndexGetFiltered_ShouldSetModelPartialViewTitle()
        {
            ...
            var fakeApp = serviceTestData.AppLogs.FakeAppB;
            string name = fakeApp.AppName;
            string expectedTitle = "Icon Tst0 DB \"" + fakeApp.AppName + "\" Log Viewer";
            var controller = ConstructController();
