...
namespace Icon.Dashboard.Mvc.Models
{
    public class DbConfigurationModel
    {
        ...
        {
            Connections = new List<DatabaseModel>();
        }
        ...
        public DatabaseModel LoggingConnection
        {
            get
            {
        ...
        public List<DatabaseModel> NonLoggingConnections
        {
            get
            {
        ...
        public List<DatabaseModel> Connections { get; set; }
        ...
        public DatabaseModel GetSingleNonLoggingConnectionOfCategory(DatabaseCategoryEnum databaseCategory)
        {
        ...
        public List<DatabaseModel> GetAllNonLoggingConnectionsOfCategory(DatabaseCategoryEnum databaseCategory)
        {
