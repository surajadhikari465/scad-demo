...
namespace Icon.Dashboard.Mvc.Models.CustomConfigElements
{
    ...
    public class EsbEnvironmentElement : ConfigurationElement
    {
        ...
        [ConfigurationProperty(nameof(CertificateName), DefaultValue = "", IsRequired = true)]
        ...
        [ConfigurationProperty(nameof(CertificateStoreName), DefaultValue = "", IsRequired = true)]
        ...
        [ConfigurationProperty(nameof(CertificateStoreLocation), DefaultValue = "", IsRequired = true)]
