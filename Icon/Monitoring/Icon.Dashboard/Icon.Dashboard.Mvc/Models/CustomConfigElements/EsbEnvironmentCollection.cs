...
namespace Icon.Dashboard.Mvc.Models.CustomConfigElements
{
    ...
    public class EsbEnvironmentCollection : ConfigurationElementCollection, IEnumerable<EsbEnvironmentElement>
    {
        ...
        IEnumerator<EsbEnvironmentElement> IEnumerable<EsbEnvironmentElement>.GetEnumerator()
        {
            for (int i = 0; i < base.Count; i++)
            {
                yield return base.BaseGet(i) as EsbEnvironmentElement;
            }
        }
    }
}