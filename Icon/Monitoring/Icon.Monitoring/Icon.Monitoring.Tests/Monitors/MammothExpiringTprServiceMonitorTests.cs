...
namespace Icon.Monitoring.Tests.Monitors
{
    ...
    public class MammothExpiringTprServiceMonitorTests
    {
        ...
        [TestMethod]
        public void MammothExpiringTprServiceMonitor_CheckStatusAndNotify_JobStatusIsNotReady_TriggersOpsgenieAlert()
        {
            //Given
            enabledRegions.Add("FL", true);
            enabledRegions.Add("MA", true);
        ...
        [TestMethod]
        public void MammothExpiringTprServiceMonitor_CheckStatusAndNotify_LastRunEndTimeIsLessThenToday_TriggersOpsgenieAlert()
        {
            //Given
            enabledRegions.Add("FL", true);
            enabledRegions.Add("MA", true);
        ...
        [TestMethod]
        public void MammothExpiringTprServiceMonitor_CheckStatusAndNotify_CacheForRegionIsAlreadySet_DoesNotTriggerOpsgenieAlert()
        {
            //Given
            enabledRegions.Add("FL", true);
            enabledRegions.Add("MA", true);
