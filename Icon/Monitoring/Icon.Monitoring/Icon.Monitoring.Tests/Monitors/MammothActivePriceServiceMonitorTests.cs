...
{
    [TestClass]
    public class MammothActivePriceServiceMonitorTests
    {
        private const string JobStatusReady = "ready";
        private const string JobStatusFailed = "failed";
        private const string JobName = "Active Price Service";

        private MammothActivePriceServiceMonitor monitor;
        ...
        public void Initialize()
        {
            ...
            monitor = new MammothActivePriceServiceMonitor(
                mockSettings.Object,
            ...
            mockPrimeAffinitySettings.SetupGet(m => m.ActivePriceServiceMonitorEnabledByRegion)
                .Returns(enabledRegions);
            mockPrimeAffinitySettings.SetupGet(m => m.ActivePriceServiceCompletionUtcTimeByRegion)
        ...
        [TestMethod]
        public void MammothActivePriceServiceMonitor_CheckStatusAndNotify_JobCompletedOnTime_DoesNotTriggerAlert()
        {
            //Given
        ...
        [TestMethod]
        public void MammothActivePriceServiceMonitor_CheckStatusAndNotify_RegionIsDisabled_SkipsMonitoringRegion()
        {
            //Given
        ...
        [TestMethod]
        public void MammothActivePriceServiceMonitor_CheckStatusAndNotify_CurrentUtcTimeIsLessThanRegionsExpectedCompletionTime_SkipsMonitoringRegion()
        {
            //Given
            enabledRegions.Add("FL", true);
            enabledRegions.Add("MA", true);
        ...
        [TestMethod]
        public void MammothActivePriceServiceMonitor_CheckStatusAndNotify_CurrentUtcTimeIsGreaterThanRegionsExpectedCompletionTime_ChecksJobScheduleForRegion()
        {
            //Given
            enabledRegions.Add("FL", true);
            enabledRegions.Add("MA", true);
        ...
        [TestMethod]
        public void MammothActivePriceServiceMonitor_CheckStatusAndNotify_JobScheduleIsNull_LogsJobScheduleDoesntExist()
        {
            //Given
        ...
        [TestMethod]
        public void MammothActivePriceServiceMonitor_CheckStatusAndNotify_JobScheduleIsDisabled_LogsJobScheduleIsDisabled()
        {
            //Given
            enabledRegions.Add("FL", true);
            enabledRegions.Add("MA", true);
        ...
        [TestMethod]
        public void MammothActivePriceServiceMonitor_CheckStatusAndNotify_SomeJobsCompletedOnTimeAndSomeDidNot_DoesNotTriggerAlertForCompletedJobsAndTriggersAlertsForNonCompletedJobs()
        {
            //Given
            enabledRegions.Add("FL", true);
            enabledRegions.Add("MA", true);
