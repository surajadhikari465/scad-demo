...
namespace PushController.Controller.MessageBuilders
{
    public class ItemLocaleMessageBuilder : IMessageBuilder<MessageQueueItemLocale>
    {
        ...
        private bool PreventMessageGeneration(ScanCodeModel scanCodeModel)
        {
            ...
            {
                logger.Info(String.Format("Scan code {0} is associated to a sub-brick with the Coupon non-merchandise trait.  No ItemLocale message will be generated.",
            ...
            {
                logger.Info(String.Format("Scan code {0} is associated to a sub-brick with the Legacy POS Only non-merchandise trait.  No ItemLocale message will be generated.",
                    scanCodeModel.ScanCode));
                return true;
            }
