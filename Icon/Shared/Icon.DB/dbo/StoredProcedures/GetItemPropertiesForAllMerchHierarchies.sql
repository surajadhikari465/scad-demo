CREATE PROCEDURE [dbo].[GetItemPropertiesForAllMerchHierarchies] 
AS  
BEGIN  
 ...
 SELECT 
   hierarchyclass.hierarchyClassID MerchandiseHierarchyClassId,
   mfm.traitvalue AS FinancialHierarcyClassId  
