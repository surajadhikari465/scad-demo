...
set @scriptKey = 'AddVimArchiveTablesToRetentionPolicy'
...
begin
	...
	insert @tempRetentionPolicy ([Server], [Database], [Schema], [Table], [DaysToKeep]) 
	values (@currentServerName, N'Icon', N'vim', N'MessageArchiveHierarchy', 5)
	insert @tempRetentionPolicy ([Server], [Database], [Schema], [Table], [DaysToKeep])
	values (@currentServerName, N'Icon', N'infor', N'MessageHistory', 5)	
