...
set @scriptKey = 'RetentionPolicyMessageArchiveProductOutOfSync'
...
BEGIN
	...
	INSERT @tempRetentionPolicy ([Server], [Database], [Schema], [Table], [DaysToKeep]) VALUES (@currentServerName, N'Icon', N'infor', N'MessageArchiveProductOutOfSync', 90)
