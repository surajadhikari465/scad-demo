        ...
        public WfmUomDescEnumType GetEsbUomDescription(string uomCode)
        {
            ...
            switch (uomCode)
            {
                ...
                case UomCodes.FluidOunces:
                    ...
                    break;
                default:
                    esbUomDescription = WfmUomDescEnumType.EACH;  // Default to EACH in case the IRMA Uom does not match the consolidated UOM list.
                    break;
            }
        ...
        public WfmUomCodeEnumType GetEsbUomCode(string uomCode)
        {
            ...
            switch (uomCode)
            {
                ...
                case UomCodes.FluidOunces:
                    ...
                    break;
                default:
                    esbUomCode = WfmUomCodeEnumType.EA;  // Default to EACH in case the IRMA Uom does not match the consolidated UOM list.
                    break;
            }
