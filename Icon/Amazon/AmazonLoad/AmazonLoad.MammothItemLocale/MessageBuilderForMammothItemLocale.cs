...
namespace AmazonLoad.MammothItemLocale
{
    internal class MessageBuilderForMammothItemLocale
    {
        ...
        internal static string BuildMessage(List<MammothItemLocaleModel> itemLocaleModels)
        {
        ...
        private static Contracts.ItemType ConvertToContractsItemType(MammothItemLocaleModel message)
        {
