...
namespace Services.NewItem.Tests.Integration
{
    [TestClass]
    public class NewItemApplicationTests
    {
        [TestInitialize]
        ...
        public void Given1NewItemEvent_WhenTheApplicationIsRun_ShouldGenerateNewItemMessageForEvents()
        {
            ...
            container.Register(() => new NewItemApplicationSettings { Regions = new List<string> { "FL" }, NumberOfItemsPerMessage = 1 });
