...
CREATE PROCEDURE [dbo].[GetTransferOrderItemSearch] 
	@FromSubTeam_No		int,
	@ToSubTeam_No		int,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetTransferOrderItemSearch] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetTransferOrderItemSearch] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetTransferOrderItemSearch] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetTransferOrderItemSearch] TO [IRMAReportsRole]
    AS [dbo];
