...
--		@GLMarketingExpenseAcct int,	-- key for store as vendor
...
--        @CopyVendorKey varchar(10),		-- Vendor Key of Cloned Store
		...
		@GeoCode varchar(15)
AS
--NewStore(ByVal nStoreID As Integer, ByVal nStoreAbbr As String, ByVal nStoreName As String, ByVal nStoreJurisdictionID As Integer, _
