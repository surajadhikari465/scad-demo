...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[HARTGetInventoryStoreOpsExport] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[HARTGetInventoryStoreOpsExport] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[HARTGetInventoryStoreOpsExport] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[HARTGetInventoryStoreOpsExport] TO [IRMAReportsRole]
    AS [dbo];
