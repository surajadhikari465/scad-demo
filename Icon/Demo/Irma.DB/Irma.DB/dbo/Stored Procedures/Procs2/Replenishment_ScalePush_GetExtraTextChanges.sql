...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_ScalePush_GetExtraTextChanges] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_ScalePush_GetExtraTextChanges] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_ScalePush_GetExtraTextChanges] TO [IRMASchedJobsRole]
    AS [dbo];
