...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_GetPORefusalCodes] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_GetPORefusalCodes] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_GetPORefusalCodes] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_GetPORefusalCodes] TO [IRMAReportsRole]
    AS [dbo];
