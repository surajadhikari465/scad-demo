...
CREATE PROCEDURE [dbo].[Replenishment_TagPush_GetElectronicShelfTagBatchFile_SO]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_TagPush_GetElectronicShelfTagBatchFile_SO] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_TagPush_GetElectronicShelfTagBatchFile_SO] TO [IRSUser]
    AS [dbo];
