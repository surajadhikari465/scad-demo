...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_ScalePush_GetSmartXPrices] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_ScalePush_GetSmartXPrices] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_ScalePush_GetSmartXPrices] TO [IRMASchedJobsRole]
    AS [dbo];
