...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ClosedPendingEinvoices] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ClosedPendingEinvoices] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ClosedPendingEinvoices] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ClosedPendingEinvoices] TO [IRMAReportsRole]
    AS [dbo];
