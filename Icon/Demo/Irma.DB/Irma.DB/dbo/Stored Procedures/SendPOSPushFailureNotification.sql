...
create PROCEDURE [dbo].[SendPOSPushFailureNotification]
...
print '[' + convert(nvarchar, getdate(), 121) + '] ' + 'Finish: [SendPOSPushFailureNotification.sql]'
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SendPOSPushFailureNotification] TO [IRSUser]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SendPOSPushFailureNotification] TO [IRMAClientRole]
    AS [dbo];
