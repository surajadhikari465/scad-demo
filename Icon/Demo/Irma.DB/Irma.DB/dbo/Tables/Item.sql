CREATE TABLE [dbo].[Item] (
    ...
    [Case_Discount]                  BIT            CONSTRAINT [DF_ITEM_Case_Discount] DEFAULT ((0)) NULL,
    [Coupon_Multiplier]              BIT            CONSTRAINT [DF_ITEM_Coupon_Multipler] DEFAULT ((0)) NULL,
    ...
    [PurchaseThresholdCouponSubTeam] BIT            CONSTRAINT [DF_ITEM_PurchaseThresholdCouponSubTeam] DEFAULT ((0)) NULL,
