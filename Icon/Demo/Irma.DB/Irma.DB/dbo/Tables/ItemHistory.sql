CREATE TABLE [dbo].[ItemHistory] (
    ...
    CONSTRAINT [pk_ItemHistory_ItemHistoryId] PRIMARY KEY CLUSTERED ([ItemHistoryID] ASC, [DateStamp] ASC) WITH (FILLFACTOR = 80),
...
CREATE NONCLUSTERED INDEX [idxItemHistory_InsertDate]
    ...
    INCLUDE([Store_No], [Item_Key], [DateStamp], [SubTeam_No], [InventoryAdjustmentCode_ID]) WITH (FILLFACTOR = 80);
