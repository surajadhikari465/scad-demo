...
GO
GRANT SELECT
    ON OBJECT::[dbo].[fn_GetOrderAllocItems] TO PUBLIC
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[fn_GetOrderAllocItems] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[fn_GetOrderAllocItems] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[fn_GetOrderAllocItems] TO [IRMASchedJobsRole]
    AS [dbo];
