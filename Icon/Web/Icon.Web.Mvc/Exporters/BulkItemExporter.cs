...
{
    public class BulkItemExporter : BaseItemExporter<BulkImportItemModel>
    {
        public BulkItemExporter(
        ...
        protected override List<ExportItemModel> ConvertExportDataToExportItemModel()
        {
            ...
            {
                ScanCode = i.ScanCode,
                Brand = brandHierarchyClassDictionary.ContainsKey(i.BrandId) ? brandHierarchyClassDictionary[i.BrandId] : String.Empty,
                ...
                Browsing = browsingHierarchyClassDictionary.ContainsKey(i.BrowsingId.ToString()) ? browsingHierarchyClassDictionary[i.BrowsingId.ToString()] : String.Empty,
                ...
                DepartmentSale = i.DepartmentSale.ToSpreadsheetBoolean(),
                HiddenItem = i.HiddenItem.ToSpreadsheetBoolean(),
                Notes = i.Notes,
        ...
        private void AddSpreadsheetColumns()
        {
            ...
            AddSpreadsheetColumn(
                ExcelHelper.ConsolidatedItemColumnIndexes.ErrorColumnIndex,
                ExcelHelper.ExcelExportColumnNames.Error,
                ExcelHelper.ExcelExportColumnWidths.Error,
                HorizontalCellAlignment.Left,
                (row, item) => row.Cells[ExcelHelper.ConsolidatedItemColumnIndexes.ErrorColumnIndex].Value = item.Error);
        }
    }
}