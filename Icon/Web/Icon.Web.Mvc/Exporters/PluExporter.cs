...
{
    public class PluExporter
    {
        public List<PluMappingViewModel> ExportData { get; set; }
        ...
        public void Export()
        {
            ...
            int i = 1;
            foreach (PluMappingViewModel plu in ExportData)
            {
                pluWorksheet.Rows[i].Cells[0].Value = plu.Brand;
                pluWorksheet.Rows[i].Cells[1].Value = plu.PluDescription;
