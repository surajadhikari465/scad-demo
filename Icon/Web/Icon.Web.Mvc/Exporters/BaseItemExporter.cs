...
{
    public abstract class BaseItemExporter<T>
    {
        ...
        protected void BuildSpreadsheet()
        {
            ...
            glutenFreeWorksheet = ExportModel.ExcelWorkbook.Worksheets.Add("GlutenFree");
            kosherWorksheet = ExportModel.ExcelWorkbook.Worksheets.Add("Kosher");
            nonGmoWorksheet = ExportModel.ExcelWorkbook.Worksheets.Add("NonGMO");
        ...
        private void BuildHierarchyClassDictionaries()
        {
            ...
            glutenFreeHierarchyClassDictionary.Add(0, Constants.ExcelImportRemoveValueKeyword);
            ...
            kosherHierarchyClassDictionary.Add(0, Constants.ExcelImportRemoveValueKeyword);
            ...
            nonGmoHierarchyClassDictionary.Add(0, Constants.ExcelImportRemoveValueKeyword);
            ...
            organicHierarchyClassDictionary.Add(0, Constants.ExcelImportRemoveValueKeyword);
            ...
            veganHierarchyClassDictionary.Add(0, Constants.ExcelImportRemoveValueKeyword);
        }
