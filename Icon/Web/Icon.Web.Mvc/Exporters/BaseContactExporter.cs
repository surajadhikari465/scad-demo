...
{
    public abstract class BaseContactExporter<T>
    {
        protected const int ContactColumnIndex = 0;
        ...
        public virtual void Export()
        {
            ...
            var exportContactData = ConvertExportDataToExportContactModel();
            // Start at 1 to exclude the header row.
            int i = 1;
            foreach (T attribute in exportContactData)
            {
        ...
        {
            worksheet = ExportModel.ExcelWorkbook.Worksheets.Add("Contact");
            CreateHeaderRow();
        }
        ...
        protected abstract List<T> ConvertExportDataToExportContactModel();
    }
}