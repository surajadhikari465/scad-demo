...
namespace Icon.Web.Mvc.Attributes
{
    ...
    public class ReadAccessAuthorizeAttribute : AuthorizeAttribute
    {
        ...
        protected override bool AuthorizeCore(HttpContextBase httpContext)
        {
            ...
            {
                grantAccess = ConfigurationManager.AppSettings["ReadAccess"].Split(',').Any(x => httpContext.User.IsInRole(x.Trim()));
            }
