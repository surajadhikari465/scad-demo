...
namespace Icon.Web.Mvc.Attributes
{
    ...
    public class AdminAccessAuthorizeAttribute : AuthorizeAttribute
    {
        ...
        protected override bool AuthorizeCore(HttpContextBase httpContext)
        {
            ...
            {
                grantAccess = ConfigurationManager.AppSettings["AdminAccess"].Split(',').Any(x => httpContext.User.IsInRole(x.Trim()));
            }
