...
namespace Icon.Web.Tests.Unit.Extensions
{
    ...
    public class ExtensionsTests
    {
        ...
        public void GetSearchParameters_ItemSearchModelWithNoSetProperties_ShouldPopulateSearchParameters()
        {
            ...
            Assert.AreEqual(result.DeliverySystem, viewModel.SelectedDeliverySystem);
            ...
            Assert.AreEqual(result.AnimalWelfareRatingId, viewModel.ItemSignAttributes.SelectedAnimalWelfareRatingId);
            Assert.AreEqual(result.Biodynamic, viewModel.ItemSignAttributes.SelectedBiodynamicOption);
            Assert.AreEqual(result.MilkTypeId, viewModel.ItemSignAttributes.SelectedCheeseMilkTypeId);
            Assert.AreEqual(result.CheeseRaw, viewModel.ItemSignAttributes.SelectedCheeseRawOption);
            Assert.AreEqual(result.EcoScaleRatingId, viewModel.ItemSignAttributes.SelectedEcoScaleRatingId);
            ...
            Assert.AreEqual(result.SeafoodFreshOrFrozenId, viewModel.ItemSignAttributes.SelectedSeafoodFreshOrFrozenId);
            Assert.AreEqual(result.SeafoodCatchTypeId, viewModel.ItemSignAttributes.SelectedSeafoodCatchTypeId);
