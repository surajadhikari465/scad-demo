...
namespace Icon.Web.Tests.Unit.Exporters
{
    ...
    public class BulkNewItemExporterTests
    {
        ...
        public void Export_IrmaItemList_ShouldBeConvertedToWorkbookObject()
        {
            ...
            Assert.AreEqual(glutenFree, firstWorksheet.Rows[1].Cells[ExcelHelper.IrmaItemColumnIndexes.GlutenFreeColumnIndex].Value);
            Assert.AreEqual(kosher, firstWorksheet.Rows[1].Cells[ExcelHelper.IrmaItemColumnIndexes.KosherColumnIndex].Value);
            Assert.AreEqual(nonGmo, firstWorksheet.Rows[1].Cells[ExcelHelper.IrmaItemColumnIndexes.NonGmoColumnIndex].Value);
            Assert.AreEqual(organic, firstWorksheet.Rows[1].Cells[ExcelHelper.IrmaItemColumnIndexes.OrganicColumnIndex].Value);
            ...
            Assert.AreEqual(vegan, firstWorksheet.Rows[1].Cells[ExcelHelper.IrmaItemColumnIndexes.VeganColumnIndex].Value);
