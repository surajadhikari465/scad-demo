		...
		private Locale CreateTestLocale()
		{
			Locale locale = new Locale
			{
				...
				LocaleTrait = new List<LocaleTrait>
				{
					...
					new LocaleTrait
					{
						Trait = context.Trait.First(t => t.traitCode == TraitCodes.SodiumWarningRequired),
						traitID = context.Trait.First(t => t.traitCode == TraitCodes.SodiumWarningRequired).traitID,
						localeID = 12345,
						traitValue = "1"
					},
				},
