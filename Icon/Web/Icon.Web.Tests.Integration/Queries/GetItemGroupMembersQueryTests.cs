...
{
    /// <summary>
    /// GetItemGroupMembersQuery Tests.
    /// </summary>
    [TestClass]
    public class GetItemGroupMembersQueryTests
    {
        ...
        public void GetItemGroupQuery_Validate_Argument_Null()
        {
            ...
            Assert.ThrowsException<ArgumentNullException>(() => new GetItemGroupMembersQuery(null));
        }
