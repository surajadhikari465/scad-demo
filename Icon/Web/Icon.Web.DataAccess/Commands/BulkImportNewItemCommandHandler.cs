    ...
    public class BulkImportNewItemCommandHandler : ICommandHandler<BulkImportCommand<BulkImportNewItemModel>>
    {
        ...
        public void Execute(BulkImportCommand<BulkImportNewItemModel> data)
        {
            ...
            var itemListData = data.BulkImportData.ConvertAll(item => new
            {
                ...
                GlutenFreeAgencyId = GetNullableValue(item.GlutenFreeAgency),
                KosherAgencyId = GetNullableValue(item.KosherAgency),
                Msc = GetNullableValue(item.Msc),
                NonGmoAgencyId = GetNullableValue(item.NonGmoAgency),
                OrganicAgencyId = GetNullableValue(item.OrganicAgency),
                ...
                VeganAgencyId = GetNullableValue(item.VeganAgency),
