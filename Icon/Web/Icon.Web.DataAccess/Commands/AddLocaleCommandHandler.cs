...
namespace Icon.Web.DataAccess.Commands
{
	public class AddLocaleCommandHandler : ICommandHandler<AddLocaleCommand>
	{
		...
		public void Execute(AddLocaleCommand data)
		{
			...
			var traits = new List<LocaleTrait>
				{
					...
					!data.Ident ? null : new LocaleTrait { traitID = Traits.Ident, traitValue = "1" },
					!data.SodiumWarningRequired ? null : new LocaleTrait { traitID = Traits.SodiumWarningRequired, traitValue = "1" }
				};
			...
			var locale = new Locale
			{
				...
				LocaleTrait = traits.Where(x => x != null).ToList()
			};
