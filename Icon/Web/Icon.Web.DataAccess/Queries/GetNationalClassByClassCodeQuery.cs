    ...
    public class GetNationalClassByClassCodeQuery : IQueryHandler<GetNationalClassByClassCodeParameters, List<HierarchyClass>>
    {
        ...
        private string SetSortColumnToMatchStoredProcedureColumn(string sortColumn)
        {
            switch(sortColumn)
            {
                ...
                case "GlutenFreeAgencyId": return "isa.GlutenFreeAgencyId";
                case "KosherAgencyId": return "isa.KosherAgencyId";
                case "Msc": return "isa.Msc";
                case "NonGmoAgencyId": return "isa.NonGmoAgencyId";
                case "OrganicAgencyId": return "isa.OrganicAgencyId";
                ...
                case "VeganAgencyId": return "isa.VeganAgencyId";
