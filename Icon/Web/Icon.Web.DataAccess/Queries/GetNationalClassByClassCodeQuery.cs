    ...
    public class GetNationalClassByClassCodeQuery : IQueryHandler<GetNationalClassByClassCodeParameters, List<HierarchyClass>>
    {
        ...
        private string SetSortColumnToMatchStoredProcedureColumn(string sortColumn)
        {
            switch(sortColumn)
            {
                ...
                case "GlutenFreeAgency": return "isa.GlutenFreeAgency";
                case "KosherAgency": return "isa.KosherAgency";
                case "Msc": return "isa.Msc";
                case "NonGmoAgency": return "isa.NonGmoAgency";
                case "OrganicAgency": return "isa.OrganicAgency";
                ...
                case "VeganAgency": return "isa.VeganAgency";
