<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" Inherits="ReportManagerWebApp.GrossMarginException" title="IRMA Report Manager" Codebehind="GrossMarginException.aspx.vb" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="navbar"><h3><a href="..\Default.aspx">Home</a> &gt; <a href="PriceReports.aspx?valuePath=Reports Home/Prices">Price Reports</a> &gt; Gross Margin Exception</h3>
    </div>
        <table style="width: 748px;">
            ...
            <tr>
                ...
                <td colspan="4" style="width: 321px"></td>
            </tr>
            <tr>
                <td style="width: 197px; text-align: right;">
                    Max Subteam</td>
            ...
            <tr>
                ...
                <td colspan="4" style="width: 321px">
                    <asp:RequiredFieldValidator ID="reqfld_txtMinval" runat="server" ControlToValidate="txtMinGM"
                        ErrorMessage="* Minimum Gross Margin is a required field." Width="317px"></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td style="width: 197px; text-align: right">
                    Max Gross Margin</td>
                ...
                <td colspan="4" style="width: 321px">
                    <asp:RequiredFieldValidator ID="reqfld_txtMaxval" runat="server" ControlToValidate="txtMaxGM"
                        ErrorMessage="* Maximum Gross Margin is a required field." Width="318px"></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td style="width: 197px; text-align: right;">
                    Report Format</td>
