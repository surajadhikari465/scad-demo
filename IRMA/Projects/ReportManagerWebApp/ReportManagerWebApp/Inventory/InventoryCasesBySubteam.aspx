<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" Inherits="ReportManagerWebApp.Inventory_InventoryCasesBySubteam" Codebehind="InventoryCasesBySubteam.aspx.vb" %>
...
<div id="navbar"><h3><a href="..\Default.aspx">Home</a> &gt; <a href="InventoryReports.aspx?valuePath=Reports Home/Inventory">Inventory Reports</a> &gt; Inventory Cases by Subteam</h3>
</div>
    <table border="0">
        <tr>
            ...
            <td style="width: 458px; height: 1px; text-align: left">
                ...
                <asp:SqlDataSource ID="dsFacility" runat="server" ConnectionString="<%$ ConnectionStrings:ReportManager_Conn %>"
                    SelectCommand="
                                   SELECT CompanyName AS Label, Vendor_ID AS 'Value'
                                   FROM Vendor V (NOLOCK)
                                   INNER JOIN Store S (NOLOCK)
	                               ON S.Store_No = V.Store_No
                                   WHERE (Manufacturer = 1 OR Distribution_Center = 1)
