...
Partial Class Distribution_PreOrderShipping
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        'report name
        sReportURL.Append(Application.Get("region") + "_" + "PreOrderedDCShipping")
        ...
        sReportURL.Append("&ExpectedDate=" & CDate(dteExpectedDate.Value).ToString("MM/dd/yyyy"))
