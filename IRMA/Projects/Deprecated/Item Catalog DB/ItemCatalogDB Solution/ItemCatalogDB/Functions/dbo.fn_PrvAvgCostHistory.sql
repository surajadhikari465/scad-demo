  /****** Object:  UserDefinedFunction [dbo].[fn_PrvAvgCostHistory]    Script Date: 11/30/2007 *****/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

IF EXISTS (SELECT * FROM   sysobjects WHERE  name = N'fn_PrvAvgCostHistory')
    DROP FUNCTION fn_PrvAvgCostHistory
GO
-- ===================================================================
-- Author:		Sekhara
