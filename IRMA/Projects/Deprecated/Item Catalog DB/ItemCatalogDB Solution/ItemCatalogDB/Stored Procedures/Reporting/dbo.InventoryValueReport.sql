...
/****** Object:  StoredProcedure [dbo].[InventoryValueReport]    Script Date: 10/04/2012 15:39:22 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[InventoryValueReport]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[InventoryValueReport]
GO
