IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'GenerateEvents')
	EXEC('CREATE PROCEDURE [mammoth].[GenerateEvents] AS BEGIN SET NOCOUNT ON; END')
GO

ALTER PROCEDURE [mammoth].[GenerateEvents]
