 /****** Object:  StoredProcedure [dbo].[EPromotions_GetPromotionPriceBatchDetail]    Script Date: 05/31/2006 16:02:45 ******/
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[EPromotions_GetPromotionPriceBatchDetail]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[EPromotions_GetPromotionPriceBatchDetail]
GO
/****** Object:  StoredProcedure [dbo].[EPromotions_GetPromotionPriceBatchDetail]    Script Date: 05/31/2006 16:02:45 ******/
SET ANSI_NULLS ON
GO
