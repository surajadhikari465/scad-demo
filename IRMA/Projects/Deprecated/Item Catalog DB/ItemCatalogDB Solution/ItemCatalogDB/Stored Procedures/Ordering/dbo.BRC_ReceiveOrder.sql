if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[BRC_ReceiveOrder]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[BRC_ReceiveOrder]
GO
