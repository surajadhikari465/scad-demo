...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ReceiveOrderItem4]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
    drop procedure [dbo].[ReceiveOrderItem4]
GO
