/****** Object:  Stored Procedure dbo.msqGetProduceAllStoresRetailPrices    Script Date: 10/4/2005 11:27:28 AM ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[msqGetProduceAllStoresRetailPrices]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[msqGetProduceAllStoresRetailPrices]
GO
