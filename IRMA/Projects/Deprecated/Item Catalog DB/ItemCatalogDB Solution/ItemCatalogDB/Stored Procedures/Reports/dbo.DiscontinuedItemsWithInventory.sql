/****** Object:  StoredProcedure [dbo].[DiscontinuedItemsWithInventory]    Script Date: 10/04/2012 15:19:23 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DiscontinuedItemsWithInventory]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[DiscontinuedItemsWithInventory]
GO
