...
--=====================================================================
--*********      dbo.EIM_Regen_GetUploadSessionUploadTypesByUploadTypeCode                             
--=====================================================================
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[EIM_Regen_GetUploadSessionUploadTypesByUploadTypeCode]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[EIM_Regen_GetUploadSessionUploadTypesByUploadTypeCode]
GO
