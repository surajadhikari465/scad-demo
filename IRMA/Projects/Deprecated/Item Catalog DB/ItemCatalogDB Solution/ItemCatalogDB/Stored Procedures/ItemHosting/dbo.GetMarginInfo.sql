 /****** Object:  StoredProcedure [dbo].[GetMarginInfo]    Script Date: 2/26/2007 11:06:56 ******/
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[GetMarginInfo]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[GetMarginInfo]
GO
