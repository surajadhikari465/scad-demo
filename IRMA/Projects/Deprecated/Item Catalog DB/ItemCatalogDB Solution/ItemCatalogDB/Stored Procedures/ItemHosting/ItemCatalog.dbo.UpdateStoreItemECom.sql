IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[UpdateStoreItemECom]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[UpdateStoreItemECom]
GO

/****** Object:  StoredProcedure [dbo].[UpdateStoreItemECom]    Script Date: 10/16/2013 ******/
SET ANSI_NULLS ON
GO
