if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[Scale_InsertUpdateNutriFact]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[Scale_InsertUpdateNutriFact]
GO
