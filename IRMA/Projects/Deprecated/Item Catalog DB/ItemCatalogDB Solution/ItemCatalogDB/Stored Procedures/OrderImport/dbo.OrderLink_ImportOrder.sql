PRINT 'Creating OrderLink_ImportOrder Stored Proc ...'

IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[OrderLink_ImportOrder]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[OrderLink_ImportOrder]
GO
