IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Replenishment_POSPull_InsertTempPriceAudit]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Replenishment_POSPull_InsertTempPriceAudit]
GO
