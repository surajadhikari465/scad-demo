...
Module SendOrdersModule
    ...
    Private Const CLASSNAME As String = "SendOrdersJob"
    ...
    Sub Main()
        ...
        Try
            ...
            logger.Info("[ SEND ORDERS JOB START ]")

            Try

                ' initialize and run the job
                Dim doJob As New SendOrdersJob()
                doJob.Main()

                ' Add the log messages to the queue
                _Logs.AddRange(doJob.LogMessages)
