...
#End Region
    ...
    Private Sub SupportDeleteItemFromPlumCorpChgQueueTmp_Click(sender As Object, e As EventArgs) Handles SupportDeleteItemFromPlumCorpChgQueueTmp.Click
        Dim window As New PlumCorpChgQueueTmpItemDelete()
        window.ShowDialog()
    End Sub
