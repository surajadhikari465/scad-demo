...
#Region "Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerNonUserCode()> Protected Overloads Overrides Sub Dispose(ByVal Disposing As Boolean)
    ...
    Me.checkIncludedInDailyPurge = New System.Windows.Forms.CheckBox()
    Me.Label7 = New System.Windows.Forms.Label()
    Me.checkDailyPurgeCompleted = New System.Windows.Forms.CheckBox()
    ...
    Me.lblLastPurgedDate = New System.Windows.Forms.Label()
    ...
    Me.NumericUpDownDaysToKeep.Minimum = New Decimal(New Integer() {1, 0, 0, 0})
    Me.NumericUpDownDaysToKeep.Name = "NumericUpDownDaysToKeep"
    Me.NumericUpDownDaysToKeep.Value = New Decimal(New Integer() {10, 0, 0, 0})
    '
    'Label6
    '
    ...
    '
    'checkIncludedInDailyPurge
    '
    resources.ApplyResources(Me.checkIncludedInDailyPurge, "checkIncludedInDailyPurge")
    Me.checkIncludedInDailyPurge.Name = "checkIncludedInDailyPurge"
    Me.checkIncludedInDailyPurge.UseVisualStyleBackColor = True
    '
    'Label7
    '
    ...
    '
    'checkDailyPurgeCompleted
    '
    resources.ApplyResources(Me.checkDailyPurgeCompleted, "checkDailyPurgeCompleted")
    Me.checkDailyPurgeCompleted.Name = "checkDailyPurgeCompleted"
    Me.checkDailyPurgeCompleted.UseVisualStyleBackColor = True
    '
    'txtSchema
    '
    ...
    Me.cboJobName.Items.AddRange(New Object() {resources.GetString("cboJobName.Items")})
    ...
    Me.NumericUpDownTimeToStart.Value = New Decimal(New Integer() {21, 0, 0, 0})
    '
    ...
    Me.NumericUpDownTimeToEnd.Value = New Decimal(New Integer() {24, 0, 0, 0})
    '
    'Label8
    '
    ...
    'lblLastPurgedDate
    '
    resources.ApplyResources(Me.lblLastPurgedDate, "lblLastPurgedDate")
    Me.lblLastPurgedDate.Name = "lblLastPurgedDate"
    '
    ...
    Me.Controls.Add(Me.lblLastPurgedDate)
    ...
    Me.Controls.Add(Me.checkDailyPurgeCompleted)
    Me.Controls.Add(Me.Label_IsSecureTransfer)
    Me.Controls.Add(Me.checkIncludedInDailyPurge)
  ...
  Friend WithEvents checkIncludedInDailyPurge As CheckBox
  Friend WithEvents Label7 As Label
  Friend WithEvents checkDailyPurgeCompleted As CheckBox
  ...
  Friend WithEvents lblLastPurgedDate As Label
#End Region
End Class