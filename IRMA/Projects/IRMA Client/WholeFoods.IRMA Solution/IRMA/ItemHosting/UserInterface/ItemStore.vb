...
Friend Class frmItemStore
	...
	Private bCanUpdate As Boolean = (Not frmItem.lblReadOnly.Visible) And
			(gbSuperUser Or (gbItemAdministrator And frmItem.pbUserSubTeam)) And
	...
	Private Sub LoadSubTeamInfo()
		Dim subTeams As List(Of SubTeamBO) = SubTeamDAO.GetSubteams()
		subTeams.Insert(0, New SubTeamBO() With {.SubTeamNo = -1, .SubTeamName = "--No Exception--"})
		ComboBox_SubTeam.DataSource = subTeams
	...
	Private Sub LoadOtherData()
		...
		If IsDBNull(_itemStore.AgeCode) Or
	...
	Private Sub cmdSelect_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdSelect.Click
		...
		If ComboBox_AgeCode.SelectedIndex = -1 Or
