...
Public Class SubTeamEdit
    ...
    Private _IsNewSubTeam As Boolean
    ...
    Private Sub LoadSubteamInfo()
        ...
        CheckBox_AlignedSubTeam.Checked = (dr("AlignedSubTeam").ToString.Equals("True") Or dr("AlignedSubTeam").ToString.Equals("1"))
    ...
    Private Function ValidateData() As Boolean
        ...
        Try
            ' --- SubTeam_No
            If TextBox_SubTeamNo.Text.Trim.Equals("") Then Throw New Exception("SubTeam Number cannot be blank.")
            If Not IsNumeric(TextBox_SubTeamNo.Text.Trim) Then Throw New Exception("SubTeam must be a valid Integer value")

            If Me.IsNewSubTeam Then
                _dataset = DAO.GetSubTeam(CInt(TextBox_SubTeamNo.Text.Trim))
            ...
            End If
            '-- target margin
            If TextBox_TargetMargin.Text.Trim.Equals("") Or Not IsNumeric(TextBox_TargetMargin.Text.Trim) Then
                Throw New Exception("Target Margin must be a valid decimal value greater than 0.")
            End If
            If CSng(TextBox_TargetMargin.Text.Trim) <= 0 Then
                Throw New Exception("Target Margin must be a valid decimal value greater than 0.")
            End If
        ...
        logger.Debug("ValidateData Exit " & retval)
        Return retval
    End Function
    ...
    Private Function CreateSubTeamObject() As SubTeamBO
        ...
        Try
            ...
            item.DepartmentNo = CInt(IIf(TextBox_DepartmentNo.Text.Trim.Equals(""), -1, (TextBox_DepartmentNo.Text.Trim)))
            item.TeamNo = CType(ComboBox_Team.SelectedItem, TeamBO).TeamNo
            item.BuyerUserId = CInt(IIf(TextBox_BuyerUserId.Text.Trim.Equals(""), -1, (TextBox_BuyerUserId.Text.Trim)))
            item.SubDepartmentNo = CInt(IIf(TextBox_SubDeptNo.Text.Trim.Equals(""), -1, (TextBox_SubDeptNo.Text.Trim)))
            item.TargetMargin = CSng(IIf(TextBox_TargetMargin.Text.Trim.Equals(""), -1.0, (TextBox_TargetMargin.Text.Trim)))
            item.JDA = CInt(IIf(TextBox_JDA.Text.Trim.Equals(""), -1, (TextBox_JDA.Text.Trim)))
            item.TransferToMarkup = CSng(IIf(TextBox_TransferToMarkup.Text.Trim.Equals(""), -1.0, (TextBox_TransferToMarkup.Text.Trim)))
            ...
            item.GLDistributionAcct = CInt(IIf(TextBox_GLDistributionAccont.Text.Trim.Equals(""), -1, (TextBox_GLDistributionAccont.Text.Trim)))
            item.GLPurchaseAcct = CInt(IIf(TextBox_GLPurchaseAccount.Text.Trim.Equals(""), -1, (TextBox_GLPurchaseAccount.Text.Trim)))
            item.GLSalesAcct = CInt(IIf(TextBox_GLSalesAccount.Text.Trim.Equals(""), -1, (TextBox_GLSalesAccount.Text.Trim)))
            item.GLTransferAcct = CInt(IIf(TextBox_GLTransferAccount.Text.Trim.Equals(""), -1, (TextBox_GLTransferAccount.Text.Trim)))
            item.GLPackagingAcct = CInt(IIf(TextBox_GLPackagingAccount.Text.Trim.Equals(""), -1, (TextBox_GLPackagingAccount.Text.Trim)))
            item.GLSuppliesAcct = CInt(IIf(TextBox_GLSuppliesAccount.Text.Trim.Equals(""), -1, (TextBox_GLSuppliesAccount.Text.Trim)))
            item.ScaleDepartment = CInt(IIf(TextBox_ScaleDept.Text.Trim.Equals(""), -1, (TextBox_ScaleDept.Text.Trim)))
        ...
        Catch ex As Exception
            Throw New Exception("SubTeam Object could not be created. Check the form data.", ex)
            logger.Info("SubTeam Object could not be created. Check the form data.")
        End Try
