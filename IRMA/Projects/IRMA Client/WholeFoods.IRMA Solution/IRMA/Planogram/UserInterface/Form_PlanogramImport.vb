...
Public Class Form_PlanogramImport
	...
	Private Sub CreateButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CreateButton.Click
		...
		Dim storeNo As Integer = VB6.GetItemData(StoreComboBox, StoreComboBox.SelectedIndex)
		Dim subteamNo As Integer = If(cmbSubTeam.SelectedIndex = -1, 0, cmbSubTeam.SelectedItem.SubTeamNo)
	...
	Private Sub SubteamComboBox_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbSubTeam.SelectedIndexChanged
		LoadSetList()
	End Sub
