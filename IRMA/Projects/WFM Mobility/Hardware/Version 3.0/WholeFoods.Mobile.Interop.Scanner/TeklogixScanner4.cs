...
{
    public class TeklogixScanner4:Scanner
    {
        private WAP4::PsionTeklogix.Barcode.Scanner scanner;
        private WAP4::PsionTeklogix.Barcode.ScannerServices.ScannerServicesDriver scannerServicesDriver;
        private ScanForm myForm;
        private bool updateEnterKeys;
        private bool updateUPCE;

        public bool alreadyScanned = false;
        public bool updateUPCEStripTrailing;
        public bool updateUPCAStripTrailing;
        public bool updateEAN13StripTrailing;
        public bool updateEAN8StripTrailing;
        public bool updateUPCETransmitCheck;
        public bool updateUPCATransmitCheck;
        public bool updateEAN13TransmitCheck;
        public bool updateEAN8TransmitCheck;
        public bool updateGTCompliant;
        public bool updatePrefixKeys = false;
        public int prefixKey = 0;
        public WAP4::PsionTeklogix.Barcode.ScanFailedEventArgs scanEvent;

        public TeklogixScanner4(ScanForm form)
        {
            this.myForm = form;
        ...
        private void InitializeDecodeComponent()
        {
            try
            {
                ...
                scanner = new WAP4::PsionTeklogix.Barcode.Scanner();
                scannerServicesDriver = new WAP4::PsionTeklogix.Barcode.ScannerServices.ScannerServicesDriver();

                // Make sure UPC A, UPC E, EAN 8, EAN 13 check digits are not transmitted.
                //MessageBox.Show("In Scanner Config: scanner type is " + WAP4::PsionTeklogix.Barcode.ScannerServices.ScannerServicesDriver.InternalScannerType);
                if (WAP4::PsionTeklogix.Barcode.ScannerServices.ScannerServicesDriver.InternalScannerType.IndexOf("Symbol") >= 0)
                {
                    try
                    {
                        if ((int)scannerServicesDriver.GetProperty(@"Barcode\UPCA\EMDK\UPCA Transmit Check Digit") != 0 ||
                            (int)scannerServicesDriver.GetProperty(@"Barcode\UPCE\EMDK\UPCE Transmit Check Digit") != 0 ||
                            ...
                            (int)scannerServicesDriver.GetProperty(@"Barcode\EAN13\Scs\Strip Trailing") != 1)
                        {
                            ...
                            scannerServicesDriver.SetProperty(@"Barcode\UPCA\EMDK\UPCA Transmit Check Digit", 0);
                            scannerServicesDriver.SetProperty(@"Barcode\UPCE\EMDK\UPCE Transmit Check Digit", 0);
                    ...
                    //int temp = (int)scannerServicesDriver.GetProperty(@"Barcode\EAN13\Scs\Suffix Char");
                ...
                else if (WAP4::PsionTeklogix.Barcode.ScannerServices.ScannerServicesDriver.InternalScannerType.IndexOf("Intermec") >= 0)
                {
                    try
                    {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        MessageBox.Show("Failed to set Intermec scanner config:\r\n" + ex.Message);
                        return;
                    }
                }
                else if (WAP4::PsionTeklogix.Barcode.ScannerServices.ScannerServicesDriver.InternalScannerType.IndexOf("HHP") >= 0)
                {
                ...
                try
                {
                    scanner.ScanCompleteEvent += new WAP4::PsionTeklogix.Barcode.ScanCompleteEventHandler(OnScanCompleteEvent);
                    scanner.ScanFailedEvent += new WAP4::PsionTeklogix.Barcode.ScanFailedEventHandler(OnScanFailedEvent);
                    scanner.ScanTriggerEvent += new WAP4::PsionTeklogix.Barcode.ScanTriggerEventHandler(OnScanTriggerEvent);
                }
                catch
                {
                    try
            ...
            catch (Exception expe) { MessageBox.Show(expe.Message); }
        }


        private void OnScanCompleteEvent(object sender, WAP4::PsionTeklogix.Barcode.ScanCompleteEventArgs e)
        {
            //upcText = e.Text;
        ...
        private void OnScanFailedEvent(object sender, WAP4::PsionTeklogix.Barcode.ScanFailedEventArgs e)
        {
            //myForm.scanEvent = e;
            myForm.UpdateControlsScanFailedEvent();
        }

        private void OnScanTriggerEvent(object sender, WAP4::PsionTeklogix.Barcode.ScanTriggerEventArgs e)
        {
            if (e.ScanTriggerState == WAP4::PsionTeklogix.Barcode.TriggerState.Down)
            {
        ...
        //        try
        //        {
        //            WAP4::PsionTeklogix.Barcode.ScannerServices.ScannerServicesDriver myDriver = scannerServicesDriver;
        ...
        public void restore()
        {
            WAP4::PsionTeklogix.Barcode.ScannerServices.ScannerServicesDriver scannerServicesDriver1 = scannerServicesDriver;
                ...
                )
            {
                ...
                {
                    MessageBox.Show("Unable to reset scanner settings\r\n" + ex.Message, "");
                }
