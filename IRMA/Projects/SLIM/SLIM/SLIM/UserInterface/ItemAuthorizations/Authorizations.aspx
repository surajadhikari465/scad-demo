<%@ Page Language="VB" MasterPageFile="~/UserInterface/MasterPage.master" AutoEventWireup="false" Inherits="SLIM.UserInterface_ItemAuthorizations_Authorizations" title="Authorizations" Codebehind="Authorizations.aspx.vb" %>
                            ...
                            <Bands>
                                <igtbl:UltraGridBand>
                                    ...
                                    <Columns>
                                        ...
                                        <igtbl:UltraGridColumn AllowUpdate="Yes" BaseColumnName="Authorized" CellButtonDisplay="Always"
                                            DataType="System.Boolean" IsBound="True" Key="Authorized" Type="CheckBox">
                                            <Header>
