	...
	DECLARE @GridPosition int
		...
		IF NOT EXISTS 
		(SELECT * FROM UploadAttribute WHERE Name = 'Storage Data')
		INSERT INTO 
		[UploadAttribute]
		...
		VALUES('Storage Data', 'scale_storagedata', 'storagedata', 'TextBox', 'varchar', 1024, NULL, 0, 0, NULL, NULL, NULL, 1,  NULL,  NULL,  NULL, @MaxSpreadSheetPosition, NULL)
		...
		IF NOT EXISTS 
		(SELECT * FROM UploadTypeAttribute WHERE UploadType_Code = 'ITEM_MAINTENANCE' AND UploadAttribute_ID = @UploadAttribute_ID)
		INSERT INTO 
		UploadTypeAttribute 
		...
		VALUES 
		('ITEM_MAINTENANCE', @UploadAttribute_ID, 0, 1, 0, @GridPosition, 0, 1, 'Scale Data')
