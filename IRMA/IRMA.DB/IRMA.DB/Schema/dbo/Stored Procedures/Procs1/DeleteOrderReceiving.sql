...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[DeleteOrderReceiving] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[DeleteOrderReceiving] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[DeleteOrderReceiving] TO [IRMAReportsRole]
    AS [dbo];
