...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[DCStoreRetailPriceReport] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[DCStoreRetailPriceReport] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[DCStoreRetailPriceReport] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[DCStoreRetailPriceReport] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[DCStoreRetailPriceReport] TO [IRMAReportsRole]
    AS [dbo];
