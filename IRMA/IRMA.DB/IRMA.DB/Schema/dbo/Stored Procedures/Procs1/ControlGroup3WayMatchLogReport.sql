...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ControlGroup3WayMatchLogReport] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ControlGroup3WayMatchLogReport] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ControlGroup3WayMatchLogReport] TO [IRMAReportsRole]
    AS [dbo];
