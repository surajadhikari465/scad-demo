...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WFMM_GetStoreItemOrderInfo] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WFMM_GetStoreItemOrderInfo] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WFMM_GetStoreItemOrderInfo] TO [IRMAReportsRole]
    AS [dbo];
