...
CREATE PROCEDURE [dbo].[VIMRetailPriceFile]
AS 
BEGIN
--**************************************************************************
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[VIMRetailPriceFile] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[VIMRetailPriceFile] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[VIMRetailPriceFile] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[VIMRetailPriceFile] TO [IRMAReportsRole]
    AS [dbo];
