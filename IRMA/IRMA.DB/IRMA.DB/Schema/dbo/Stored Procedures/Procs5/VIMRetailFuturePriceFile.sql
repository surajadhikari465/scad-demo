...
CREATE PROCEDURE dbo.VIMRetailFuturePriceFile
AS 
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[VIMRetailFuturePriceFile] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[VIMRetailFuturePriceFile] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[VIMRetailFuturePriceFile] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[VIMRetailFuturePriceFile] TO [IRMAReportsRole]
    AS [dbo];
