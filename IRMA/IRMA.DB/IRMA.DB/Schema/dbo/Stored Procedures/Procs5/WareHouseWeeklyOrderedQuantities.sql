...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WareHouseWeeklyOrderedQuantities] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WareHouseWeeklyOrderedQuantities] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WareHouseWeeklyOrderedQuantities] TO [IRMAReportsRole]
    AS [dbo];
