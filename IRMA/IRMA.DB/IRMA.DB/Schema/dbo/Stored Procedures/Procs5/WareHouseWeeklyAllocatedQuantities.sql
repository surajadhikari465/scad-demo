...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WareHouseWeeklyAllocatedQuantities] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WareHouseWeeklyAllocatedQuantities] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WareHouseWeeklyAllocatedQuantities] TO [IRMAReportsRole]
    AS [dbo];
