...
-- 2013/01/04	KM		9251	Select ru.Unit_ID instead of i.Retail_Unit_ID to properly pick up any override Retail Units;
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WFMM_GetTransferItem] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WFMM_GetTransferItem] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WFMM_GetTransferItem] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[WFMM_GetTransferItem] TO [IRMAReportsRole]
    AS [dbo];
