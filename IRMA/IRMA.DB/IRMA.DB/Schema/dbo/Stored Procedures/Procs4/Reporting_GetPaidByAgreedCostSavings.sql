...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_GetPaidByAgreedCostSavings] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_GetPaidByAgreedCostSavings] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_GetPaidByAgreedCostSavings] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_GetPaidByAgreedCostSavings] TO [IRMAReportsRole]
    AS [dbo];
