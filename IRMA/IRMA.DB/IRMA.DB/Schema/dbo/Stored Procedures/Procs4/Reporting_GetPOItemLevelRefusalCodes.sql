...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_GetPOItemLevelRefusalCodes] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_GetPOItemLevelRefusalCodes] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_GetPOItemLevelRefusalCodes] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_GetPOItemLevelRefusalCodes] TO [IRMAReportsRole]
    AS [dbo];
