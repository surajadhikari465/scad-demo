...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[UpdateOrderItemFreight3PartyAll] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[UpdateOrderItemFreight3PartyAll] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[UpdateOrderItemFreight3PartyAll] TO [IRMAReportsRole]
    AS [dbo];
