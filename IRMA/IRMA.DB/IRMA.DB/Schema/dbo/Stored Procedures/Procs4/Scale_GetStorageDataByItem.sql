...
AS
BEGIN
	SELECT ISNULL(sd.Scale_StorageData_ID,0) AS Scale_StorageData_ID,
	...
	WHERE  idf.Item_Key = @Item_Key AND idf.Deleted_identifier = 0
	AND    idf.Remove_identifier = 0 AND  idf.Default_identifier = 1
END
GO
