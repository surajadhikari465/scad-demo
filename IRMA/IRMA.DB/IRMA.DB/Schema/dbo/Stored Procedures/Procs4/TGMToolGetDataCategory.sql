...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TGMToolGetDataCategory] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TGMToolGetDataCategory] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TGMToolGetDataCategory] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[TGMToolGetDataCategory] TO [IRMAReportsRole]
    AS [dbo];
