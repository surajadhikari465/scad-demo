...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[UpdateReceivingDiscrepancyReasonCodeID] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[UpdateReceivingDiscrepancyReasonCodeID] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[UpdateReceivingDiscrepancyReasonCodeID] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[UpdateReceivingDiscrepancyReasonCodeID] TO [IRMASchedJobsRole]
    AS [dbo];
