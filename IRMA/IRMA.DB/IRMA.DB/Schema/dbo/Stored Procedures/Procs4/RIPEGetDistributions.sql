...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[RIPEGetDistributions] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[RIPEGetDistributions] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[RIPEGetDistributions] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[RIPEGetDistributions] TO [IRMAReportsRole]
    AS [dbo];
