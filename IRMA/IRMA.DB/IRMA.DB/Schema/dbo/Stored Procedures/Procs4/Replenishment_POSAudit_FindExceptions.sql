...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_POSAudit_FindExceptions] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_POSAudit_FindExceptions] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_POSAudit_FindExceptions] TO [IRMASchedJobsRole]
    AS [dbo];
