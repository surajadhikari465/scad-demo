...
CREATE PROCEDURE [dbo].[Replenishment_TagPush_GetAccessViaBatchTagFile]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_TagPush_GetAccessViaBatchTagFile] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Replenishment_TagPush_GetAccessViaBatchTagFile] TO [IRMAClientRole]
    AS [dbo];
