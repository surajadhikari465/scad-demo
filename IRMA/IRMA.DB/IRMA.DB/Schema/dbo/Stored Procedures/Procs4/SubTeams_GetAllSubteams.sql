...
GRANT EXECUTE
    ON OBJECT::[dbo].[SubTeams_GetAllSubteams] TO [IRMAAdminRole]
    AS [dbo];

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SubTeams_GetAllSubteams] TO [IRMASupportRole]
    AS [dbo];

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[SubTeams_GetAllSubteams] TO [IRMAClientRole]
    AS [dbo];