...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_GetAverageCostVariance] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_GetAverageCostVariance] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_GetAverageCostVariance] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_GetAverageCostVariance] TO [IRMAReportsRole]
    AS [dbo];
