...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[UpdateOrderResetWarehouseSent] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[UpdateOrderResetWarehouseSent] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[UpdateOrderResetWarehouseSent] TO [IRMAReportsRole]
    AS [dbo];
