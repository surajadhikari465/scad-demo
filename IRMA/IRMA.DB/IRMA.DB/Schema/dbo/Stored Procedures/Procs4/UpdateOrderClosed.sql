...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[UpdateOrderClosed] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[UpdateOrderClosed] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[UpdateOrderClosed] TO [IRMAReportsRole]
    AS [dbo];
