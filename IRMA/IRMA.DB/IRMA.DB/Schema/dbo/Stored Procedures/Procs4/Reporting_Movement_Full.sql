...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_Movement_Full] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_Movement_Full] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_Movement_Full] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_Movement_Full] TO [IRMAReportsRole]
    AS [dbo];
