...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_PIRIS_RunAudit] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_PIRIS_RunAudit] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[Reporting_PIRIS_RunAudit] TO [IRMAReportsRole]
    AS [dbo];
