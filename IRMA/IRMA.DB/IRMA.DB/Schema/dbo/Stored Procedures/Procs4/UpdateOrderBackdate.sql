...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[UpdateOrderBackdate] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[UpdateOrderBackdate] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[UpdateOrderBackdate] TO [IRMAReportsRole]
    AS [dbo];
