...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetOrderHeaderByIdentifier] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetOrderHeaderByIdentifier] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetOrderHeaderByIdentifier] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetOrderHeaderByIdentifier] TO [IRMAReportsRole]
    AS [dbo];
