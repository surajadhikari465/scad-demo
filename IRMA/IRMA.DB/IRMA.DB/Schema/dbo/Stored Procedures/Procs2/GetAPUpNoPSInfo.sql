CREATE PROCEDURE dbo.GetAPUpNoPSInfo
@Begin_Date datetime,
@End_Date datetime,
@Store_No int
AS
-- **************************************************************************
-- Procedure: GetAPUpNoPSInfo()
--    Author: n/a
--      Date: n/a
--
-- Description:
...
-- 12/23/2011  BAS	coding standards; validated charges calculation (TFS 33744)
-- **************************************************************************
BEGIN
    SET NOCOUNT ON
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetAPUpNoPSInfo] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetAPUpNoPSInfo] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetAPUpNoPSInfo] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetAPUpNoPSInfo] TO [IRMAReportsRole]
    AS [dbo];
