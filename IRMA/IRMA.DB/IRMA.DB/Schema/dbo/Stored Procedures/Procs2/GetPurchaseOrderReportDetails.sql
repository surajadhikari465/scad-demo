...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetPurchaseOrderReportDetails] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetPurchaseOrderReportDetails] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetPurchaseOrderReportDetails] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetPurchaseOrderReportDetails] TO [IRMAReportsRole]
    AS [dbo];
