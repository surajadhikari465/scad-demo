...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetStoresAndDist] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetStoresAndDist] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetStoresAndDist] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetStoresAndDist] TO [IRMAReportsRole]
    AS [dbo];
