CREATE PROCEDURE dbo.GetAPUpNotApproved
	@Begin_Date datetime,
	@End_Date	datetime,
	@Store_No	int
AS
-- **************************************************************************
-- Procedure: GetAPUpNotApproved()
--    Author: n/a
--      Date: n/a
--
-- Description:
...
BEGIN
	...
	GROUP BY 
        ...
        RecvLogDate,
        v.CompanyName, 
        InvoiceDate, VendorDocDate, 
        InvoiceNumber, VendorDoc_ID,
        ov.InvoiceCost, Return_Order,
        InvoiceFreight,
        sst.Team_No, 
        ov.SubTeam_No, 
        oh.OrderHeader_ID,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetAPUpNotApproved] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetAPUpNotApproved] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetAPUpNotApproved] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetAPUpNotApproved] TO [IRMAReportsRole]
    AS [dbo];
