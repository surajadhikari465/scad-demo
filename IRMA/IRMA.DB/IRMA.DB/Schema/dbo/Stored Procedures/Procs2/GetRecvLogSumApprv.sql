...
CREATE PROCEDURE [dbo].[GetRecvLogSumApprv] 
	@Store_No	int,
	@Begin		varchar(255),
	@End		varchar(255),
	@SubTeam_No	int
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetRecvLogSumApprv] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetRecvLogSumApprv] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetRecvLogSumApprv] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetRecvLogSumApprv] TO [IRMAReportsRole]
    AS [dbo];
