...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetAPUpUploaded] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetAPUpUploaded] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetAPUpUploaded] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetAPUpUploaded] TO [IRMAReportsRole]
    AS [dbo];
