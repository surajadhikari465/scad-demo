...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetOrderItemReceivedList] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetOrderItemReceivedList] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetOrderItemReceivedList] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetOrderItemReceivedList] TO [IRMAReportsRole]
    AS [dbo];
