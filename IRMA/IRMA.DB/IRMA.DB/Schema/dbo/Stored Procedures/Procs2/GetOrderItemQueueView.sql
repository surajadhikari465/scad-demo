...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetOrderItemQueueView] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetOrderItemQueueView] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetOrderItemQueueView] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetOrderItemQueueView] TO [IRMAReportsRole]
    AS [dbo];
