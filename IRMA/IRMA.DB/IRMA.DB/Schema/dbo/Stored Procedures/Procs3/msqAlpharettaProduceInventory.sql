...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[msqAlpharettaProduceInventory] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[msqAlpharettaProduceInventory] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[msqAlpharettaProduceInventory] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[msqAlpharettaProduceInventory] TO [IRMAReportsRole]
    AS [dbo];
