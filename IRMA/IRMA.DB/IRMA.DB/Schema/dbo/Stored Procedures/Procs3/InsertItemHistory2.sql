...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertItemHistory2] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertItemHistory2] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertItemHistory2] TO [IRMAReportsRole]
    AS [dbo];
