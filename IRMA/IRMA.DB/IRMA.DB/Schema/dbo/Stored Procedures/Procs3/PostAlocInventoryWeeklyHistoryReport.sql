...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PostAlocInventoryWeeklyHistoryReport] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PostAlocInventoryWeeklyHistoryReport] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PostAlocInventoryWeeklyHistoryReport] TO [IRMAReportsRole]
    AS [dbo];
