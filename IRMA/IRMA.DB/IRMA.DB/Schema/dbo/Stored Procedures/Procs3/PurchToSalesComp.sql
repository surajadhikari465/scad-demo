...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PurchToSalesComp] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PurchToSalesComp] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PurchToSalesComp] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PurchToSalesComp] TO [IRMAReportsRole]
    AS [dbo];
