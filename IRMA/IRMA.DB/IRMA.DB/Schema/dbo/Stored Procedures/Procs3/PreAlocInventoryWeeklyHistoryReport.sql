...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PreAlocInventoryWeeklyHistoryReport] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PreAlocInventoryWeeklyHistoryReport] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PreAlocInventoryWeeklyHistoryReport] TO [IRMAReportsRole]
    AS [dbo];
