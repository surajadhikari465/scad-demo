...
print '[' + convert(nvarchar, getdate(), 121) + '] ' + 'Finish: [InsertOrUpdateItemExtraText.sql]'

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertOrUpdateItemExtraText] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertOrUpdateItemExtraText] TO [IRSUser]
    AS [dbo];
