...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertCycleCountItemsVendor] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertCycleCountItemsVendor] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertCycleCountItemsVendor] TO [IRMAReportsRole]
    AS [dbo];
