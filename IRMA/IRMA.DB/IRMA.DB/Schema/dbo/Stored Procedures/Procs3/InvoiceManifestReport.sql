...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InvoiceManifestReport] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InvoiceManifestReport] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InvoiceManifestReport] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InvoiceManifestReport] TO [IRMAReportsRole]
    AS [dbo];
