...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[OrderInvoice_3PartyFreightInvoice_Update] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[OrderInvoice_3PartyFreightInvoice_Update] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[OrderInvoice_3PartyFreightInvoice_Update] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[OrderInvoice_3PartyFreightInvoice_Update] TO [IRMAReportsRole]
    AS [dbo];
