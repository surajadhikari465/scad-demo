...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GLDistributionCheckReport] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GLDistributionCheckReport] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GLDistributionCheckReport] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GLDistributionCheckReport] TO [IRMAReportsRole]
    AS [dbo];
