...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PSIMovement] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PSIMovement] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PSIMovement] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PSIMovement] TO [IRMAReportsRole]
    AS [dbo];
