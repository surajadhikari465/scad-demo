...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MarginByVendorReport_UseLastCost] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MarginByVendorReport_UseLastCost] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MarginByVendorReport_UseLastCost] TO [IRMAReportsRole]
    AS [dbo];
