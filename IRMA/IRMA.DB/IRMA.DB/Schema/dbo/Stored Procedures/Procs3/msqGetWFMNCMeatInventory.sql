/****** Object:  Stored Procedure dbo.msqGetWFMNCMeatInventory    Script Date: 2/12/2006 2:51:39 PM ******/
CREATE PROCEDURE dbo.msqGetWFMNCMeatInventory 
@Store_No int
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[msqGetWFMNCMeatInventory] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[msqGetWFMNCMeatInventory] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[msqGetWFMNCMeatInventory] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[msqGetWFMNCMeatInventory] TO [IRMAReportsRole]
    AS [dbo];
