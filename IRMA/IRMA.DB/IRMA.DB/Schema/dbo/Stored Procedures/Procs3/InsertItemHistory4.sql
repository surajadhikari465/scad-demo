...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertItemHistory4] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertItemHistory4] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertItemHistory4] TO [IRMAReportsRole]
    AS [dbo];
