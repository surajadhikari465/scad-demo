...
CREATE PROCEDURE [dbo].[InsertItemIdentifier]
    @Item_Key					int,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertItemIdentifier] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertItemIdentifier] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertItemIdentifier] TO [IRMAReportsRole]
    AS [dbo];
