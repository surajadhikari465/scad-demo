...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MarginBySubTeamReport_UseLastCost] TO [IRMASupportRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MarginBySubTeamReport_UseLastCost] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MarginBySubTeamReport_UseLastCost] TO [IRMAReportsRole]
    AS [dbo];
