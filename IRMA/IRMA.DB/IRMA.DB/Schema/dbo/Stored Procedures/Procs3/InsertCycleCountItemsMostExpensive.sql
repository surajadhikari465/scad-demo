...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertCycleCountItemsMostExpensive] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertCycleCountItemsMostExpensive] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[InsertCycleCountItemsMostExpensive] TO [IRMAReportsRole]
    AS [dbo];
