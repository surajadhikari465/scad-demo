...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PerpetualMovementReport] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PerpetualMovementReport] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PerpetualMovementReport] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[PerpetualMovementReport] TO [IRMAReportsRole]
    AS [dbo];
