...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Used as boolean flag to indicate if an Error Report has been sent', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Einvoicing_Invoices_Old', @level2type = N'COLUMN', @level2name = N'ErrorEmailSentDate';
