...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[fn_GLAcctIncludesTeamSubteam] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[fn_GLAcctIncludesTeamSubteam] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[fn_GLAcctIncludesTeamSubteam] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[fn_GLAcctIncludesTeamSubteam] TO [IRMAReportsRole]
    AS [dbo];
