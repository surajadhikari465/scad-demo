...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[fn_GetPreviousAvgCostSource] TO [IRMAAdminRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[fn_GetPreviousAvgCostSource] TO [IRMAClientRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[fn_GetPreviousAvgCostSource] TO [IRMASchedJobsRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[fn_GetPreviousAvgCostSource] TO [IRMAReportsRole]
    AS [dbo];
