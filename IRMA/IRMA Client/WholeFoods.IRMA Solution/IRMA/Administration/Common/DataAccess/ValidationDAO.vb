...
Namespace WholeFoods.IRMA.Administration.Common.DataAccess
    ...
    Public Class ValidationDAO
        ...
        Public Shared Function IsErrorCode(ByVal valCode As Integer) As Boolean
            logger.Debug("IsErrorCode entry: valCode=" + valCode.ToString)
            ...
            If valCode <> 0 Then
                ...
                End If
            End If
            logger.Debug("IsErrorCode exit: isError=" + isError.ToString)
            Return isError
        End Function
        ...
        Public Shared Function GetValidationCodeDetails(ByVal valCode As Integer) As ValidationBO
            logger.Debug("GetValidationCodeDetails entry: valCode=" + valCode.ToString)
            Dim factory As New DataFactory(DataFactory.ItemCatalog)
