IF EXISTS (SELECT * from dbo.sysobjects WHERE id = object_id(N'[dbo].[fn_HasPendingItemChangePriceBatchDetailRecord]') AND xtype IN (N'FN', N'IF', N'TF'))
	DROP FUNCTION [dbo].[fn_HasPendingItemChangePriceBatchDetailRecord]
GO
