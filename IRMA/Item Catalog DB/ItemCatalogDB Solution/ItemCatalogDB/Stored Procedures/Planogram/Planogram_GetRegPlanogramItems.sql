if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[Planogram_GetRegPlanogramItems]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[Planogram_GetRegPlanogramItems]
GO
