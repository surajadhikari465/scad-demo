...
IF EXISTS (select * from dbo.sysobjects where id = object_id(N'[dbo].[OpenOrdersReport]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[OpenOrdersReport]
GO
