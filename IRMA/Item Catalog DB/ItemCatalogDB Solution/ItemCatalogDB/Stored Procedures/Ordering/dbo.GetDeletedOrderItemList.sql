/****** Object:  StoredProcedure [dbo].[GetDeletedOrderItemList]    Script Date: 11/07/2012 14:39:43 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GetDeletedOrderItemList]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[GetDeletedOrderItemList]
GO
