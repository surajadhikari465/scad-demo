...
SET ANSI_NULLS ON 
GO
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[ReceiveOrderItem3]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
	drop procedure [dbo].[ReceiveOrderItem3]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
