IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[InsertItemUploadDetail]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[InsertItemUploadDetail]
GO
