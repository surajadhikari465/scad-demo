...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[EIM_GetUploadValueByPK]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[EIM_GetUploadValueByPK]
GO

CREATE PROCEDURE dbo.EIM_GetUploadValueByPK
	@UploadValue_ID int
