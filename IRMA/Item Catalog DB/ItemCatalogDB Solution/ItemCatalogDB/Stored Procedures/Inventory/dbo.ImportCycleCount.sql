...
if exists (select * from dbo.sysobjects where id = object_id(N'dbo.ImportCycleCount') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
	drop procedure dbo.ImportCycleCount
GO
...
GRANT  EXECUTE  ON dbo.ImportCycleCount  TO public
GRANT  EXECUTE  ON dbo.ImportCycleCount  TO IRMAClientRole
