 /****** Object:  StoredProcedure [dbo].[Replenishment_POSPush_GetFTPConfigForWriterType]    Script Date: 08/23/2006 16:33:09 ******/
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[Replenishment_POSPush_GetFTPConfigForWriterType]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[Replenishment_POSPush_GetFTPConfigForWriterType]
GO
