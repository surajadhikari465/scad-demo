IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[InsertCloneTaxJurisdiction]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[InsertCloneTaxJurisdiction]
GO
