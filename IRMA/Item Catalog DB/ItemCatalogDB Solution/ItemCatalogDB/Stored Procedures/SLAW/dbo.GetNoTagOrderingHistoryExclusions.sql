if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[GetNoTagOrderingHistoryExclusions]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
	drop procedure [dbo].[GetNoTagOrderingHistoryExclusions]
GO
...
ALTER PROCEDURE [dbo].[GetNoTagOrderingHistoryExclusions]
