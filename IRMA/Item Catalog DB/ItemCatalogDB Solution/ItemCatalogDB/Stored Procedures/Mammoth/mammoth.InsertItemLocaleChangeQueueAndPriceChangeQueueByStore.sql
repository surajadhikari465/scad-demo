IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'InsertItemLocaleChangeQueueAndPriceChangeQueueByStore')
	EXEC('CREATE PROCEDURE [mammoth].[InsertItemLocaleChangeQueueAndPriceChangeQueueByStore] AS BEGIN SET NOCOUNT ON; END')
GO

ALTER PROCEDURE [mammoth].[InsertItemLocaleChangeQueueAndPriceChangeQueueByStore]
	@Store_No int
AS
BEGIN	
/* =============================================
