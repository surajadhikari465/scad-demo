IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'dbo.GetStoresWithPrimaryVendorThatCanSwap') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure dbo.GetStoresWithPrimaryVendorThatCanSwap
GO
