...
Namespace Administration
    <Serializable()> _
    Public Class SalePriceChgTypeList
        Inherits WfmReadOnlyListBase(Of SalePriceChgTypeList, SalePriceChgTypeInfo)

#Region " Factory Methods "

        Public Overloads Shared Function GetList() As SalePriceChgTypeList

            Return DataPortal.Fetch(Of SalePriceChgTypeList)()
            ...
            Using cn As New SqlConnection(connString)
                ...
                Using cm As SqlCommand = cn.CreateCommand
                    With cm
                        ...
                        .CommandText = "Administration_GetSalePriceChgType"
                        Me.IsReadOnly = False
                        Using dr As New SafeDataReader(.ExecuteReader)
                            While dr.Read()
                                Dim info As New SalePriceChgTypeInfo(dr)
                                Me.Add(info)
                            End While
                        End Using
                        Me.IsReadOnly = True
