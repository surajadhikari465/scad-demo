<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" Inherits="ReportManagerWebApp.Shrink_FPShrinkReport" Title="FP Shrink Report" Codebehind="FPShrink.aspx.vb" %>
    ...
    <asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        <div id="navbar">
            <h3>
                <a href="..\Default.aspx">Home</a> &gt; Shrink<a href="ShrinkReports.aspx?valuePath=Reports Home/Waste">/Spoilage
                    Reports</a> &gt; FP Shrink Report</h3>
        </div>
        <br />
