<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" Inherits="ReportManagerWebApp.NoTagReport" title="Report Manager - No Tag Report" Codebehind="NoTagReport.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="navbar"><h3><a href="..\Default.aspx">Home</a> &gt; <a href="MiscReports.aspx?valuePath=Reports Home/Misc">Miscellaneous Reports</a> &gt; No Tag Report</h3>
    </div>
    <table border="0">
        <tr>
            <td style="width: 192px; text-align: right; height: 59px;">
                Store</td>
            <td style="width: 249px; text-align: left; height: 59px;"><asp:DropDownList ID="cmbStore" runat="server" Width="225px" DataSourceID="ICStores" DataTextField="Store_Name" DataValueField="Store_No" Font-Names="Verdana" Font-Size="10pt" TabIndex="1">
                </asp:DropDownList><asp:SqlDataSource ID="ICStores" runat="server" ConnectionString="<%$ ConnectionStrings:ReportManager_Conn %>"
                SelectCommand="GetRetailStores" SelectCommandType="StoredProcedure"></asp:SqlDataSource></td>
            <td style="width: 318px; text-align: left; height: 59px;">
        ...
        <tr>
            ...
            <td style="width: 249px; text-align: left">
                <asp:TextBox ID="txtBatchName" runat="server" Width="179px"></asp:TextBox>
            </td>
            <td style="width: 318px; text-align: left">
            </td>
        </tr>
        <tr>
            <td style="width: 192px; text-align: right; height: 42px;">
                Start Date Begin Range</td>
            <td style="width: 249px; text-align: left; height: 42px;">
            ...
            <td style="width: 318px; text-align: left; height: 42px;">
        ...
        <tr>
            ...
            <td style="width: 318px; text-align: left">
                ...
                <asp:CompareValidator ID="comp_DateRange" runat="server" ControlToCompare="dteEndDate"
                    ControlToValidate="dteBeginDate" Display="Dynamic" ErrorMessage="* Invalid date range - End Date Range cannot be earlier than Begin Date Range."
