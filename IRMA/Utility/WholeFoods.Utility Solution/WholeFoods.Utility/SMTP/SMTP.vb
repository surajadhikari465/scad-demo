...
#Region "Public Methods"
        ...
        Public Sub send(ByVal msgBody As String, ByVal msgTo As String, ByVal msgCC As String, ByVal msgFrom As String, ByVal msgSubject As String)
            ...
            Catch ex As SMTPException
                ...
                'TODO: handle exception, is this right?
            End Try
        ...
        ''' <param name="msgSubject"></param>
        ''' <remarks>pass in params to send the message to the smtp client</remarks>
        Public Sub sendWithAttachment(ByVal msgBody As String, ByVal msgTo As String, ByVal msgCC As String, ByVal msgFrom As String, ByVal msgSubject As String, ByVal fileNameWithPath As String)
            ...
            If (fileNameWithPath <> Nothing) Then
                myAttachment = New System.Net.Mail.Attachment(fileNameWithPath)
