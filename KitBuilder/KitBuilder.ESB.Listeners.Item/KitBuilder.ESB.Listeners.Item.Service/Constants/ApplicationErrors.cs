namespace KitBuilder.ESB.Listeners.Item.Service.Constants
{
    public static class ApplicationErrors
    {
        public static class Codes
        {
            ...
            public const string ItemRemoveError = "ItemRemoveError";
        ...
        public static class Messages
        {
            ...
            public const string ItemRemoveError = "An unexpected exception occurred which caused a failure to remove an item.";
