...
namespace KitBuilder.DataAccess.DatabaseModels
{
    public partial class KitBuilderContext : DbContext
    {
        ...
        public virtual DbSet<InstructionListQueue> InstructionListQueue { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<InstructionListQueue>(entity =>
            {
                entity.Property(e => e.InstructionListQueueId).HasColumnName("InstructionListQueueID");

                entity.Property(e => e.InsertDateUtc).HasDefaultValueSql("(sysdatetime())");

                entity.Property(e => e.KeyId).HasColumnName("KeyID");

                entity.Property(e => e.MessageTimestampUtc).HasDefaultValueSql("(sysutcdatetime())");
