...
namespace KitBuilder.Esb.LocaleListener.Tests
{
    [TestClass]
    public class KitBuilderLocaleListenerTests
    {
        private KitBuilderLocaleListener listener;
        ...
        private Mock<ILogger<KitBuilderLocaleListener>> mockLogger;
        ...
        public void Initialize()
        {
            ...
            mockLogger = new Mock<ILogger<KitBuilderLocaleListener>>();
            ...
            listener = new KitBuilderLocaleListener(listenerApplicationSettings,
