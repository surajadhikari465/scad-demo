...
function ViewKitSearch(props: any) {
    ...
    return (<div className="search-container">
            ...
            <Grid xs = {12} md={2} item>
                ...
                <Grid xs = {12} md={2} item>
                    <Button variant="contained" color="primary" className={props.classes.button} onClick={() => props.selectKit()} >
                        Select Kit
                    </Button>
                </Grid>
...
export default withStyles(styles, { withTheme: true })(ViewKitSearch);